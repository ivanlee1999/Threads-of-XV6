...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 6f 05 00 00       	call   586 <getpid>
  ...
  1a:	c7 45 f0 2a 00 00 00 	movl   $0x2a,-0x10(%ebp)
   ppid = getpid();
  21:	a3 5c 0e 00 00       	mov    %eax,0xe5c
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  5e:	6a 22                	push   $0x22
  60:	68 98 09 00 00       	push   $0x998
  65:	68 a2 09 00 00       	push   $0x9a2
  6a:	6a 01                	push   $0x1
  6c:	e8 ff 05 00 00       	call   670 <printf>
  71:	83 c4 0c             	add    $0xc,%esp
  74:	68 13 0a 00 00       	push   $0xa13
  79:	eb 1b                	jmp    96 <main+0x96>
   assert(join_pid == thread_pid);
  7b:	6a 21                	push   $0x21
  7d:	68 98 09 00 00       	push   $0x998
  82:	68 a2 09 00 00       	push   $0x9a2
  87:	6a 01                	push   $0x1
  89:	e8 e2 05 00 00       	call   670 <printf>
  8e:	83 c4 0c             	add    $0xc,%esp
  91:	68 fc 09 00 00       	push   $0x9fc
  96:	68 b5 09 00 00       	push   $0x9b5
  9b:	6a 01                	push   $0x1
  9d:	e8 ce 05 00 00       	call   670 <printf>
  a2:	5a                   	pop    %edx
  a3:	59                   	pop    %ecx
  a4:	68 c9 09 00 00       	push   $0x9c9
  a9:	6a 01                	push   $0x1
  ab:	e8 c0 05 00 00       	call   670 <printf>
  b0:	5b                   	pop    %ebx
  b1:	ff 35 5c 0e 00 00    	push   0xe5c
  b7:	e8 7a 04 00 00       	call   536 <kill>
  bc:	e8 45 04 00 00       	call   506 <exit>
   assert(thread_pid > 0);
  c1:	6a 1e                	push   $0x1e
  c3:	68 98 09 00 00       	push   $0x998
  c8:	68 a2 09 00 00       	push   $0x9a2
  cd:	6a 01                	push   $0x1
  cf:	e8 9c 05 00 00       	call   670 <printf>
  d4:	83 c4 0c             	add    $0xc,%esp
  d7:	68 ed 09 00 00       	push   $0x9ed
  dc:	eb b8                	jmp    96 <main+0x96>

   printf(1, "TEST PASSED\n");
  de:	50                   	push   %eax
  df:	50                   	push   %eax
  e0:	68 1f 0a 00 00       	push   $0xa1f
  e5:	6a 01                	push   $0x1
  e7:	e8 84 05 00 00       	call   670 <printf>
   exit();
  ec:	e8 15 04 00 00       	call   506 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 11f:	75 52                	jne    173 <worker+0x73>
   global++;
 121:	c7 05 58 0e 00 00 02 	movl   $0x2,0xe58
 128:	00 00 00 
   // no exit() in thread
}
 12b:	c9                   	leave  
 12c:	c3                   	ret    
   assert(tmp1 == 42);
 12d:	6a 2c                	push   $0x2c
 12f:	68 98 09 00 00       	push   $0x998
 134:	68 a2 09 00 00       	push   $0x9a2
 139:	6a 01                	push   $0x1
 13b:	e8 30 05 00 00       	call   670 <printf>
 140:	83 c4 0c             	add    $0xc,%esp
 143:	68 aa 09 00 00       	push   $0x9aa
   assert(tmp2 == 24);
 148:	68 b5 09 00 00       	push   $0x9b5
 14d:	6a 01                	push   $0x1
 14f:	e8 1c 05 00 00       	call   670 <printf>
 154:	58                   	pop    %eax
 155:	5a                   	pop    %edx
 156:	68 c9 09 00 00       	push   $0x9c9
 15b:	6a 01                	push   $0x1
 15d:	e8 0e 05 00 00       	call   670 <printf>
 162:	59                   	pop    %ecx
 163:	ff 35 5c 0e 00 00    	push   0xe5c
 169:	e8 c8 03 00 00       	call   536 <kill>
 16e:	e8 93 03 00 00       	call   506 <exit>
   assert(global == 1);
 173:	6a 2e                	push   $0x2e
 175:	68 98 09 00 00       	push   $0x998
 17a:	68 a2 09 00 00       	push   $0x9a2
 17f:	6a 01                	push   $0x1
 181:	e8 ea 04 00 00       	call   670 <printf>
 186:	83 c4 0c             	add    $0xc,%esp
 189:	68 e1 09 00 00       	push   $0x9e1
 18e:	eb b8                	jmp    148 <worker+0x48>
   assert(tmp2 == 24);
 190:	6a 2d                	push   $0x2d
 192:	68 98 09 00 00       	push   $0x998
 197:	68 a2 09 00 00       	push   $0x9a2
 19c:	6a 01                	push   $0x1
 19e:	e8 cd 04 00 00       	call   670 <printf>
 1a3:	83 c4 0c             	add    $0xc,%esp
 1a6:	68 d6 09 00 00       	push   $0x9d6
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 407:	68 00 20 00 00       	push   $0x2000
 ...
 5cc:	89 d1                	mov    %edx,%ecx
{
 ...
 5f9:	0f b6 92 e0 0a 00 00 	movzbl 0xae0(%edx),%edx
 ...
 679:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6e9:	ff 24 85 88 0a 00 00 	jmp    *0xa88(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7f7:	90                   	nop
          s = "(null)";
 7f8:	ba 81 0a 00 00       	mov    $0xa81,%edx
        while(*s != 0){
 ...
 811:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 851:	5b                   	pop    %ebx
  freep = p;
 852:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 858:	5e                   	pop    %esi
 859:	5f                   	pop    %edi
 85a:	5d                   	pop    %ebp
 ...
 889:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 88c:	89 15 60 0e 00 00    	mov    %edx,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8ac:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8ef:	73 4f                	jae    940 <malloc+0xa0>
    ...
    if(p == freep)
 8f1:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
 ...
 91a:	e8 f1 fe ff ff       	call   810 <free>
  return freep;
 91f:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 95f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 960:	c7 05 60 0e 00 00 64 	movl   $0xe64,0xe60
 967:	0e 00 00 
    base.s.size = 0;
 96a:	bf 64 0e 00 00       	mov    $0xe64,%edi
    base.s.ptr = freep = prevp = &base;
 96f:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 976:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 979:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 97b:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 982:	00 00 00 
    if(p->s.size >= nunits){
