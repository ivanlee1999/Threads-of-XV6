...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 02 05 00 00       	call   519 <getpid>
  ...
  1a:	c7 45 f0 2a 00 00 00 	movl   $0x2a,-0x10(%ebp)
   ppid = getpid();
  21:	a3 8c 0d 00 00       	mov    %eax,0xd8c
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 2);
  51:	83 3d 88 0d 00 00 02 	cmpl   $0x2,0xd88
  ...
  b0:	5b                   	pop    %ebx
  b1:	ff 35 8c 0d 00 00    	push   0xd8c
  b7:	e8 0d 04 00 00       	call   4c9 <kill>
  bc:	e8 d8 03 00 00       	call   499 <exit>
   assert(thread_pid > 0);
  c1:	6a 1e                	push   $0x1e
  ...
  e7:	e8 14 05 00 00       	call   600 <printf>
   exit();
  ec:	e8 a8 03 00 00       	call   499 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 116:	75 78                	jne    190 <worker+0x90>
   assert(global == 1);
 118:	83 3d 88 0d 00 00 01 	cmpl   $0x1,0xd88
 11f:	75 52                	jne    173 <worker+0x73>
   global++;
 121:	c7 05 88 0d 00 00 02 	movl   $0x2,0xd88
 128:	00 00 00 
   // no exit() in thread
}
 12b:	c9                   	leave  
 ...
 162:	59                   	pop    %ecx
 163:	ff 35 8c 0d 00 00    	push   0xd8c
 169:	e8 5b 03 00 00       	call   4c9 <kill>
 16e:	e8 26 03 00 00       	call   499 <exit>
   assert(global == 1);
 173:	6a 2e                	push   $0x2e
 ...
 55c:	89 d1                	mov    %edx,%ecx
{
 ...
 589:	0f b6 92 30 0a 00 00 	movzbl 0xa30(%edx),%edx
 ...
 609:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 679:	ff 24 85 d8 09 00 00 	jmp    *0x9d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 787:	90                   	nop
          s = "(null)";
 788:	ba d0 09 00 00       	mov    $0x9d0,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a1:	a1 90 0d 00 00       	mov    0xd90,%eax
{
 ...
 7e1:	5b                   	pop    %ebx
  freep = p;
 7e2:	89 15 90 0d 00 00    	mov    %edx,0xd90
}
 7e8:	5e                   	pop    %esi
 7e9:	5f                   	pop    %edi
 7ea:	5d                   	pop    %ebp
 ...
 819:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 81c:	89 15 90 0d 00 00    	mov    %edx,0xd90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 839:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 83c:	8b 3d 90 0d 00 00    	mov    0xd90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 87f:	73 4f                	jae    8d0 <malloc+0xa0>
    ...
    if(p == freep)
 881:	8b 3d 90 0d 00 00    	mov    0xd90,%edi
 ...
 8aa:	e8 f1 fe ff ff       	call   7a0 <free>
  return freep;
 8af:	8b 15 90 0d 00 00    	mov    0xd90,%edx
 ...
 8dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8df:	89 15 90 0d 00 00    	mov    %edx,0xd90
}
 ...
 8ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8f0:	c7 05 90 0d 00 00 94 	movl   $0xd94,0xd90
 8f7:	0d 00 00 
    base.s.size = 0;
 8fa:	bf 94 0d 00 00       	mov    $0xd94,%edi
    base.s.ptr = freep = prevp = &base;
 8ff:	c7 05 94 0d 00 00 94 	movl   $0xd94,0xd94
 906:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 909:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 90b:	c7 05 98 0d 00 00 00 	movl   $0x0,0xd98
 912:	00 00 00 
    if(p->s.size >= nunits){
