...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 95 05 00 00       	call   5a9 <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 48 0e 00 00       	push   $0xe48
   ppid = getpid();
  1c:	a3 50 0e 00 00       	mov    %eax,0xe50
   lock_init(&lock);
  21:	e8 fa 04 00 00       	call   520 <lock_init>

   int i;
   for (i = 0; i < num_threads; i++) {
  26:	a1 44 0e 00 00       	mov    0xe44,%eax
  ...
  40:	a1 44 0e 00 00       	mov    0xe44,%eax
  ...
  99:	5b                   	pop    %ebx
  9a:	ff 35 50 0e 00 00    	push   0xe50
  a0:	e8 b4 04 00 00       	call   559 <kill>
  a5:	e8 7f 04 00 00       	call   529 <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 44 0e 00 00       	mov    0xe44,%eax
  ...
  ec:	3b 05 4c 0e 00 00    	cmp    0xe4c,%eax
 ...
 11d:	e8 6e 05 00 00       	call   690 <printf>
   exit();
 122:	e8 02 04 00 00       	call   529 <exit>
...
void worker2(void *arg1,void *arg2){
 ...
 133:	83 ec 14             	sub    $0x14,%esp
    int j;
    lock_acquire(&lock);
 136:	68 48 0e 00 00       	push   $0xe48
 13b:	e8 c0 03 00 00       	call   500 <lock_acquire>
    for(j=0;j<50;j++);
    global++;
    lock_release(&lock);
 140:	c7 04 24 48 0e 00 00 	movl   $0xe48,(%esp)
    global++;
 147:	83 05 4c 0e 00 00 01 	addl   $0x1,0xe4c
    lock_release(&lock);
 14e:	e8 bd 03 00 00       	call   510 <lock_release>
    exit();
 153:	e8 d1 03 00 00       	call   529 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 164:	83 ec 10             	sub    $0x10,%esp
    ...
    lock_acquire(&lock);
 167:	68 48 0e 00 00       	push   $0xe48
 16c:	e8 8f 03 00 00       	call   500 <lock_acquire>
    int j;
    for(j = 0; j < 50; j++); // take some time
    global++;
    lock_release(&lock);
 171:	c7 04 24 48 0e 00 00 	movl   $0xe48,(%esp)
    global++;
 178:	83 05 4c 0e 00 00 01 	addl   $0x1,0xe4c
    lock_release(&lock);
 ...
 1e4:	59                   	pop    %ecx
 1e5:	ff 35 50 0e 00 00    	push   0xe50
 1eb:	e8 69 03 00 00       	call   559 <kill>
 1f0:	e8 34 03 00 00       	call   529 <exit>
    assert(nested_thread_pid > 0);
 1f5:	6a 47                	push   $0x47
 ...
 22d:	eb 9b                	jmp    1ca <worker+0x6a>
   ...
   exit();
 22f:	e8 f5 02 00 00       	call   529 <exit>
 ...
 369:	31 db                	xor    %ebx,%ebx
{
 ...
 375:	57                   	push   %edi
 376:	6a 00                	push   $0x0
 378:	e8 c4 01 00 00       	call   541 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3dd:	e8 87 01 00 00       	call   569 <open>
  if(fd < 0)
 ...
 3f1:	50                   	push   %eax
 3f2:	e8 8a 01 00 00       	call   581 <fstat>
  close(fd);
 3f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 3fa:	89 c6                	mov    %eax,%esi
  close(fd);
 3fc:	e8 50 01 00 00       	call   551 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 497:	68 00 10 00 00       	push   $0x1000
 49c:	e8 1f 04 00 00       	call   8c0 <malloc>
  // if((int) stack % 4096 != 0){
  //   stack = stack + (4096 - (int) stack % 4096);
  // }
  int rc = clone(start_routine, arg1, arg2, stack);
 4a1:	50                   	push   %eax
 4a2:	ff 75 10             	push   0x10(%ebp)
 4a5:	ff 75 0c             	push   0xc(%ebp)
 4a8:	ff 75 08             	push   0x8(%ebp)
 4ab:	e8 19 01 00 00       	call   5c9 <clone>
  printf(1, " thread create %d \n", rc);
 4b0:	83 c4 1c             	add    $0x1c,%esp
 4b3:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 4b4:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 4b6:	68 5f 0a 00 00       	push   $0xa5f
 4bb:	6a 01                	push   $0x1
 4bd:	e8 ce 01 00 00       	call   690 <printf>
  return rc;
}
...
thread_join(){
 ...
 4d8:	6a 04                	push   $0x4
 4da:	e8 e1 03 00 00       	call   8c0 <malloc>
  int rc = join(stack);
 4df:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 4e2:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 4e4:	e8 e8 00 00 00       	call   5d1 <join>
 4e9:	89 c6                	mov    %eax,%esi
  free(*stack);
 4eb:	58                   	pop    %eax
 4ec:	ff 33                	push   (%ebx)
 4ee:	e8 3d 03 00 00       	call   830 <free>
  return rc;
}
...
00000539 <pipe>:
SYSCALL(pipe)
 539:	b8 04 00 00 00       	mov    $0x4,%eax
 53e:	cd 40                	int    $0x40
 540:	c3                   	ret    
...
00000549 <write>:
SYSCALL(write)
 549:	b8 10 00 00 00       	mov    $0x10,%eax
 54e:	cd 40                	int    $0x40
 550:	c3                   	ret    

00000551 <close>:
SYSCALL(close)
 551:	b8 15 00 00 00       	mov    $0x15,%eax
 556:	cd 40                	int    $0x40
 558:	c3                   	ret    

00000559 <kill>:
SYSCALL(kill)
 559:	b8 06 00 00 00       	mov    $0x6,%eax
 55e:	cd 40                	int    $0x40
 560:	c3                   	ret    

00000561 <exec>:
SYSCALL(exec)
 561:	b8 07 00 00 00       	mov    $0x7,%eax
 566:	cd 40                	int    $0x40
 568:	c3                   	ret    

00000569 <open>:
SYSCALL(open)
 569:	b8 0f 00 00 00       	mov    $0xf,%eax
 56e:	cd 40                	int    $0x40
 570:	c3                   	ret    

00000571 <mknod>:
SYSCALL(mknod)
 571:	b8 11 00 00 00       	mov    $0x11,%eax
 576:	cd 40                	int    $0x40
 578:	c3                   	ret    

00000579 <unlink>:
SYSCALL(unlink)
 579:	b8 12 00 00 00       	mov    $0x12,%eax
 57e:	cd 40                	int    $0x40
 580:	c3                   	ret    

00000581 <fstat>:
SYSCALL(fstat)
 581:	b8 08 00 00 00       	mov    $0x8,%eax
 586:	cd 40                	int    $0x40
 588:	c3                   	ret    

00000589 <link>:
SYSCALL(link)
 589:	b8 13 00 00 00       	mov    $0x13,%eax
 58e:	cd 40                	int    $0x40
 590:	c3                   	ret    

00000591 <mkdir>:
SYSCALL(mkdir)
 591:	b8 14 00 00 00       	mov    $0x14,%eax
 596:	cd 40                	int    $0x40
 598:	c3                   	ret    

00000599 <chdir>:
SYSCALL(chdir)
 599:	b8 09 00 00 00       	mov    $0x9,%eax
 59e:	cd 40                	int    $0x40
 5a0:	c3                   	ret    

000005a1 <dup>:
SYSCALL(dup)
 5a1:	b8 0a 00 00 00       	mov    $0xa,%eax
 5a6:	cd 40                	int    $0x40
 5a8:	c3                   	ret    

000005a9 <getpid>:
SYSCALL(getpid)
 5a9:	b8 0b 00 00 00       	mov    $0xb,%eax
 5ae:	cd 40                	int    $0x40
 5b0:	c3                   	ret    

000005b1 <sbrk>:
SYSCALL(sbrk)
 5b1:	b8 0c 00 00 00       	mov    $0xc,%eax
 5b6:	cd 40                	int    $0x40
 5b8:	c3                   	ret    

000005b9 <sleep>:
SYSCALL(sleep)
 5b9:	b8 0d 00 00 00       	mov    $0xd,%eax
 5be:	cd 40                	int    $0x40
 5c0:	c3                   	ret    

000005c1 <uptime>:
SYSCALL(uptime)
 5c1:	b8 0e 00 00 00       	mov    $0xe,%eax
 5c6:	cd 40                	int    $0x40
 5c8:	c3                   	ret    

000005c9 <clone>:
SYSCALL(clone)
 5c9:	b8 16 00 00 00       	mov    $0x16,%eax
 5ce:	cd 40                	int    $0x40
 5d0:	c3                   	ret    

000005d1 <join>:
SYSCALL(join)
 5d1:	b8 17 00 00 00       	mov    $0x17,%eax
 5d6:	cd 40                	int    $0x40
 5d8:	c3                   	ret    
 ...
 5ec:	89 d1                	mov    %edx,%ecx
{
 ...
 65e:	56                   	push   %esi
 65f:	57                   	push   %edi
 660:	e8 e4 fe ff ff       	call   549 <write>
  while(--i >= 0)
 ...
 699:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6d5:	57                   	push   %edi
 6d6:	56                   	push   %esi
 6d7:	e8 6d fe ff ff       	call   549 <write>
 ...
 72e:	e8 16 fe ff ff       	call   549 <write>
        putc(fd, c);
 ...
 73f:	57                   	push   %edi
 740:	56                   	push   %esi
 741:	e8 03 fe ff ff       	call   549 <write>
        putc(fd, c);
 ...
 7ab:	57                   	push   %edi
 7ac:	56                   	push   %esi
 7ad:	e8 97 fd ff ff       	call   549 <write>
        while(*s != 0){
 ...
 7ec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 7ef:	e8 55 fd ff ff       	call   549 <write>
        ap++;
 ...
 817:	90                   	nop
          s = "(null)";
 818:	ba 73 0a 00 00       	mov    $0xa73,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 831:	a1 54 0e 00 00       	mov    0xe54,%eax
{
 ...
 871:	5b                   	pop    %ebx
  freep = p;
 872:	89 15 54 0e 00 00    	mov    %edx,0xe54
}
 878:	5e                   	pop    %esi
 879:	5f                   	pop    %edi
 87a:	5d                   	pop    %ebp
 ...
 8a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8ac:	89 15 54 0e 00 00    	mov    %edx,0xe54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8cc:	8b 3d 54 0e 00 00    	mov    0xe54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 90f:	73 4f                	jae    960 <malloc+0xa0>
    ...
    if(p == freep)
 911:	8b 3d 54 0e 00 00    	mov    0xe54,%edi
 ...
 923:	e8 89 fc ff ff       	call   5b1 <sbrk>
  if(p == (char*)-1)
 ...
 93a:	e8 f1 fe ff ff       	call   830 <free>
  return freep;
 93f:	8b 15 54 0e 00 00    	mov    0xe54,%edx
 ...
 96c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 96f:	89 15 54 0e 00 00    	mov    %edx,0xe54
}
 ...
 97f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 980:	c7 05 54 0e 00 00 58 	movl   $0xe58,0xe54
 987:	0e 00 00 
    base.s.size = 0;
 98a:	bf 58 0e 00 00       	mov    $0xe58,%edi
    base.s.ptr = freep = prevp = &base;
 98f:	c7 05 58 0e 00 00 58 	movl   $0xe58,0xe58
 996:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 999:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 99b:	c7 05 5c 0e 00 00 00 	movl   $0x0,0xe5c
 9a2:	00 00 00 
    if(p->s.size >= nunits){
