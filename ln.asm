   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 8b 04 00 00       	call   4b0 <printf>
    exit();
  25:	e8 1f 03 00 00       	call   349 <exit>
  }
  ...
  32:	e8 72 03 00 00       	call   3a9 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 06 03 00 00       	call   349 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 c4 01 00 00       	call   361 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 87 01 00 00       	call   389 <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 8a 01 00 00       	call   3a1 <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 50 01 00 00       	call   371 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2bc:	e8 1f 04 00 00       	call   6e0 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 2cb:	e8 19 01 00 00       	call   3e9 <clone>
  printf(1, " thread create %d \n", rc);
 2d0:	83 c4 1c             	add    $0x1c,%esp
 2d3:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 2d4:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 2d6:	68 ff 07 00 00       	push   $0x7ff
 2db:	6a 01                	push   $0x1
 2dd:	e8 ce 01 00 00       	call   4b0 <printf>
  return rc;
}
...
thread_join(){
 ...
 2f8:	6a 04                	push   $0x4
 2fa:	e8 e1 03 00 00       	call   6e0 <malloc>
  int rc = join(stack);
 2ff:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 302:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 304:	e8 e8 00 00 00       	call   3f1 <join>
 309:	89 c6                	mov    %eax,%esi
  free(*stack);
 30b:	58                   	pop    %eax
 30c:	ff 33                	push   (%ebx)
 30e:	e8 3d 03 00 00       	call   650 <free>
  return rc;
}
...
00000359 <pipe>:
SYSCALL(pipe)
 359:	b8 04 00 00 00       	mov    $0x4,%eax
 35e:	cd 40                	int    $0x40
 360:	c3                   	ret    

00000361 <read>:
SYSCALL(read)
 361:	b8 05 00 00 00       	mov    $0x5,%eax
 366:	cd 40                	int    $0x40
 368:	c3                   	ret    

00000369 <write>:
SYSCALL(write)
 369:	b8 10 00 00 00       	mov    $0x10,%eax
 36e:	cd 40                	int    $0x40
 370:	c3                   	ret    

00000371 <close>:
SYSCALL(close)
 371:	b8 15 00 00 00       	mov    $0x15,%eax
 376:	cd 40                	int    $0x40
 378:	c3                   	ret    

00000379 <kill>:
SYSCALL(kill)
 379:	b8 06 00 00 00       	mov    $0x6,%eax
 37e:	cd 40                	int    $0x40
 380:	c3                   	ret    

00000381 <exec>:
SYSCALL(exec)
 381:	b8 07 00 00 00       	mov    $0x7,%eax
 386:	cd 40                	int    $0x40
 388:	c3                   	ret    

00000389 <open>:
SYSCALL(open)
 389:	b8 0f 00 00 00       	mov    $0xf,%eax
 38e:	cd 40                	int    $0x40
 390:	c3                   	ret    

00000391 <mknod>:
SYSCALL(mknod)
 391:	b8 11 00 00 00       	mov    $0x11,%eax
 396:	cd 40                	int    $0x40
 398:	c3                   	ret    

00000399 <unlink>:
SYSCALL(unlink)
 399:	b8 12 00 00 00       	mov    $0x12,%eax
 39e:	cd 40                	int    $0x40
 3a0:	c3                   	ret    
...
000003a9 <link>:
SYSCALL(link)
 3a9:	b8 13 00 00 00       	mov    $0x13,%eax
 3ae:	cd 40                	int    $0x40
 3b0:	c3                   	ret    

000003b1 <mkdir>:
SYSCALL(mkdir)
 3b1:	b8 14 00 00 00       	mov    $0x14,%eax
 3b6:	cd 40                	int    $0x40
 3b8:	c3                   	ret    

000003b9 <chdir>:
SYSCALL(chdir)
 3b9:	b8 09 00 00 00       	mov    $0x9,%eax
 3be:	cd 40                	int    $0x40
 3c0:	c3                   	ret    

000003c1 <dup>:
SYSCALL(dup)
 3c1:	b8 0a 00 00 00       	mov    $0xa,%eax
 3c6:	cd 40                	int    $0x40
 3c8:	c3                   	ret    

000003c9 <getpid>:
SYSCALL(getpid)
 3c9:	b8 0b 00 00 00       	mov    $0xb,%eax
 3ce:	cd 40                	int    $0x40
 3d0:	c3                   	ret    

000003d1 <sbrk>:
SYSCALL(sbrk)
 3d1:	b8 0c 00 00 00       	mov    $0xc,%eax
 3d6:	cd 40                	int    $0x40
 3d8:	c3                   	ret    

000003d9 <sleep>:
SYSCALL(sleep)
 3d9:	b8 0d 00 00 00       	mov    $0xd,%eax
 3de:	cd 40                	int    $0x40
 3e0:	c3                   	ret    

000003e1 <uptime>:
SYSCALL(uptime)
 3e1:	b8 0e 00 00 00       	mov    $0xe,%eax
 3e6:	cd 40                	int    $0x40
 3e8:	c3                   	ret    

000003e9 <clone>:
SYSCALL(clone)
 3e9:	b8 16 00 00 00       	mov    $0x16,%eax
 3ee:	cd 40                	int    $0x40
 3f0:	c3                   	ret    
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 47e:	56                   	push   %esi
 47f:	57                   	push   %edi
 480:	e8 e4 fe ff ff       	call   369 <write>
  while(--i >= 0)
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f5:	57                   	push   %edi
 4f6:	56                   	push   %esi
 4f7:	e8 6d fe ff ff       	call   369 <write>
 ...
 529:	ff 24 85 1c 08 00 00 	jmp    *0x81c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 54e:	e8 16 fe ff ff       	call   369 <write>
        putc(fd, c);
 ...
 55f:	57                   	push   %edi
 560:	56                   	push   %esi
 561:	e8 03 fe ff ff       	call   369 <write>
        putc(fd, c);
 ...
 5cb:	57                   	push   %edi
 5cc:	56                   	push   %esi
 5cd:	e8 97 fd ff ff       	call   369 <write>
        while(*s != 0){
 ...
 60c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 60f:	e8 55 fd ff ff       	call   369 <write>
        ap++;
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 13 08 00 00       	mov    $0x813,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 a8 0b 00 00       	mov    0xba8,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 a8 0b 00 00    	mov    %edx,0xba8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
 ...
 743:	e8 89 fc ff ff       	call   3d1 <sbrk>
  if(p == (char*)-1)
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 a8 0b 00 00 ac 	movl   $0xbac,0xba8
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf ac 0b 00 00       	mov    $0xbac,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 7c2:	00 00 00 
    if(p->s.size >= nunits){
