...
main(int argc, char *argv[])
{
  ...
  10:	83 ec 1c             	sub    $0x1c,%esp
   ppid = getpid();
  13:	e8 f1 04 00 00       	call   509 <getpid>
   void *stack, *p = malloc(PGSIZE*2);
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 5c 0d 00 00       	mov    %eax,0xd5c
   void *stack, *p = malloc(PGSIZE*2);
  ...
  4f:	e8 d5 04 00 00       	call   529 <clone>
   assert(clone_pid > 0);
  ...
  61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
   while(global != 5);
  68:	8b 15 58 0d 00 00    	mov    0xd58,%edx
  ...
  87:	e8 a5 04 00 00       	call   531 <join>
  ...
  c8:	5b                   	pop    %ebx
  c9:	ff 35 5c 0d 00 00    	push   0xd5c
  cf:	e8 e5 03 00 00       	call   4b9 <kill>
  d4:	e8 b0 03 00 00       	call   489 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  e9:	e8 a2 06 00 00       	call   790 <free>
   exit();
  ee:	e8 96 03 00 00       	call   489 <exit>
   assert(clone_pid > 0);
  f3:	6a 23                	push   $0x23
...
worker(void *arg1, void *arg2) {
 ...
 133:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 136:	a1 58 0d 00 00       	mov    0xd58,%eax
 ...
 175:	59                   	pop    %ecx
 176:	ff 35 5c 0d 00 00    	push   0xd5c
 17c:	e8 38 03 00 00       	call   4b9 <kill>
 181:	e8 03 03 00 00       	call   489 <exit>
   global = 5;
 186:	c7 05 58 0d 00 00 05 	movl   $0x5,0xd58
 18d:	00 00 00 
   exit();
 190:	e8 f4 02 00 00       	call   489 <exit>
 ...
 2c9:	31 db                	xor    %ebx,%ebx
{
 ...
 2d5:	57                   	push   %edi
 2d6:	6a 00                	push   $0x0
 2d8:	e8 c4 01 00 00       	call   4a1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 33d:	e8 87 01 00 00       	call   4c9 <open>
  if(fd < 0)
 ...
 351:	50                   	push   %eax
 352:	e8 8a 01 00 00       	call   4e1 <fstat>
  close(fd);
 357:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 35a:	89 c6                	mov    %eax,%esi
  close(fd);
 35c:	e8 50 01 00 00       	call   4b1 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 3fc:	e8 1f 04 00 00       	call   820 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 40b:	e8 19 01 00 00       	call   529 <clone>
  printf(1, " thread create %d \n", rc);
 410:	83 c4 1c             	add    $0x1c,%esp
 413:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 414:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 416:	68 91 09 00 00       	push   $0x991
 41b:	6a 01                	push   $0x1
 41d:	e8 ce 01 00 00       	call   5f0 <printf>
  return rc;
}
 ...
 54c:	89 d1                	mov    %edx,%ecx
{
 ...
 579:	0f b6 92 04 0a 00 00 	movzbl 0xa04(%edx),%edx
 ...
 5f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 669:	ff 24 85 ac 09 00 00 	jmp    *0x9ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 777:	90                   	nop
          s = "(null)";
 778:	ba a5 09 00 00       	mov    $0x9a5,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 791:	a1 60 0d 00 00       	mov    0xd60,%eax
{
 ...
 7d1:	5b                   	pop    %ebx
  freep = p;
 7d2:	89 15 60 0d 00 00    	mov    %edx,0xd60
}
 7d8:	5e                   	pop    %esi
 7d9:	5f                   	pop    %edi
 7da:	5d                   	pop    %ebp
 ...
 809:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 80c:	89 15 60 0d 00 00    	mov    %edx,0xd60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 829:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 82c:	8b 3d 60 0d 00 00    	mov    0xd60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 86f:	73 4f                	jae    8c0 <malloc+0xa0>
    ...
    if(p == freep)
 871:	8b 3d 60 0d 00 00    	mov    0xd60,%edi
 ...
 89a:	e8 f1 fe ff ff       	call   790 <free>
  return freep;
 89f:	8b 15 60 0d 00 00    	mov    0xd60,%edx
 ...
 8cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8cf:	89 15 60 0d 00 00    	mov    %edx,0xd60
}
 ...
 8df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 60 0d 00 00 64 	movl   $0xd64,0xd60
 8e7:	0d 00 00 
    base.s.size = 0;
 8ea:	bf 64 0d 00 00       	mov    $0xd64,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 64 0d 00 00 64 	movl   $0xd64,0xd64
 8f6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8fb:	c7 05 68 0d 00 00 00 	movl   $0x0,0xd68
 902:	00 00 00 
    if(p->s.size >= nunits){
