...
main(int argc, char *argv[])
{
  ...
  61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
   while(global != 5);
  68:	8b 15 28 0e 00 00    	mov    0xe28,%edx
  ...
  c8:	5b                   	pop    %ebx
  c9:	ff 35 2c 0e 00 00    	push   0xe2c
...
worker(void *arg1, void *arg2) {
 ...
 133:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 136:	a1 28 0e 00 00       	mov    0xe28,%eax
 ...
 175:	59                   	pop    %ecx
 176:	ff 35 2c 0e 00 00    	push   0xe2c
 17c:	e8 a5 03 00 00       	call   526 <kill>
 181:	e8 70 03 00 00       	call   4f6 <exit>
   global = 5;
 186:	c7 05 28 0e 00 00 05 	movl   $0x5,0xe28
 18d:	00 00 00 
   exit();
...
thread_join(){
 ...
 463:	58                   	pop    %eax
 464:	5a                   	pop    %edx
 465:	68 25 0a 00 00       	push   $0xa25
 46a:	6a 01                	push   $0x1
 46c:	e8 ef 01 00 00       	call   660 <printf>
  int rc = join(stack);
 471:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 478:	e8 21 01 00 00       	call   59e <join>
 ...
 47e:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 480:	58                   	pop    %eax
 481:	68 35 0a 00 00       	push   $0xa35
 486:	6a 01                	push   $0x1
 488:	e8 d3 01 00 00       	call   660 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 48d:	58                   	pop    %eax
 48e:	5a                   	pop    %edx
 48f:	68 45 0a 00 00       	push   $0xa45
 494:	6a 01                	push   $0x1
 496:	e8 c5 01 00 00       	call   660 <printf>
  return rc;
}
 ...
 5bc:	89 d1                	mov    %edx,%ecx
{
 ...
 5e9:	0f b6 92 b4 0a 00 00 	movzbl 0xab4(%edx),%edx
 ...
 669:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6d9:	ff 24 85 5c 0a 00 00 	jmp    *0xa5c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7e7:	90                   	nop
          s = "(null)";
 7e8:	ba 55 0a 00 00       	mov    $0xa55,%edx
        while(*s != 0){
