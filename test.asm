...
int main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 30 07 00 00       	call   749 <getpid>
  ...
  1c:	c7 45 e0 0b 00 00 00 	movl   $0xb,-0x20(%ebp)
   lock_init(&lock);
  23:	68 d9 0f 00 00       	push   $0xfd9
   ppid = getpid();
  28:	a3 e4 0f 00 00       	mov    %eax,0xfe4
   int arg1 = 11, arg2 = 22;
  2d:	c7 45 e4 16 00 00 00 	movl   $0x16,-0x1c(%ebp)
   lock_init(&lock);
  34:	e8 87 06 00 00       	call   6c0 <lock_init>
   lock_init(&lock2);
  39:	c7 04 24 d8 0f 00 00 	movl   $0xfd8,(%esp)
  40:	e8 7b 06 00 00       	call   6c0 <lock_init>
   lock_acquire(&lock);
  45:	c7 04 24 d9 0f 00 00 	movl   $0xfd9,(%esp)
  4c:	e8 4f 06 00 00       	call   6a0 <lock_acquire>
   lock_acquire(&lock2);
  51:	c7 04 24 d8 0f 00 00 	movl   $0xfd8,(%esp)
  58:	e8 43 06 00 00       	call   6a0 <lock_acquire>
  ...
  a0:	68 5f 0b 00 00       	push   $0xb5f
  a5:	6a 01                	push   $0x1
  a7:	e8 84 07 00 00       	call   830 <printf>
  ac:	83 c4 0c             	add    $0xc,%esp
  af:	68 a6 0b 00 00       	push   $0xba6
   }
   lock_release(&lock2);
   ...
   for (int i = 0; i < num_threads; i++) {
      ...
      assert(join_pid > 0);
  b4:	68 85 0b 00 00       	push   $0xb85
  b9:	6a 01                	push   $0x1
  bb:	e8 70 07 00 00       	call   830 <printf>
  c0:	5a                   	pop    %edx
  c1:	59                   	pop    %ecx
  c2:	68 99 0b 00 00       	push   $0xb99
  c7:	6a 01                	push   $0x1
  c9:	e8 62 07 00 00       	call   830 <printf>
  ce:	5b                   	pop    %ebx
  cf:	ff 35 e4 0f 00 00    	push   0xfe4
  d5:	e8 1f 06 00 00       	call   6f9 <kill>
  da:	e8 ea 05 00 00       	call   6c9 <exit>
   size = (unsigned int)sbrk(0);
  df:	83 ec 0c             	sub    $0xc,%esp
  e2:	6a 00                	push   $0x0
  e4:	e8 68 06 00 00       	call   751 <sbrk>
   while (global < num_threads) {
  e9:	83 c4 10             	add    $0x10,%esp
   size = (unsigned int)sbrk(0);
  ec:	a3 dc 0f 00 00       	mov    %eax,0xfdc
   while (global < num_threads) {
  f1:	a1 d4 0f 00 00       	mov    0xfd4,%eax
  f6:	39 05 e0 0f 00 00    	cmp    %eax,0xfe0
  fc:	7d 37                	jge    135 <main+0x135>
  fe:	66 90                	xchg   %ax,%ax
      lock_release(&lock);
 100:	83 ec 0c             	sub    $0xc,%esp
 103:	68 d9 0f 00 00       	push   $0xfd9
 108:	e8 a3 05 00 00       	call   6b0 <lock_release>
      sleep(100);
 10d:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
 114:	e8 40 06 00 00       	call   759 <sleep>
      lock_acquire(&lock);
 119:	c7 04 24 d9 0f 00 00 	movl   $0xfd9,(%esp)
 120:	e8 7b 05 00 00       	call   6a0 <lock_acquire>
   while (global < num_threads) {
 125:	a1 d4 0f 00 00       	mov    0xfd4,%eax
 12a:	83 c4 10             	add    $0x10,%esp
 12d:	39 05 e0 0f 00 00    	cmp    %eax,0xfe0
 133:	7c cb                	jl     100 <main+0x100>
   global = 0;
 135:	c7 05 e0 0f 00 00 00 	movl   $0x0,0xfe0
 13c:	00 00 00 
   sbrk(10000);
 13f:	83 ec 0c             	sub    $0xc,%esp
 142:	68 10 27 00 00       	push   $0x2710
 147:	e8 05 06 00 00       	call   751 <sbrk>
   size = (unsigned int)sbrk(0);
 14c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 153:	e8 f9 05 00 00       	call   751 <sbrk>
   lock_release(&lock);
 158:	c7 04 24 d9 0f 00 00 	movl   $0xfd9,(%esp)
   size = (unsigned int)sbrk(0);
 15f:	a3 dc 0f 00 00       	mov    %eax,0xfdc
   lock_release(&lock);
 164:	e8 47 05 00 00       	call   6b0 <lock_release>
   while (global < num_threads) {
 169:	a1 d4 0f 00 00       	mov    0xfd4,%eax
 16e:	83 c4 10             	add    $0x10,%esp
 171:	39 05 e0 0f 00 00    	cmp    %eax,0xfe0
 ...
 194:	e8 c0 05 00 00       	call   759 <sleep>
      lock_acquire(&lock2);
 199:	c7 04 24 d8 0f 00 00 	movl   $0xfd8,(%esp)
 1a0:	e8 fb 04 00 00       	call   6a0 <lock_acquire>
   while (global < num_threads) {
 1a5:	a1 d4 0f 00 00       	mov    0xfd4,%eax
 1aa:	83 c4 10             	add    $0x10,%esp
 1ad:	39 05 e0 0f 00 00    	cmp    %eax,0xfe0
 ...
 1f3:	68 5f 0b 00 00       	push   $0xb5f
 1f8:	6a 01                	push   $0x1
 1fa:	e8 31 06 00 00       	call   830 <printf>
 1ff:	83 c4 0c             	add    $0xc,%esp
 202:	68 b5 0b 00 00       	push   $0xbb5
 ...
 20c:	50                   	push   %eax
 20d:	50                   	push   %eax
 20e:	68 c2 0b 00 00       	push   $0xbc2
 213:	6a 01                	push   $0x1
 215:	e8 16 06 00 00       	call   830 <printf>
   exit();
 21a:	e8 aa 04 00 00       	call   6c9 <exit>
 21f:	90                   	nop
...
void worker(void *arg1, void *arg2) {
 ...
 223:	83 ec 14             	sub    $0x14,%esp
   lock_acquire(&lock);
 226:	68 d9 0f 00 00       	push   $0xfd9
 22b:	e8 70 04 00 00       	call   6a0 <lock_acquire>
   assert((unsigned int)sbrk(0) == size);
 230:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 237:	e8 15 05 00 00       	call   751 <sbrk>
 23c:	83 c4 10             	add    $0x10,%esp
 23f:	3b 05 dc 0f 00 00    	cmp    0xfdc,%eax
 ...
 24e:	68 5f 0b 00 00       	push   $0xb5f
 253:	6a 01                	push   $0x1
 255:	e8 d6 05 00 00       	call   830 <printf>
 25a:	83 c4 0c             	add    $0xc,%esp
 25d:	68 67 0b 00 00       	push   $0xb67
 262:	68 85 0b 00 00       	push   $0xb85
 267:	6a 01                	push   $0x1
 269:	e8 c2 05 00 00       	call   830 <printf>
 26e:	58                   	pop    %eax
 26f:	5a                   	pop    %edx
 270:	68 99 0b 00 00       	push   $0xb99
 275:	6a 01                	push   $0x1
 277:	e8 b4 05 00 00       	call   830 <printf>
 27c:	59                   	pop    %ecx
 27d:	ff 35 e4 0f 00 00    	push   0xfe4
 283:	e8 71 04 00 00       	call   6f9 <kill>
 288:	e8 3c 04 00 00       	call   6c9 <exit>
   lock_release(&lock);
 28d:	83 ec 0c             	sub    $0xc,%esp
   global++;
 290:	83 05 e0 0f 00 00 01 	addl   $0x1,0xfe0
   lock_release(&lock);
 297:	68 d9 0f 00 00       	push   $0xfd9
 29c:	e8 0f 04 00 00       	call   6b0 <lock_release>
   lock_acquire(&lock2);
 2a1:	c7 04 24 d8 0f 00 00 	movl   $0xfd8,(%esp)
 2a8:	e8 f3 03 00 00       	call   6a0 <lock_acquire>
   assert((unsigned int)sbrk(0) == size);
 2ad:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 2b4:	e8 98 04 00 00       	call   751 <sbrk>
 2b9:	83 c4 10             	add    $0x10,%esp
 2bc:	3b 05 dc 0f 00 00    	cmp    0xfdc,%eax
 ...
 2c8:	83 ec 0c             	sub    $0xc,%esp
   global++;
 2cb:	83 05 e0 0f 00 00 01 	addl   $0x1,0xfe0
   sbrk(10000);
 2d2:	68 10 27 00 00       	push   $0x2710
 2d7:	e8 75 04 00 00       	call   751 <sbrk>
   size = (unsigned int)sbrk(0);
 2dc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 2e3:	e8 69 04 00 00       	call   751 <sbrk>
   lock_release(&lock2);
 2e8:	c7 04 24 d8 0f 00 00 	movl   $0xfd8,(%esp)
   size = (unsigned int)sbrk(0);
 2ef:	a3 dc 0f 00 00       	mov    %eax,0xfdc
   lock_release(&lock2);
 2f4:	e8 b7 03 00 00       	call   6b0 <lock_release>
   ...
   exit();
 2f9:	e8 cb 03 00 00       	call   6c9 <exit>
 ...
 509:	31 db                	xor    %ebx,%ebx
{
 ...
 515:	57                   	push   %edi
 516:	6a 00                	push   $0x0
 518:	e8 c4 01 00 00       	call   6e1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 57d:	e8 87 01 00 00       	call   709 <open>
  if(fd < 0)
 ...
 591:	50                   	push   %eax
 592:	e8 8a 01 00 00       	call   721 <fstat>
  close(fd);
 597:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 59a:	89 c6                	mov    %eax,%esi
  close(fd);
 59c:	e8 50 01 00 00       	call   6f1 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 63c:	e8 1f 04 00 00       	call   a60 <malloc>
  // if((int) stack % 4096 != 0){
  //   stack = stack + (4096 - (int) stack % 4096);
  // }
  int rc = clone(start_routine, arg1, arg2, stack);
 641:	50                   	push   %eax
 642:	ff 75 10             	push   0x10(%ebp)
 645:	ff 75 0c             	push   0xc(%ebp)
 648:	ff 75 08             	push   0x8(%ebp)
 64b:	e8 19 01 00 00       	call   769 <clone>
 ...
 654:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 656:	68 ed 0b 00 00       	push   $0xbed
 65b:	6a 01                	push   $0x1
 65d:	e8 ce 01 00 00       	call   830 <printf>
  return rc;
}
...
thread_join(){
 ...
 678:	6a 04                	push   $0x4
 67a:	e8 e1 03 00 00       	call   a60 <malloc>
  int rc = join(stack);
 67f:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 682:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 684:	e8 e8 00 00 00       	call   771 <join>
 689:	89 c6                	mov    %eax,%esi
  free(*stack);
 68b:	58                   	pop    %eax
 68c:	ff 33                	push   (%ebx)
 68e:	e8 3d 03 00 00       	call   9d0 <free>
  return rc;
}
 693:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
000006c9 <exit>:
SYSCALL(exit)
 6c9:	b8 02 00 00 00       	mov    $0x2,%eax
 6ce:	cd 40                	int    $0x40
 6d0:	c3                   	ret    

000006d1 <wait>:
SYSCALL(wait)
 6d1:	b8 03 00 00 00       	mov    $0x3,%eax
 6d6:	cd 40                	int    $0x40
 6d8:	c3                   	ret    

000006d9 <pipe>:
SYSCALL(pipe)
 6d9:	b8 04 00 00 00       	mov    $0x4,%eax
 6de:	cd 40                	int    $0x40
 6e0:	c3                   	ret    

000006e1 <read>:
SYSCALL(read)
 6e1:	b8 05 00 00 00       	mov    $0x5,%eax
 6e6:	cd 40                	int    $0x40
 6e8:	c3                   	ret    

000006e9 <write>:
SYSCALL(write)
 6e9:	b8 10 00 00 00       	mov    $0x10,%eax
 6ee:	cd 40                	int    $0x40
 6f0:	c3                   	ret    

000006f1 <close>:
SYSCALL(close)
 6f1:	b8 15 00 00 00       	mov    $0x15,%eax
 6f6:	cd 40                	int    $0x40
 6f8:	c3                   	ret    

000006f9 <kill>:
SYSCALL(kill)
 6f9:	b8 06 00 00 00       	mov    $0x6,%eax
 6fe:	cd 40                	int    $0x40
 700:	c3                   	ret    

00000701 <exec>:
SYSCALL(exec)
 701:	b8 07 00 00 00       	mov    $0x7,%eax
 706:	cd 40                	int    $0x40
 708:	c3                   	ret    

00000709 <open>:
SYSCALL(open)
 709:	b8 0f 00 00 00       	mov    $0xf,%eax
 70e:	cd 40                	int    $0x40
 710:	c3                   	ret    

00000711 <mknod>:
SYSCALL(mknod)
 711:	b8 11 00 00 00       	mov    $0x11,%eax
 716:	cd 40                	int    $0x40
 718:	c3                   	ret    

00000719 <unlink>:
SYSCALL(unlink)
 719:	b8 12 00 00 00       	mov    $0x12,%eax
 71e:	cd 40                	int    $0x40
 720:	c3                   	ret    

00000721 <fstat>:
SYSCALL(fstat)
 721:	b8 08 00 00 00       	mov    $0x8,%eax
 726:	cd 40                	int    $0x40
 728:	c3                   	ret    

00000729 <link>:
SYSCALL(link)
 729:	b8 13 00 00 00       	mov    $0x13,%eax
 72e:	cd 40                	int    $0x40
 730:	c3                   	ret    

00000731 <mkdir>:
SYSCALL(mkdir)
 731:	b8 14 00 00 00       	mov    $0x14,%eax
 736:	cd 40                	int    $0x40
 738:	c3                   	ret    

00000739 <chdir>:
SYSCALL(chdir)
 739:	b8 09 00 00 00       	mov    $0x9,%eax
 73e:	cd 40                	int    $0x40
 740:	c3                   	ret    

00000741 <dup>:
SYSCALL(dup)
 741:	b8 0a 00 00 00       	mov    $0xa,%eax
 746:	cd 40                	int    $0x40
 748:	c3                   	ret    

00000749 <getpid>:
SYSCALL(getpid)
 749:	b8 0b 00 00 00       	mov    $0xb,%eax
 74e:	cd 40                	int    $0x40
 750:	c3                   	ret    

00000751 <sbrk>:
SYSCALL(sbrk)
 751:	b8 0c 00 00 00       	mov    $0xc,%eax
 756:	cd 40                	int    $0x40
 758:	c3                   	ret    

00000759 <sleep>:
SYSCALL(sleep)
 759:	b8 0d 00 00 00       	mov    $0xd,%eax
 75e:	cd 40                	int    $0x40
 760:	c3                   	ret    

00000761 <uptime>:
SYSCALL(uptime)
 761:	b8 0e 00 00 00       	mov    $0xe,%eax
 766:	cd 40                	int    $0x40
 768:	c3                   	ret    

00000769 <clone>:
SYSCALL(clone)
 769:	b8 16 00 00 00       	mov    $0x16,%eax
 76e:	cd 40                	int    $0x40
 770:	c3                   	ret    

00000771 <join>:
SYSCALL(join)
 771:	b8 17 00 00 00       	mov    $0x17,%eax
 776:	cd 40                	int    $0x40
 778:	c3                   	ret    
 ...
 78c:	89 d1                	mov    %edx,%ecx
{
 ...
 7b9:	0f b6 92 60 0c 00 00 	movzbl 0xc60(%edx),%edx
 ...
 7fe:	56                   	push   %esi
 7ff:	57                   	push   %edi
 800:	e8 e4 fe ff ff       	call   6e9 <write>
  while(--i >= 0)
 ...
 839:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 875:	57                   	push   %edi
 876:	56                   	push   %esi
 877:	e8 6d fe ff ff       	call   6e9 <write>
 ...
 8a9:	ff 24 85 08 0c 00 00 	jmp    *0xc08(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8ce:	e8 16 fe ff ff       	call   6e9 <write>
        putc(fd, c);
 ...
 8df:	57                   	push   %edi
 8e0:	56                   	push   %esi
 8e1:	e8 03 fe ff ff       	call   6e9 <write>
        putc(fd, c);
 ...
 94b:	57                   	push   %edi
 94c:	56                   	push   %esi
 94d:	e8 97 fd ff ff       	call   6e9 <write>
        while(*s != 0){
 ...
 98c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 98f:	e8 55 fd ff ff       	call   6e9 <write>
        ap++;
 ...
 9b7:	90                   	nop
          s = "(null)";
 9b8:	ba 01 0c 00 00       	mov    $0xc01,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 9d1:	a1 e8 0f 00 00       	mov    0xfe8,%eax
{
 ...
 a11:	5b                   	pop    %ebx
  freep = p;
 a12:	89 15 e8 0f 00 00    	mov    %edx,0xfe8
}
 a18:	5e                   	pop    %esi
 a19:	5f                   	pop    %edi
 a1a:	5d                   	pop    %ebp
 ...
 a49:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 a4c:	89 15 e8 0f 00 00    	mov    %edx,0xfe8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a69:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a6c:	8b 3d e8 0f 00 00    	mov    0xfe8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 aaf:	73 4f                	jae    b00 <malloc+0xa0>
    ...
    if(p == freep)
 ab1:	8b 3d e8 0f 00 00    	mov    0xfe8,%edi
 ...
 ac3:	e8 89 fc ff ff       	call   751 <sbrk>
  if(p == (char*)-1)
 ...
 ada:	e8 f1 fe ff ff       	call   9d0 <free>
  return freep;
 adf:	8b 15 e8 0f 00 00    	mov    0xfe8,%edx
 ...
 b0c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 b0f:	89 15 e8 0f 00 00    	mov    %edx,0xfe8
}
 ...
 b1f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 b20:	c7 05 e8 0f 00 00 ec 	movl   $0xfec,0xfe8
 b27:	0f 00 00 
    base.s.size = 0;
 b2a:	bf ec 0f 00 00       	mov    $0xfec,%edi
    base.s.ptr = freep = prevp = &base;
 b2f:	c7 05 ec 0f 00 00 ec 	movl   $0xfec,0xfec
 b36:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 b39:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 b3b:	c7 05 f0 0f 00 00 00 	movl   $0x0,0xff0
 b42:	00 00 00 
    if(p->s.size >= nunits){
