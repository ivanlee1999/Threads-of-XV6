...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 5e 39 00 00       	call   3989 <open>
    ...
    exit();
      40:	e8 04 39 00 00       	call   3949 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 33 39 00 00       	call   3989 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 13 39 00 00       	call   3971 <close>
  ...
  exit();
     10d:	e8 37 38 00 00       	call   3949 <exit>
...
00000120 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
     ...
     13d:	e8 6f 38 00 00       	call   39b1 <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 63 38 00 00       	call   39b9 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 2b 38 00 00       	call   3999 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 37 38 00 00       	call   39b9 <chdir>
  ...
  printf(stdout, "iput test ok\n");
    ...
    exit();
     1b3:	e8 91 37 00 00       	call   3949 <exit>
    ...
    exit();
     1ca:	e8 7a 37 00 00       	call   3949 <exit>
    ...
    exit();
     1e1:	e8 63 37 00 00       	call   3949 <exit>
    ...
    exit();
     1f8:	e8 4c 37 00 00       	call   3949 <exit>
...
00000200 <exitiputtest>:
{
  ...
  pid = fork();
     216:	e8 26 37 00 00       	call   3941 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 7c 37 00 00       	call   39b1 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 6c 37 00 00       	call   39b9 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 34 37 00 00       	call   3999 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 d8 36 00 00       	call   3949 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 d4 36 00 00       	call   3951 <wait>
  printf(stdout, "exitiput test ok\n");
     ...
     2a6:	e8 05 38 00 00       	call   3ab0 <printf>
      exit();
     2ab:	e8 99 36 00 00       	call   3949 <exit>
    ...
    exit();
     2c2:	e8 82 36 00 00       	call   3949 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     ...
     2d4:	e8 d7 37 00 00       	call   3ab0 <printf>
      exit();
     2d9:	e8 6b 36 00 00       	call   3949 <exit>
     ...
     2eb:	e8 c0 37 00 00       	call   3ab0 <printf>
      exit();
     2f0:	e8 54 36 00 00       	call   3949 <exit>
...
00000300 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     31d:	e8 8f 36 00 00       	call   39b1 <mkdir>
     322:	83 c4 10             	add    $0x10,%esp
     325:	85 c0                	test   %eax,%eax
     327:	0f 88 9f 00 00 00    	js     3cc <openiputtest+0xcc>
  pid = fork();
     32d:	e8 0f 36 00 00       	call   3941 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 42 36 00 00       	call   3989 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 94 35 00 00       	call   3949 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
    ...
    exit();
     3c7:	e8 7d 35 00 00       	call   3949 <exit>
    ...
    exit();
     3de:	e8 66 35 00 00       	call   3949 <exit>
    ...
    exit();
     3f5:	e8 4f 35 00 00       	call   3949 <exit>
...
00000400 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 65 35 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 3d 35 00 00       	call   3971 <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 d5 3e 00 00       	push   $0x3ed5
     43d:	e8 47 35 00 00       	call   3989 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
    ...
    exit();
     473:	e8 d1 34 00 00       	call   3949 <exit>
    ...
    exit();
     48a:	e8 ba 34 00 00       	call   3949 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 d0 34 00 00       	call   3989 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 79 34 00 00       	call   3969 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 5d 34 00 00       	call   3969 <write>
  ...
  close(fd);
     ...
     536:	e8 36 34 00 00       	call   3971 <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 1f 3f 00 00       	push   $0x3f1f
     544:	e8 40 34 00 00       	call   3989 <open>
  if(fd >= 0){
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 e5 33 00 00       	call   3961 <read>
  if(i == 2000){
  ...
  close(fd);
     ...
     5a0:	e8 cc 33 00 00       	call   3971 <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 1f 3f 00 00 	movl   $0x3f1f,(%esp)
     5ac:	e8 e8 33 00 00       	call   3999 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5e4:	e8 c7 34 00 00       	call   3ab0 <printf>
      exit();
     5e9:	e8 5b 33 00 00       	call   3949 <exit>
     ...
     5fd:	e8 ae 34 00 00       	call   3ab0 <printf>
      exit();
     602:	e8 42 33 00 00       	call   3949 <exit>
    ...
    exit();
     619:	e8 2b 33 00 00       	call   3949 <exit>
    ...
    exit();
     630:	e8 14 33 00 00       	call   3949 <exit>
    ...
    exit();
     647:	e8 fd 32 00 00       	call   3949 <exit>
    ...
    exit();
     65e:	e8 e6 32 00 00       	call   3949 <exit>
...
00000670 <writetest1>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 f0 32 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 a0 32 00 00       	call   3969 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 86 32 00 00       	call   3971 <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 67 40 00 00       	push   $0x4067
     6f4:	e8 90 32 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 27 32 00 00       	call   3961 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 1b 32 00 00       	call   3971 <close>
  if(unlink("big") < 0){
     756:	c7 04 24 67 40 00 00 	movl   $0x4067,(%esp)
     75d:	e8 37 32 00 00       	call   3999 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     799:	e8 12 33 00 00       	call   3ab0 <printf>
      exit();
     79e:	e8 a6 31 00 00       	call   3949 <exit>
     ...
     7b0:	e8 fb 32 00 00       	call   3ab0 <printf>
      exit();
     7b5:	e8 8f 31 00 00       	call   3949 <exit>
     ...
     7c9:	e8 e2 32 00 00       	call   3ab0 <printf>
      exit();
     7ce:	e8 76 31 00 00       	call   3949 <exit>
     ...
     7e4:	e8 c7 32 00 00       	call   3ab0 <printf>
        exit();
     7e9:	e8 5b 31 00 00       	call   3949 <exit>
    ...
    exit();
     800:	e8 44 31 00 00       	call   3949 <exit>
    ...
    exit();
     817:	e8 2d 31 00 00       	call   3949 <exit>
    ...
    exit();
     82e:	e8 16 31 00 00       	call   3949 <exit>
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 fe 30 00 00       	call   3989 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 de 30 00 00       	call   3971 <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 d3 30 00 00       	call   3999 <unlink>
  for(i = 0; i < 52; i++){
...
000008f0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
     ...
     90d:	e8 9f 30 00 00       	call   39b1 <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 93 30 00 00       	call   39b9 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 7b 30 00 00       	call   39b9 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 47 30 00 00       	call   3999 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
    ...
    exit();
     983:	e8 c1 2f 00 00       	call   3949 <exit>
    ...
    exit();
     99a:	e8 aa 2f 00 00       	call   3949 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
    ...
    exit();
     9b1:	e8 93 2f 00 00       	call   3949 <exit>
    ...
    exit();
     9c8:	e8 7c 2f 00 00       	call   3949 <exit>
...
000009d0 <exectest>:
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     9f2:	e8 8a 2f 00 00       	call   3981 <exec>
    ...
    exit();
     a12:	e8 32 2f 00 00       	call   3949 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 0f 2f 00 00       	call   3971 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 e4 2e 00 00       	call   3961 <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 95 2e 00 00       	call   3971 <close>
     ...
     b11:	e8 53 2e 00 00       	call   3969 <write>
    ...
    exit();
     b28:	e8 1c 2e 00 00       	call   3949 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 30 2e 00 00       	call   3971 <close>
    wait();
     b41:	e8 0b 2e 00 00       	call   3951 <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 44 2f 00 00       	call   3ab0 <printf>
      exit();
     b6c:	e8 d8 2d 00 00       	call   3949 <exit>
    ...
    exit();
     b7f:	e8 c5 2d 00 00       	call   3949 <exit>
    ...
    exit();
     b92:	e8 b2 2d 00 00       	call   3949 <exit>
     ...
     ba0:	e8 0b 2f 00 00       	call   3ab0 <printf>
        exit();
     ba5:	e8 9f 2d 00 00       	call   3949 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 77 2d 00 00       	call   3941 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 62 2d 00 00       	call   3941 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 5d 2d 00 00       	call   3959 <pipe>
  pid3 = fork();
     bfc:	e8 40 2d 00 00       	call   3941 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 33 2d 00 00       	call   3971 <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 f6 2c 00 00       	call   3971 <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 e8 2c 00 00       	call   3979 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 e0 2c 00 00       	call   3979 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 d8 2c 00 00       	call   3979 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 9d 2c 00 00       	call   3951 <wait>
  wait();
     cb4:	e8 98 2c 00 00       	call   3951 <wait>
  wait();
     cb9:	e8 93 2c 00 00       	call   3951 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 2a 2c 00 00       	call   3951 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 0c 2c 00 00       	call   3941 <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 ba 2b 00 00       	call   3949 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 1e 2c 00 00       	call   39c9 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 8f 2b 00 00       	call   3941 <fork>
    ...
    exit();
     e1f:	e8 25 2b 00 00       	call   3949 <exit>
     ...
     e3a:	e8 3a 2b 00 00       	call   3979 <kill>
      exit();
     e3f:	e8 05 2b 00 00       	call   3949 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 fe 2a 00 00       	jmp    3951 <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 18 2b 00 00       	call   3999 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 13 42 00 00       	push   $0x4213
     e8d:	e8 f7 2a 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 95 2a 00 00       	call   3941 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 88 2a 00 00       	call   3969 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 46 2a 00 00       	call   3951 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 58 2a 00 00       	call   3971 <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 13 42 00 00       	push   $0x4213
     f22:	e8 62 2a 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 10 2a 00 00       	call   3961 <read>
  ...
  close(fd);
     ...
     f86:	e8 e6 29 00 00       	call   3971 <close>
  unlink("sharedfd");
     f8b:	c7 04 24 13 42 00 00 	movl   $0x4213,(%esp)
     f92:	e8 02 2a 00 00       	call   3999 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 49 29 00 00       	call   3949 <exit>
    ...
    exit();
    100e:	e8 36 29 00 00       	call   3949 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 35 29 00 00       	call   3999 <unlink>
    pid = fork();
    1064:	e8 d8 28 00 00       	call   3941 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 c4 28 00 00       	call   3951 <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 bd 28 00 00       	call   3951 <wait>
    1094:	e8 b8 28 00 00       	call   3951 <wait>
    1099:	e8 b3 28 00 00       	call   3951 <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 d7 28 00 00       	call   3989 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 8c 28 00 00       	call   3961 <read>
    ...
    1104:	e8 68 28 00 00       	call   3971 <close>
    if(total != 12*500){
    ...
    111e:	e8 76 28 00 00       	call   3999 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 52 29 00 00       	call   3ab0 <printf>
          exit();
    115e:	e8 e6 27 00 00       	call   3949 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 18 28 00 00       	call   3989 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 be 27 00 00       	call   3969 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 8a 27 00 00       	call   3949 <exit>
    ...
    11c8:	e8 e3 28 00 00       	call   3ab0 <printf>
        exit();
    11cd:	e8 77 27 00 00       	call   3949 <exit>
    ...
    11e2:	e8 c9 28 00 00       	call   3ab0 <printf>
      exit();
    11e7:	e8 5d 27 00 00       	call   3949 <exit>
    ...
    11f5:	e8 b6 28 00 00       	call   3ab0 <printf>
      exit();
    11fa:	e8 4a 27 00 00       	call   3949 <exit>
    ...
    1208:	e8 a3 28 00 00       	call   3ab0 <printf>
          exit();
    120d:	e8 37 27 00 00       	call   3949 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 02 27 00 00       	call   3941 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 f7 26 00 00       	call   3951 <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 ed 26 00 00       	call   3951 <wait>
    1264:	e8 e8 26 00 00       	call   3951 <wait>
    1269:	e8 e3 26 00 00       	call   3951 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 db 26 00 00       	call   3989 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 9f 26 00 00       	call   3971 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 89 26 00 00       	call   3999 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 5e 27 00 00       	call   3ab0 <printf>
        exit();
    1352:	e8 f2 25 00 00       	call   3949 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 ea 25 00 00       	call   3989 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 c2 25 00 00       	call   3971 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 cb 25 00 00       	call   3999 <unlink>
    ...
    13de:	e8 cd 26 00 00       	call   3ab0 <printf>
            exit();
    13e3:	e8 61 25 00 00       	call   3949 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 54 25 00 00       	call   3949 <exit>
    ...
    1400:	e8 ab 26 00 00       	call   3ab0 <printf>
        exit();
    1405:	e8 3f 25 00 00       	call   3949 <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 97 26 00 00       	call   3ab0 <printf>
      exit();
    1419:	e8 2b 25 00 00       	call   3949 <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 83 26 00 00       	call   3ab0 <printf>
          exit();
    142d:	e8 17 25 00 00       	call   3949 <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 24 25 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 e7 24 00 00       	call   3969 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 e7 24 00 00       	call   3971 <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 c5 42 00 00       	push   $0x42c5
    1493:	e8 f1 24 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 e7 24 00 00       	call   3999 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 ba 24 00 00       	call   3989 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 48 24 00 00       	call   3969 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 3f 24 00 00       	call   3971 <close>
  unlink("unlinkread");
    1532:	c7 04 24 c5 42 00 00 	movl   $0x42c5,(%esp)
    1539:	e8 5b 24 00 00       	call   3999 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 e0 23 00 00       	call   3949 <exit>
    ...
    exit();
    1577:	e8 cd 23 00 00       	call   3949 <exit>
    ...
    exit();
    158a:	e8 ba 23 00 00       	call   3949 <exit>
    ...
    exit();
    159d:	e8 a7 23 00 00       	call   3949 <exit>
    ...
    exit();
    15b0:	e8 94 23 00 00       	call   3949 <exit>
    ...
    exit();
    15c3:	e8 81 23 00 00       	call   3949 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 40 23 00 00       	call   3969 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 33 23 00 00       	call   3971 <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 8a 43 00 00       	push   $0x438a
    1645:	68 86 43 00 00       	push   $0x4386
    164a:	e8 5a 23 00 00       	call   39a9 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 32 23 00 00       	call   3999 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 86 43 00 00       	push   $0x4386
    1670:	e8 14 23 00 00       	call   3989 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 fa 22 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 b2 22 00 00       	call   3961 <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 ad 22 00 00       	call   3971 <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 8a 43 00 00       	push   $0x438a
    16cb:	68 8a 43 00 00       	push   $0x438a
    16d0:	e8 d4 22 00 00       	call   39a9 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 ac 22 00 00       	call   3999 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 86 43 00 00       	push   $0x4386
    16f4:	68 8a 43 00 00       	push   $0x438a
    16f9:	e8 ab 22 00 00       	call   39a9 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 92 22 00 00       	call   39a9 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 01 22 00 00       	call   3949 <exit>
    ...
    exit();
    1756:	e8 ee 21 00 00       	call   3949 <exit>
    ...
    exit();
    1769:	e8 db 21 00 00       	call   3949 <exit>
    ...
    exit();
    177c:	e8 c8 21 00 00       	call   3949 <exit>
    ...
    exit();
    178f:	e8 b5 21 00 00       	call   3949 <exit>
    ...
    exit();
    17a2:	e8 a2 21 00 00       	call   3949 <exit>
    ...
    exit();
    17b5:	e8 8f 21 00 00       	call   3949 <exit>
    ...
    exit();
    17c8:	e8 7c 21 00 00       	call   3949 <exit>
    ...
    exit();
    17db:	e8 69 21 00 00       	call   3949 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 5a 21 00 00       	call   3989 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 2f 21 00 00       	call   3971 <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 07 21 00 00       	call   3951 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 37 21 00 00       	call   3999 <unlink>
    pid = fork();
    1862:	e8 da 20 00 00       	call   3941 <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 ff 20 00 00       	call   3989 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 c8 20 00 00       	call   39a9 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 68 20 00 00       	call   3951 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 76 20 00 00       	call   3989 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 35 20 00 00       	call   3961 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 f8 1f 00 00       	call   3971 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 f7 1f 00 00       	call   3999 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 ef 1f 00 00       	call   3999 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 e7 1f 00 00       	call   3999 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 df 1f 00 00       	call   3999 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 87 1f 00 00       	call   3951 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 60 1f 00 00       	call   3941 <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 79 1f 00 00       	call   3989 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 59 1f 00 00       	call   3971 <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 67 1f 00 00       	call   3989 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 47 1f 00 00       	call   3971 <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 55 1f 00 00       	call   3989 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 35 1f 00 00       	call   3971 <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 43 1f 00 00       	call   3989 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 23 1f 00 00       	call   3971 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 2a 20 00 00       	call   3ab0 <printf>
      exit();
    1a86:	e8 be 1e 00 00       	call   3949 <exit>
    ...
    exit();
    1a99:	e8 ab 1e 00 00       	call   3949 <exit>
    ...
    1aac:	e8 ff 1f 00 00       	call   3ab0 <printf>
        exit();
    1ab1:	e8 93 1e 00 00       	call   3949 <exit>
    ...
    1ac4:	e8 e7 1f 00 00       	call   3ab0 <printf>
        exit();
    1ac9:	e8 7b 1e 00 00       	call   3949 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 9a 1e 00 00       	call   3971 <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 98 1e 00 00       	call   3999 <unlink>
  pid = fork();
    1b01:	e8 3b 1e 00 00       	call   3941 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 57 1e 00 00       	call   3999 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 0e 1e 00 00       	call   3989 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 ee 1d 00 00       	call   3971 <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 ba 1d 00 00       	call   3951 <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 e7 1d 00 00       	call   39a9 <link>
    ...
    exit();
    1bd8:	e8 6c 1d 00 00       	call   3949 <exit>
    exit();
    1bdd:	e8 67 1d 00 00       	call   3949 <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 88 1d 00 00       	call   3999 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 d5 44 00 00       	push   $0x44d5
    1c1d:	e8 67 1d 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 36 1d 00 00       	call   3971 <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 3d 1d 00 00       	call   39a9 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 0c 1d 00 00       	call   3999 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 e2 1c 00 00       	call   3999 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 be 1d 00 00       	call   3ab0 <printf>
      exit();
    1cf2:	e8 52 1c 00 00       	call   3949 <exit>
    ...
    1d01:	e8 aa 1d 00 00       	call   3ab0 <printf>
      exit();
    1d06:	e8 3e 1c 00 00       	call   3949 <exit>
    ...
    exit();
    1d19:	e8 2b 1c 00 00       	call   3949 <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 5a 1c 00 00       	call   3999 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 48 46 00 00 	movl   $0x4648,(%esp)
    1d46:	e8 66 1c 00 00       	call   39b1 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 21 1c 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 e4 1b 00 00       	call   3969 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 e4 1b 00 00       	call   3971 <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 48 46 00 00 	movl   $0x4648,(%esp)
    1d94:	e8 00 1c 00 00       	call   3999 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 00 1c 00 00       	call   39b1 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 bb 1b 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 7e 1b 00 00       	call   3969 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 7e 1b 00 00       	call   3971 <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 a2 45 00 00       	push   $0x45a2
    1dfc:	e8 88 1b 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 40 1b 00 00       	call   3961 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 2e 1b 00 00       	call   3971 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 e2 45 00 00       	push   $0x45e2
    1e4a:	68 7e 45 00 00       	push   $0x457e
    1e4f:	e8 55 1b 00 00       	call   39a9 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 2d 1b 00 00       	call   3999 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 03 1b 00 00       	call   3989 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 1b 1b 00 00       	call   39b9 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 03 1b 00 00       	call   39b9 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 eb 1a 00 00       	call   39b9 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 d3 1a 00 00       	call   39b9 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 89 1a 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 41 1a 00 00       	call   3961 <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 3c 1a 00 00       	call   3971 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 7e 45 00 00       	push   $0x457e
    1f3e:	e8 46 1a 00 00       	call   3989 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 29 1a 00 00       	call   3989 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 0c 1a 00 00       	call   3989 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 ef 19 00 00       	call   3989 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 d5 19 00 00       	call   3989 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 bb 19 00 00       	call   3989 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 be 19 00 00       	call   39a9 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 a1 19 00 00       	call   39a9 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 84 19 00 00       	call   39a9 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 74 19 00 00       	call   39b1 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 5c 19 00 00       	call   39b1 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 44 19 00 00       	call   39b1 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 14 19 00 00       	call   3999 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 fc 18 00 00       	call   3999 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 04 19 00 00       	call   39b9 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 ec 18 00 00       	call   39b9 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 b4 18 00 00       	call   3999 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 9c 18 00 00       	call   3999 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 84 18 00 00       	call   3999 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 6c 18 00 00       	call   3999 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 54 18 00 00       	call   3999 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 cf 17 00 00       	call   3949 <exit>
    ...
    exit();
    2188:	e8 bc 17 00 00       	call   3949 <exit>
    ...
    exit();
    219b:	e8 a9 17 00 00       	call   3949 <exit>
    ...
    exit();
    21ae:	e8 96 17 00 00       	call   3949 <exit>
    ...
    exit();
    21c1:	e8 83 17 00 00       	call   3949 <exit>
    ...
    exit();
    21d4:	e8 70 17 00 00       	call   3949 <exit>
    ...
    exit();
    21e7:	e8 5d 17 00 00       	call   3949 <exit>
    ...
    exit();
    21fa:	e8 4a 17 00 00       	call   3949 <exit>
    ...
    exit();
    220d:	e8 37 17 00 00       	call   3949 <exit>
    ...
    exit();
    2220:	e8 24 17 00 00       	call   3949 <exit>
    ...
    exit();
    2233:	e8 11 17 00 00       	call   3949 <exit>
    ...
    exit();
    2246:	e8 fe 16 00 00       	call   3949 <exit>
    ...
    exit();
    2259:	e8 eb 16 00 00       	call   3949 <exit>
    ...
    exit();
    226c:	e8 d8 16 00 00       	call   3949 <exit>
    ...
    exit();
    227f:	e8 c5 16 00 00       	call   3949 <exit>
    ...
    exit();
    2292:	e8 b2 16 00 00       	call   3949 <exit>
    ...
    exit();
    22a5:	e8 9f 16 00 00       	call   3949 <exit>
    ...
    exit();
    22b8:	e8 8c 16 00 00       	call   3949 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 79 16 00 00       	call   3949 <exit>
    ...
    exit();
    22de:	e8 66 16 00 00       	call   3949 <exit>
    ...
    exit();
    22f1:	e8 53 16 00 00       	call   3949 <exit>
    ...
    exit();
    2304:	e8 40 16 00 00       	call   3949 <exit>
    ...
    exit();
    2317:	e8 2d 16 00 00       	call   3949 <exit>
    ...
    exit();
    232a:	e8 1a 16 00 00       	call   3949 <exit>
    ...
    exit();
    233d:	e8 07 16 00 00       	call   3949 <exit>
    ...
    exit();
    2350:	e8 f4 15 00 00       	call   3949 <exit>
    ...
    exit();
    2363:	e8 e1 15 00 00       	call   3949 <exit>
    ...
    exit();
    2376:	e8 ce 15 00 00       	call   3949 <exit>
    ...
    exit();
    2389:	e8 bb 15 00 00       	call   3949 <exit>
    ...
    exit();
    239c:	e8 a8 15 00 00       	call   3949 <exit>
    ...
    exit();
    23af:	e8 95 15 00 00       	call   3949 <exit>
    ...
    exit();
    23c2:	e8 82 15 00 00       	call   3949 <exit>
    ...
    exit();
    23d5:	e8 6f 15 00 00       	call   3949 <exit>
    ...
    exit();
    23e8:	e8 5c 15 00 00       	call   3949 <exit>
    ...
    exit();
    23fb:	e8 49 15 00 00       	call   3949 <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 74 15 00 00       	call   3999 <unlink>
    ...
    243d:	e8 47 15 00 00       	call   3989 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 0f 15 00 00       	call   3969 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 f9 14 00 00       	call   3969 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 eb 14 00 00       	call   3971 <close>
    unlink("bigwrite");
    2486:	c7 04 24 44 48 00 00 	movl   $0x4844,(%esp)
    248d:	e8 07 15 00 00       	call   3999 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 ec 15 00 00       	call   3ab0 <printf>
        exit();
    24c4:	e8 80 14 00 00       	call   3949 <exit>
    ...
    24d3:	e8 d8 15 00 00       	call   3ab0 <printf>
      exit();
    24d8:	e8 6c 14 00 00       	call   3949 <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 98 14 00 00       	call   3999 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 a0 48 00 00       	push   $0x48a0
    250d:	e8 77 14 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 1b 14 00 00       	call   3969 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 04 14 00 00       	call   3971 <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 a0 48 00 00       	push   $0x48a0
    2576:	e8 0e 14 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 90 13 00 00       	call   3961 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 8e 13 00 00       	call   3971 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 9a 13 00 00       	call   3999 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 89 14 00 00       	call   3ab0 <printf>
      exit();
    2627:	e8 1d 13 00 00       	call   3949 <exit>
    ...
    2636:	e8 75 14 00 00       	call   3ab0 <printf>
      exit();
    263b:	e8 09 13 00 00       	call   3949 <exit>
    ...
    264a:	e8 61 14 00 00       	call   3ab0 <printf>
      exit();
    264f:	e8 f5 12 00 00       	call   3949 <exit>
    ...
    265e:	e8 4d 14 00 00       	call   3ab0 <printf>
      exit();
    2663:	e8 e1 12 00 00       	call   3949 <exit>
    ...
    exit();
    2676:	e8 ce 12 00 00       	call   3949 <exit>
    ...
    exit();
    2689:	e8 bb 12 00 00       	call   3949 <exit>
    ...
    exit();
    269c:	e8 a8 12 00 00       	call   3949 <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 e3 12 00 00       	call   39b1 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 cb 12 00 00       	call   39b1 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 86 12 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 5a 12 00 00       	call   3971 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 f8 51 00 00       	push   $0x51f8
    2720:	e8 64 12 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 3c 12 00 00       	call   3971 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 6c 49 00 00 	movl   $0x496c,(%esp)
    273c:	e8 70 12 00 00       	call   39b1 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 5c 12 00 00       	call   39b1 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 c6 11 00 00       	call   3949 <exit>
    ...
    exit();
    2791:	e8 b3 11 00 00       	call   3949 <exit>
    ...
    exit();
    27a4:	e8 a0 11 00 00       	call   3949 <exit>
    ...
    exit();
    27b7:	e8 8d 11 00 00       	call   3949 <exit>
    ...
    exit();
    27ca:	e8 7a 11 00 00       	call   3949 <exit>
    ...
    exit();
    27dd:	e8 67 11 00 00       	call   3949 <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 a3 11 00 00       	call   39b1 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 93 11 00 00       	call   39b9 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 5b 11 00 00       	call   3999 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 43 11 00 00       	call   3999 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 4b 11 00 00       	call   39b9 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 13 11 00 00       	call   3999 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 ff 10 00 00       	call   3999 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 eb 10 00 00       	call   3999 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 6d 10 00 00       	call   3949 <exit>
    ...
    exit();
    28ea:	e8 5a 10 00 00       	call   3949 <exit>
    ...
    exit();
    28fd:	e8 47 10 00 00       	call   3949 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 34 10 00 00       	call   3949 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 21 10 00 00       	call   3949 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 0e 10 00 00       	call   3949 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 fb 0f 00 00       	call   3949 <exit>
    ...
    exit();
    295c:	e8 e8 0f 00 00       	call   3949 <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 f5 0f 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 c9 0f 00 00       	call   3971 <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 55 4a 00 00 	movl   $0x4a55,(%esp)
    29af:	e8 05 10 00 00       	call   39b9 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 bb 0f 00 00       	call   3989 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 9e 0f 00 00       	call   3989 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 ae 0f 00 00       	call   39b1 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 7e 0f 00 00       	call   3999 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 71 0f 00 00       	call   39a9 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 49 0f 00 00       	call   3999 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 1f 0f 00 00       	call   3989 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 05 0f 00 00       	call   3989 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 d3 0e 00 00       	call   3969 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 cb 0e 00 00       	call   3971 <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 7a 0e 00 00       	call   3949 <exit>
    ...
    exit();
    2add:	e8 67 0e 00 00       	call   3949 <exit>
    ...
    exit();
    2af0:	e8 54 0e 00 00       	call   3949 <exit>
    ...
    exit();
    2b03:	e8 41 0e 00 00       	call   3949 <exit>
    ...
    exit();
    2b16:	e8 2e 0e 00 00       	call   3949 <exit>
    ...
    exit();
    2b29:	e8 1b 0e 00 00       	call   3949 <exit>
    ...
    exit();
    2b3c:	e8 08 0e 00 00       	call   3949 <exit>
    ...
    exit();
    2b4f:	e8 f5 0d 00 00       	call   3949 <exit>
    ...
    exit();
    2b62:	e8 e2 0d 00 00       	call   3949 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 14 0e 00 00       	call   39b1 <mkdir>
    ...
    2bb0:	e8 04 0e 00 00       	call   39b9 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 4d 0d 00 00       	call   3971 <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 30 47 00 00       	push   $0x4730
    2c2f:	e8 65 0d 00 00       	call   3999 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 6c 0d 00 00       	call   39b9 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 3e 0e 00 00       	call   3ab0 <printf>
      exit();
    2c72:	e8 d2 0c 00 00       	call   3949 <exit>
    ...
    2c81:	e8 2a 0e 00 00       	call   3ab0 <printf>
      exit();
    2c86:	e8 be 0c 00 00       	call   3949 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 7f 0c 00 00       	call   3941 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 7c 0c 00 00       	call   3951 <wait>
  ...
  if(wait() != -1){
    2cde:	e8 6e 0c 00 00       	call   3951 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 48 0c 00 00       	call   3949 <exit>
    ...
    2d0b:	e8 a0 0d 00 00       	call   3ab0 <printf>
      exit();
    2d10:	e8 34 0c 00 00       	call   3949 <exit>
    ...
    exit();
    2d23:	e8 21 0c 00 00       	call   3949 <exit>
    ...
    exit();
    2d36:	e8 0e 0c 00 00       	call   3949 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  oldbrk = sbrk(0);
    ...
    2d62:	e8 6a 0c 00 00       	call   39d1 <sbrk>
  a = sbrk(0);
    2d67:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d6e:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d71:	e8 5b 0c 00 00       	call   39d1 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 45 0c 00 00       	call   39d1 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 94 0b 00 00       	call   3941 <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 0d 0c 00 00       	call   39d1 <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 01 0c 00 00       	call   39d1 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 69 0b 00 00       	call   3951 <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 df 0b 00 00       	call   39d1 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 ce 0b 00 00       	call   39d1 <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 b9 0b 00 00       	call   39d1 <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 ab 0b 00 00       	call   39d1 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 95 0b 00 00       	call   39d1 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 7a 0b 00 00       	call   39d1 <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 6c 0b 00 00       	call   39d1 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 55 0b 00 00       	call   39d1 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 ec 0a 00 00       	call   39c9 <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 5d 0a 00 00       	call   3941 <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 5a 0a 00 00       	call   3951 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 48 0a 00 00       	call   3959 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 14 0a 00 00       	call   3941 <fork>
    ...
    2f48:	e8 14 0a 00 00       	call   3961 <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 6d 0a 00 00       	call   39d1 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 f9 09 00 00       	call   3979 <kill>
    wait();
    2f80:	e8 cc 09 00 00       	call   3951 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 2f 0a 00 00       	call   39d1 <sbrk>
    2fa2:	83 c4 10             	add    $0x10,%esp
    2fa5:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fa8:	72 68                	jb     3012 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2faa:	83 ec 08             	sub    $0x8,%esp
    2fad:	68 70 4c 00 00       	push   $0x4c70
    2fb2:	ff 35 4c 5f 00 00    	push   0x5f4c
    2fb8:	e8 f3 0a 00 00       	call   3ab0 <printf>
}
    ...
    304c:	e8 f8 08 00 00       	call   3949 <exit>
      printf(stdout, "fork failed\n");
    ...
    305f:	e8 4c 0a 00 00       	call   3ab0 <printf>
      exit();
    3064:	e8 e0 08 00 00       	call   3949 <exit>
    ...
    3081:	e8 f3 08 00 00       	call   3979 <kill>
      exit();
    3086:	e8 be 08 00 00       	call   3949 <exit>
    ...
    exit();
    309d:	e8 a7 08 00 00       	call   3949 <exit>
    ...
    exit();
    30b4:	e8 90 08 00 00       	call   3949 <exit>
    ...
    exit();
    30cb:	e8 79 08 00 00       	call   3949 <exit>
    ...
    exit();
    30e2:	e8 62 08 00 00       	call   3949 <exit>
    ...
    exit();
    30f9:	e8 4b 08 00 00       	call   3949 <exit>
    printf(1, "pipe() failed\n");
    30fe:	52                   	push   %edx
    30ff:	52                   	push   %edx
    ...
    exit();
    310c:	e8 38 08 00 00       	call   3949 <exit>
    exit();
    3111:	e8 33 08 00 00       	call   3949 <exit>
    ...
    exit();
    3128:	e8 1c 08 00 00       	call   3949 <exit>
    ...
    exit();
    313f:	e8 05 08 00 00       	call   3949 <exit>
    ...
    exit();
    3156:	e8 ee 07 00 00       	call   3949 <exit>
    ...
    exit();
    316d:	e8 d7 07 00 00       	call   3949 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    if((pid = fork()) == 0){
    31b0:	e8 8c 07 00 00       	call   3941 <fork>
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 14 08 00 00       	call   39d9 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 08 08 00 00       	call   39d9 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 a0 07 00 00       	call   3979 <kill>
    wait();
    31d9:	e8 73 07 00 00       	call   3951 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 8d 4c 00 00       	push   $0x4c8d
    31e6:	e8 be 07 00 00       	call   39a9 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 26 07 00 00       	call   3949 <exit>
    ...
    3231:	e8 7a 08 00 00       	call   3ab0 <printf>
      exit();
    3236:	e8 0e 07 00 00       	call   3949 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    3299:	e8 12 08 00 00       	call   3ab0 <printf>
      exit();
    329e:	e8 a6 06 00 00       	call   3949 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 d9 06 00 00       	call   3999 <unlink>
  pid = fork();
    32c0:	e8 7c 06 00 00       	call   3941 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 7a 06 00 00       	call   3951 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 e6 4c 00 00       	push   $0x4ce6
    32e1:	e8 a3 06 00 00       	call   3989 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 77 06 00 00       	call   3971 <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 e6 4c 00 00 	movl   $0x4ce6,(%esp)
    3301:	e8 93 06 00 00       	call   3999 <unlink>
}
    ...
    3310:	c7 04 85 a0 a6 00 00 	movl   $0x5440,0xa6a0(,%eax,4)
    3317:	40 54 00 00 
    ...
    334b:	e8 31 06 00 00       	call   3981 <exec>
    ...
    336e:	e8 16 06 00 00       	call   3989 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 f6 05 00 00       	call   3971 <close>
    exit();
    337b:	e8 c9 05 00 00       	call   3949 <exit>
    ...
    exit();
    3392:	e8 b2 05 00 00       	call   3949 <exit>
    ...
    exit();
    33a9:	e8 9b 05 00 00       	call   3949 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 2b 05 00 00       	call   3989 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 e4 04 00 00       	call   3969 <write>
      if(cc < 512)
    ...
    34a2:	e8 ca 04 00 00       	call   3971 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 48 04 00 00       	call   3999 <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 aa 03 00 00       	call   3941 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 ac 03 00 00       	call   3951 <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 6c 03 00 00       	call   3949 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 59 03 00 00       	call   3949 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 86 03 00 00       	call   3989 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 bb 03 00 00       	call   39d1 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 3c 03 00 00       	call   3961 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 44 03 00 00       	call   3971 <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3651:	e8 f3 02 00 00       	call   3949 <exit>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 a4 01 00 00       	call   3961 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 67 01 00 00       	call   3989 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 6a 01 00 00       	call   39a1 <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 30 01 00 00       	call   3971 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
  ...
  void* stack = malloc(sizeof(void*));
    38d6:	6a 04                	push   $0x4
    38d8:	e8 03 04 00 00       	call   3ce0 <malloc>
  return clone(start_routine, arg1, arg2, stack);
    38dd:	50                   	push   %eax
    38de:	ff 75 10             	push   0x10(%ebp)
    38e1:	ff 75 0c             	push   0xc(%ebp)
    38e4:	ff 75 08             	push   0x8(%ebp)
    38e7:	e8 fd 00 00 00       	call   39e9 <clone>
}
    38ec:	c9                   	leave  
    38ed:	c3                   	ret    
    38ee:	66 90                	xchg   %ax,%ax

000038f0 <thread_join>:
...
thread_join(){
  ...
  void** stack = malloc(sizeof(void*));
    ...
    38f8:	6a 04                	push   $0x4
    38fa:	e8 e1 03 00 00       	call   3ce0 <malloc>
  int rc = join(stack);
    38ff:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
    3902:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
    3904:	e8 e8 00 00 00       	call   39f1 <join>
    3909:	89 c6                	mov    %eax,%esi
  free(*stack);
    390b:	58                   	pop    %eax
    390c:	ff 33                	push   (%ebx)
    390e:	e8 3d 03 00 00       	call   3c50 <free>
  return rc;
}
    3913:	8d 65 f8             	lea    -0x8(%ebp),%esp
    3916:	89 f0                	mov    %esi,%eax
    3918:	5b                   	pop    %ebx
    3919:	5e                   	pop    %esi
    391a:	5d                   	pop    %ebp
    391b:	c3                   	ret    
...
SYSCALL(fork)
    3941:	b8 01 00 00 00       	mov    $0x1,%eax
    3946:	cd 40                	int    $0x40
    3948:	c3                   	ret    
...
00003951 <wait>:
SYSCALL(wait)
    3951:	b8 03 00 00 00       	mov    $0x3,%eax
    3956:	cd 40                	int    $0x40
    3958:	c3                   	ret    

00003959 <pipe>:
SYSCALL(pipe)
    3959:	b8 04 00 00 00       	mov    $0x4,%eax
    395e:	cd 40                	int    $0x40
    3960:	c3                   	ret    

00003961 <read>:
SYSCALL(read)
    3961:	b8 05 00 00 00       	mov    $0x5,%eax
    3966:	cd 40                	int    $0x40
    3968:	c3                   	ret    

00003969 <write>:
SYSCALL(write)
    3969:	b8 10 00 00 00       	mov    $0x10,%eax
    396e:	cd 40                	int    $0x40
    3970:	c3                   	ret    

00003971 <close>:
SYSCALL(close)
    3971:	b8 15 00 00 00       	mov    $0x15,%eax
    3976:	cd 40                	int    $0x40
    3978:	c3                   	ret    

00003979 <kill>:
SYSCALL(kill)
    3979:	b8 06 00 00 00       	mov    $0x6,%eax
    397e:	cd 40                	int    $0x40
    3980:	c3                   	ret    

00003981 <exec>:
SYSCALL(exec)
    3981:	b8 07 00 00 00       	mov    $0x7,%eax
    3986:	cd 40                	int    $0x40
    3988:	c3                   	ret    

00003989 <open>:
SYSCALL(open)
    3989:	b8 0f 00 00 00       	mov    $0xf,%eax
    398e:	cd 40                	int    $0x40
    3990:	c3                   	ret    

00003991 <mknod>:
SYSCALL(mknod)
    3991:	b8 11 00 00 00       	mov    $0x11,%eax
    3996:	cd 40                	int    $0x40
    3998:	c3                   	ret    

00003999 <unlink>:
SYSCALL(unlink)
    3999:	b8 12 00 00 00       	mov    $0x12,%eax
    399e:	cd 40                	int    $0x40
    39a0:	c3                   	ret    

000039a1 <fstat>:
SYSCALL(fstat)
    39a1:	b8 08 00 00 00       	mov    $0x8,%eax
    39a6:	cd 40                	int    $0x40
    39a8:	c3                   	ret    

000039a9 <link>:
SYSCALL(link)
    39a9:	b8 13 00 00 00       	mov    $0x13,%eax
    39ae:	cd 40                	int    $0x40
    39b0:	c3                   	ret    

000039b1 <mkdir>:
SYSCALL(mkdir)
    39b1:	b8 14 00 00 00       	mov    $0x14,%eax
    39b6:	cd 40                	int    $0x40
    39b8:	c3                   	ret    

000039b9 <chdir>:
SYSCALL(chdir)
    39b9:	b8 09 00 00 00       	mov    $0x9,%eax
    39be:	cd 40                	int    $0x40
    39c0:	c3                   	ret    

000039c1 <dup>:
SYSCALL(dup)
    39c1:	b8 0a 00 00 00       	mov    $0xa,%eax
    39c6:	cd 40                	int    $0x40
    39c8:	c3                   	ret    

000039c9 <getpid>:
SYSCALL(getpid)
    39c9:	b8 0b 00 00 00       	mov    $0xb,%eax
    39ce:	cd 40                	int    $0x40
    39d0:	c3                   	ret    

000039d1 <sbrk>:
SYSCALL(sbrk)
    39d1:	b8 0c 00 00 00       	mov    $0xc,%eax
    39d6:	cd 40                	int    $0x40
    39d8:	c3                   	ret    

000039d9 <sleep>:
SYSCALL(sleep)
    39d9:	b8 0d 00 00 00       	mov    $0xd,%eax
    39de:	cd 40                	int    $0x40
    39e0:	c3                   	ret    

000039e1 <uptime>:
SYSCALL(uptime)
    39e1:	b8 0e 00 00 00       	mov    $0xe,%eax
    39e6:	cd 40                	int    $0x40
    39e8:	c3                   	ret    

000039e9 <clone>:
SYSCALL(clone)
    39e9:	b8 16 00 00 00       	mov    $0x16,%eax
    39ee:	cd 40                	int    $0x40
    39f0:	c3                   	ret    

000039f1 <join>:
SYSCALL(join)
    39f1:	b8 17 00 00 00       	mov    $0x17,%eax
    39f6:	cd 40                	int    $0x40
    39f8:	c3                   	ret    
    ...
    3a0c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a7e:	56                   	push   %esi
    3a7f:	57                   	push   %edi
    3a80:	e8 e4 fe ff ff       	call   3969 <write>
  while(--i >= 0)
    ...
    3ab9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3af5:	57                   	push   %edi
    3af6:	56                   	push   %esi
    3af7:	e8 6d fe ff ff       	call   3969 <write>
  ...
  write(fd, &c, 1);
    ...
    3b4e:	e8 16 fe ff ff       	call   3969 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b5f:	57                   	push   %edi
    3b60:	56                   	push   %esi
    3b61:	e8 03 fe ff ff       	call   3969 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3bcb:	57                   	push   %edi
    3bcc:	56                   	push   %esi
    3bcd:	e8 97 fd ff ff       	call   3969 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c0f:	e8 55 fd ff ff       	call   3969 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c51:	a1 20 a7 00 00       	mov    0xa720,%eax
{
  ...
  freep = p;
    ...
    3c91:	5b                   	pop    %ebx
  freep = p;
    3c92:	89 15 20 a7 00 00    	mov    %edx,0xa720
}
    3c98:	5e                   	pop    %esi
    3c99:	5f                   	pop    %edi
    3c9a:	5d                   	pop    %ebp
  ...
  freep = p;
    3ccc:	89 15 20 a7 00 00    	mov    %edx,0xa720
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cec:	8b 3d 20 a7 00 00    	mov    0xa720,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3d31:	8b 3d 20 a7 00 00    	mov    0xa720,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d43:	e8 89 fc ff ff       	call   39d1 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3d5f:	8b 15 20 a7 00 00    	mov    0xa720,%edx
    ...
    3d8c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3d8f:	89 15 20 a7 00 00    	mov    %edx,0xa720
}
    ...
    3d9f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3da0:	c7 05 20 a7 00 00 24 	movl   $0xa724,0xa720
    3da7:	a7 00 00 
    base.s.size = 0;
    3daa:	bf 24 a7 00 00       	mov    $0xa724,%edi
    base.s.ptr = freep = prevp = &base;
    3daf:	c7 05 24 a7 00 00 24 	movl   $0xa724,0xa724
    3db6:	a7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3db9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3dbb:	c7 05 28 a7 00 00 00 	movl   $0x0,0xa728
    3dc2:	00 00 00 
    if(p->s.size >= nunits){
