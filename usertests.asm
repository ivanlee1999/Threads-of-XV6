...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 7e 39 00 00       	call   39a9 <open>
    ...
    exit();
      40:	e8 24 39 00 00       	call   3969 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 53 39 00 00       	call   39a9 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 33 39 00 00       	call   3991 <close>
  ...
  exit();
     10d:	e8 57 38 00 00       	call   3969 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 83 38 00 00       	call   39d9 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 4b 38 00 00       	call   39b9 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 57 38 00 00       	call   39d9 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 84 5f 00 00    	push   0x5f84
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 84 5f 00 00    	push   0x5f84
     1ae:	e8 1d 39 00 00       	call   3ad0 <printf>
    exit();
     1b3:	e8 b1 37 00 00       	call   3969 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 43 3e 00 00       	push   $0x3e43
     1bf:	ff 35 84 5f 00 00    	push   0x5f84
     1c5:	e8 06 39 00 00       	call   3ad0 <printf>
    exit();
     1ca:	e8 9a 37 00 00       	call   3969 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 27 3e 00 00       	push   $0x3e27
     1d6:	ff 35 84 5f 00 00    	push   0x5f84
     1dc:	e8 ef 38 00 00       	call   3ad0 <printf>
    exit();
     1e1:	e8 83 37 00 00       	call   3969 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 06 3e 00 00       	push   $0x3e06
     1ed:	ff 35 84 5f 00 00    	push   0x5f84
     1f3:	e8 d8 38 00 00       	call   3ad0 <printf>
    exit();
     1f8:	e8 6c 37 00 00       	call   3969 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 84 5f 00 00    	push   0x5f84
     211:	e8 ba 38 00 00       	call   3ad0 <printf>
  pid = fork();
     216:	e8 46 37 00 00       	call   3961 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 9c 37 00 00       	call   39d1 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 8c 37 00 00       	call   39d9 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 54 37 00 00       	call   39b9 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 f8 36 00 00       	call   3969 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 f4 36 00 00       	call   3971 <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 76 3e 00 00       	push   $0x3e76
     285:	ff 35 84 5f 00 00    	push   0x5f84
     ...
     2a0:	ff 35 84 5f 00 00    	push   0x5f84
     2a6:	e8 25 38 00 00       	call   3ad0 <printf>
      exit();
     2ab:	e8 b9 36 00 00       	call   3969 <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 39 4d 00 00       	push   $0x4d39
     2b7:	ff 35 84 5f 00 00    	push   0x5f84
     2bd:	e8 0e 38 00 00       	call   3ad0 <printf>
    exit();
     2c2:	e8 a2 36 00 00       	call   3969 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 f8 3d 00 00       	push   $0x3df8
     2ce:	ff 35 84 5f 00 00    	push   0x5f84
     2d4:	e8 f7 37 00 00       	call   3ad0 <printf>
      exit();
     2d9:	e8 8b 36 00 00       	call   3969 <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 62 3e 00 00       	push   $0x3e62
     2e5:	ff 35 84 5f 00 00    	push   0x5f84
     2eb:	e8 e0 37 00 00       	call   3ad0 <printf>
      exit();
     2f0:	e8 74 36 00 00       	call   3969 <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 62 36 00 00       	call   39a9 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 b4 35 00 00       	call   3969 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 39 4d 00 00       	push   $0x4d39
     3bc:	ff 35 84 5f 00 00    	push   0x5f84
     3c2:	e8 09 37 00 00       	call   3ad0 <printf>
    exit();
     3c7:	e8 9d 35 00 00       	call   3969 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 9d 3e 00 00       	push   $0x3e9d
     3d3:	ff 35 84 5f 00 00    	push   0x5f84
     3d9:	e8 f2 36 00 00       	call   3ad0 <printf>
    exit();
     3de:	e8 86 35 00 00       	call   3969 <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 b1 3e 00 00       	push   $0x3eb1
     3ea:	ff 35 84 5f 00 00    	push   0x5f84
     3f0:	e8 db 36 00 00       	call   3ad0 <printf>
    exit();
     3f5:	e8 6f 35 00 00       	call   3969 <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 84 5f 00 00    	push   0x5f84
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 85 35 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 5d 35 00 00       	call   3991 <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 f5 3e 00 00       	push   $0x3ef5
     43d:	e8 67 35 00 00       	call   39a9 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 84 5f 00 00    	push   0x5f84
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 84 5f 00 00    	push   0x5f84
     46e:	e8 5d 36 00 00       	call   3ad0 <printf>
    exit();
     473:	e8 f1 34 00 00       	call   3969 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 02 3f 00 00       	push   $0x3f02
     47f:	ff 35 84 5f 00 00    	push   0x5f84
     485:	e8 46 36 00 00       	call   3ad0 <printf>
    exit();
     48a:	e8 da 34 00 00       	call   3969 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 84 5f 00 00    	push   0x5f84
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 f0 34 00 00       	call   39a9 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 84 5f 00 00    	push   0x5f84
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 99 34 00 00       	call   3989 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 7d 34 00 00       	call   3989 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 84 5f 00 00    	push   0x5f84
     52e:	e8 9d 35 00 00       	call   3ad0 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 56 34 00 00       	call   3991 <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 3f 3f 00 00       	push   $0x3f3f
     544:	e8 60 34 00 00       	call   39a9 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 84 5f 00 00    	push   0x5f84
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 05 34 00 00       	call   3981 <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 84 5f 00 00    	push   0x5f84
     598:	e8 33 35 00 00       	call   3ad0 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 ec 33 00 00       	call   3991 <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 3f 3f 00 00 	movl   $0x3f3f,(%esp)
     5ac:	e8 08 34 00 00       	call   39b9 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 84 5f 00 00    	push   0x5f84
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 84 5f 00 00    	push   0x5f84
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 10 33 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 c0 32 00 00       	call   3989 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 a6 32 00 00       	call   3991 <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 87 40 00 00       	push   $0x4087
     6f4:	e8 b0 32 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 47 32 00 00       	call   3981 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 3b 32 00 00       	call   3991 <close>
  if(unlink("big") < 0){
     756:	c7 04 24 87 40 00 00 	movl   $0x4087,(%esp)
     75d:	e8 57 32 00 00       	call   39b9 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 84 5f 00 00    	push   0x5f84
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 84 5f 00 00    	push   0x5f84
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 1e 31 00 00       	call   39a9 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 fe 30 00 00       	call   3991 <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 f3 30 00 00       	call   39b9 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 84 5f 00 00    	push   0x5f84
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 b3 30 00 00       	call   39d9 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 9b 30 00 00       	call   39d9 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 67 30 00 00       	call   39b9 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 84 5f 00 00    	push   0x5f84
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 84 5f 00 00    	push   0x5f84
     97e:	e8 4d 31 00 00       	call   3ad0 <printf>
    exit();
     983:	e8 e1 2f 00 00       	call   3969 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 f1 40 00 00       	push   $0x40f1
     98f:	ff 35 84 5f 00 00    	push   0x5f84
     995:	e8 36 31 00 00       	call   3ad0 <printf>
    exit();
     99a:	e8 ca 2f 00 00       	call   3969 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 e0 40 00 00       	push   $0x40e0
     9a6:	ff 35 84 5f 00 00    	push   0x5f84
     9ac:	e8 1f 31 00 00       	call   3ad0 <printf>
    exit();
     9b1:	e8 b3 2f 00 00       	call   3969 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 cd 40 00 00       	push   $0x40cd
     9bd:	ff 35 84 5f 00 00    	push   0x5f84
     9c3:	e8 08 31 00 00       	call   3ad0 <printf>
    exit();
     9c8:	e8 9c 2f 00 00       	call   3969 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 84 5f 00 00    	push   0x5f84
     9e1:	e8 ea 30 00 00       	call   3ad0 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 88 5f 00 00       	push   $0x5f88
     9ed:	68 dd 3e 00 00       	push   $0x3edd
     9f2:	e8 aa 2f 00 00       	call   39a1 <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 84 5f 00 00    	push   0x5f84
     a0d:	e8 be 30 00 00       	call   3ad0 <printf>
    exit();
     a12:	e8 52 2f 00 00       	call   3969 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 2f 2f 00 00       	call   3991 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 04 2f 00 00       	call   3981 <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 b5 2e 00 00       	call   3991 <close>
     ...
     b11:	e8 73 2e 00 00       	call   3989 <write>
    ...
    exit();
     b28:	e8 3c 2e 00 00       	call   3969 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 50 2e 00 00       	call   3991 <close>
    wait();
     b41:	e8 2b 2e 00 00       	call   3971 <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 64 2f 00 00       	call   3ad0 <printf>
      exit();
     b6c:	e8 f8 2d 00 00       	call   3969 <exit>
    ...
    exit();
     b7f:	e8 e5 2d 00 00       	call   3969 <exit>
    ...
    exit();
     b92:	e8 d2 2d 00 00       	call   3969 <exit>
     ...
     ba0:	e8 2b 2f 00 00       	call   3ad0 <printf>
        exit();
     ba5:	e8 bf 2d 00 00       	call   3969 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 97 2d 00 00       	call   3961 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 82 2d 00 00       	call   3961 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 7d 2d 00 00       	call   3979 <pipe>
  pid3 = fork();
     bfc:	e8 60 2d 00 00       	call   3961 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 53 2d 00 00       	call   3991 <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 16 2d 00 00       	call   3991 <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 08 2d 00 00       	call   3999 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 00 2d 00 00       	call   3999 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 f8 2c 00 00       	call   3999 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 bd 2c 00 00       	call   3971 <wait>
  wait();
     cb4:	e8 b8 2c 00 00       	call   3971 <wait>
  wait();
     cb9:	e8 b3 2c 00 00       	call   3971 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 4a 2c 00 00       	call   3971 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 2c 2c 00 00       	call   3961 <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 da 2b 00 00       	call   3969 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 3e 2c 00 00       	call   39e9 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 af 2b 00 00       	call   3961 <fork>
    ...
    exit();
     e1f:	e8 45 2b 00 00       	call   3969 <exit>
     ...
     e3a:	e8 5a 2b 00 00       	call   3999 <kill>
      exit();
     e3f:	e8 25 2b 00 00       	call   3969 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 1e 2b 00 00       	jmp    3971 <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 38 2b 00 00       	call   39b9 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 33 42 00 00       	push   $0x4233
     e8d:	e8 17 2b 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 b5 2a 00 00       	call   3961 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 a8 2a 00 00       	call   3989 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 66 2a 00 00       	call   3971 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 78 2a 00 00       	call   3991 <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 33 42 00 00       	push   $0x4233
     f22:	e8 82 2a 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 30 2a 00 00       	call   3981 <read>
  ...
  close(fd);
     ...
     f86:	e8 06 2a 00 00       	call   3991 <close>
  unlink("sharedfd");
     f8b:	c7 04 24 33 42 00 00 	movl   $0x4233,(%esp)
     f92:	e8 22 2a 00 00       	call   39b9 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 69 29 00 00       	call   3969 <exit>
    ...
    exit();
    100e:	e8 56 29 00 00       	call   3969 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 55 29 00 00       	call   39b9 <unlink>
    pid = fork();
    1064:	e8 f8 28 00 00       	call   3961 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 e4 28 00 00       	call   3971 <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 dd 28 00 00       	call   3971 <wait>
    1094:	e8 d8 28 00 00       	call   3971 <wait>
    1099:	e8 d3 28 00 00       	call   3971 <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 f7 28 00 00       	call   39a9 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 ac 28 00 00       	call   3981 <read>
    ...
    1104:	e8 88 28 00 00       	call   3991 <close>
    if(total != 12*500){
    ...
    111e:	e8 96 28 00 00       	call   39b9 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 72 29 00 00       	call   3ad0 <printf>
          exit();
    115e:	e8 06 28 00 00       	call   3969 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 38 28 00 00       	call   39a9 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 de 27 00 00       	call   3989 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 aa 27 00 00       	call   3969 <exit>
    ...
    11c8:	e8 03 29 00 00       	call   3ad0 <printf>
        exit();
    11cd:	e8 97 27 00 00       	call   3969 <exit>
    ...
    11e2:	e8 e9 28 00 00       	call   3ad0 <printf>
      exit();
    11e7:	e8 7d 27 00 00       	call   3969 <exit>
    ...
    11f5:	e8 d6 28 00 00       	call   3ad0 <printf>
      exit();
    11fa:	e8 6a 27 00 00       	call   3969 <exit>
    ...
    1208:	e8 c3 28 00 00       	call   3ad0 <printf>
          exit();
    120d:	e8 57 27 00 00       	call   3969 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 22 27 00 00       	call   3961 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 17 27 00 00       	call   3971 <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 0d 27 00 00       	call   3971 <wait>
    1264:	e8 08 27 00 00       	call   3971 <wait>
    1269:	e8 03 27 00 00       	call   3971 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 fb 26 00 00       	call   39a9 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 bf 26 00 00       	call   3991 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 a9 26 00 00       	call   39b9 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 7e 27 00 00       	call   3ad0 <printf>
        exit();
    1352:	e8 12 26 00 00       	call   3969 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 0a 26 00 00       	call   39a9 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 e2 25 00 00       	call   3991 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 eb 25 00 00       	call   39b9 <unlink>
    ...
    13de:	e8 ed 26 00 00       	call   3ad0 <printf>
            exit();
    13e3:	e8 81 25 00 00       	call   3969 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 74 25 00 00       	call   3969 <exit>
    ...
    1400:	e8 cb 26 00 00       	call   3ad0 <printf>
        exit();
    1405:	e8 5f 25 00 00       	call   3969 <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 b7 26 00 00       	call   3ad0 <printf>
      exit();
    1419:	e8 4b 25 00 00       	call   3969 <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 a3 26 00 00       	call   3ad0 <printf>
          exit();
    142d:	e8 37 25 00 00       	call   3969 <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 44 25 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 07 25 00 00       	call   3989 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 07 25 00 00       	call   3991 <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 e5 42 00 00       	push   $0x42e5
    1493:	e8 11 25 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 07 25 00 00       	call   39b9 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 da 24 00 00       	call   39a9 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 68 24 00 00       	call   3989 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 5f 24 00 00       	call   3991 <close>
  unlink("unlinkread");
    1532:	c7 04 24 e5 42 00 00 	movl   $0x42e5,(%esp)
    1539:	e8 7b 24 00 00       	call   39b9 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 00 24 00 00       	call   3969 <exit>
    ...
    exit();
    1577:	e8 ed 23 00 00       	call   3969 <exit>
    ...
    exit();
    158a:	e8 da 23 00 00       	call   3969 <exit>
    ...
    exit();
    159d:	e8 c7 23 00 00       	call   3969 <exit>
    ...
    exit();
    15b0:	e8 b4 23 00 00       	call   3969 <exit>
    ...
    exit();
    15c3:	e8 a1 23 00 00       	call   3969 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 60 23 00 00       	call   3989 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 53 23 00 00       	call   3991 <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 aa 43 00 00       	push   $0x43aa
    1645:	68 a6 43 00 00       	push   $0x43a6
    164a:	e8 7a 23 00 00       	call   39c9 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 52 23 00 00       	call   39b9 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 a6 43 00 00       	push   $0x43a6
    1670:	e8 34 23 00 00       	call   39a9 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 1a 23 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 d2 22 00 00       	call   3981 <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 cd 22 00 00       	call   3991 <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 aa 43 00 00       	push   $0x43aa
    16cb:	68 aa 43 00 00       	push   $0x43aa
    16d0:	e8 f4 22 00 00       	call   39c9 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 cc 22 00 00       	call   39b9 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 a6 43 00 00       	push   $0x43a6
    16f4:	68 aa 43 00 00       	push   $0x43aa
    16f9:	e8 cb 22 00 00       	call   39c9 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 b2 22 00 00       	call   39c9 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 21 22 00 00       	call   3969 <exit>
    ...
    exit();
    1756:	e8 0e 22 00 00       	call   3969 <exit>
    ...
    exit();
    1769:	e8 fb 21 00 00       	call   3969 <exit>
    ...
    exit();
    177c:	e8 e8 21 00 00       	call   3969 <exit>
    ...
    exit();
    178f:	e8 d5 21 00 00       	call   3969 <exit>
    ...
    exit();
    17a2:	e8 c2 21 00 00       	call   3969 <exit>
    ...
    exit();
    17b5:	e8 af 21 00 00       	call   3969 <exit>
    ...
    exit();
    17c8:	e8 9c 21 00 00       	call   3969 <exit>
    ...
    exit();
    17db:	e8 89 21 00 00       	call   3969 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 7a 21 00 00       	call   39a9 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 4f 21 00 00       	call   3991 <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 27 21 00 00       	call   3971 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 57 21 00 00       	call   39b9 <unlink>
    pid = fork();
    1862:	e8 fa 20 00 00       	call   3961 <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 1f 21 00 00       	call   39a9 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 e8 20 00 00       	call   39c9 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 88 20 00 00       	call   3971 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 96 20 00 00       	call   39a9 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 55 20 00 00       	call   3981 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 18 20 00 00       	call   3991 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 17 20 00 00       	call   39b9 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 0f 20 00 00       	call   39b9 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 07 20 00 00       	call   39b9 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 ff 1f 00 00       	call   39b9 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 a7 1f 00 00       	call   3971 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 80 1f 00 00       	call   3961 <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 99 1f 00 00       	call   39a9 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 79 1f 00 00       	call   3991 <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 87 1f 00 00       	call   39a9 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 67 1f 00 00       	call   3991 <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 75 1f 00 00       	call   39a9 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 55 1f 00 00       	call   3991 <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 63 1f 00 00       	call   39a9 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 43 1f 00 00       	call   3991 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 4a 20 00 00       	call   3ad0 <printf>
      exit();
    1a86:	e8 de 1e 00 00       	call   3969 <exit>
    ...
    exit();
    1a99:	e8 cb 1e 00 00       	call   3969 <exit>
    ...
    1aac:	e8 1f 20 00 00       	call   3ad0 <printf>
        exit();
    1ab1:	e8 b3 1e 00 00       	call   3969 <exit>
    ...
    1ac4:	e8 07 20 00 00       	call   3ad0 <printf>
        exit();
    1ac9:	e8 9b 1e 00 00       	call   3969 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 ba 1e 00 00       	call   3991 <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 b8 1e 00 00       	call   39b9 <unlink>
  pid = fork();
    1b01:	e8 5b 1e 00 00       	call   3961 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 77 1e 00 00       	call   39b9 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 2e 1e 00 00       	call   39a9 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 0e 1e 00 00       	call   3991 <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 da 1d 00 00       	call   3971 <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 07 1e 00 00       	call   39c9 <link>
    ...
    exit();
    1bd8:	e8 8c 1d 00 00       	call   3969 <exit>
    exit();
    1bdd:	e8 87 1d 00 00       	call   3969 <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 a8 1d 00 00       	call   39b9 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 f5 44 00 00       	push   $0x44f5
    1c1d:	e8 87 1d 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 56 1d 00 00       	call   3991 <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 5d 1d 00 00       	call   39c9 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 2c 1d 00 00       	call   39b9 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 02 1d 00 00       	call   39b9 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 de 1d 00 00       	call   3ad0 <printf>
      exit();
    1cf2:	e8 72 1c 00 00       	call   3969 <exit>
    ...
    1d01:	e8 ca 1d 00 00       	call   3ad0 <printf>
      exit();
    1d06:	e8 5e 1c 00 00       	call   3969 <exit>
    ...
    exit();
    1d19:	e8 4b 1c 00 00       	call   3969 <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 7a 1c 00 00       	call   39b9 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 68 46 00 00 	movl   $0x4668,(%esp)
    1d46:	e8 86 1c 00 00       	call   39d1 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 41 1c 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 04 1c 00 00       	call   3989 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 04 1c 00 00       	call   3991 <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 68 46 00 00 	movl   $0x4668,(%esp)
    1d94:	e8 20 1c 00 00       	call   39b9 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 20 1c 00 00       	call   39d1 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 db 1b 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 9e 1b 00 00       	call   3989 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 9e 1b 00 00       	call   3991 <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 c2 45 00 00       	push   $0x45c2
    1dfc:	e8 a8 1b 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 60 1b 00 00       	call   3981 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 4e 1b 00 00       	call   3991 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 02 46 00 00       	push   $0x4602
    1e4a:	68 9e 45 00 00       	push   $0x459e
    1e4f:	e8 75 1b 00 00       	call   39c9 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 4d 1b 00 00       	call   39b9 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 23 1b 00 00       	call   39a9 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 3b 1b 00 00       	call   39d9 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 23 1b 00 00       	call   39d9 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 0b 1b 00 00       	call   39d9 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 f3 1a 00 00       	call   39d9 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 a9 1a 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 61 1a 00 00       	call   3981 <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 5c 1a 00 00       	call   3991 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 9e 45 00 00       	push   $0x459e
    1f3e:	e8 66 1a 00 00       	call   39a9 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 49 1a 00 00       	call   39a9 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 2c 1a 00 00       	call   39a9 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 0f 1a 00 00       	call   39a9 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 f5 19 00 00       	call   39a9 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 db 19 00 00       	call   39a9 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 de 19 00 00       	call   39c9 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 c1 19 00 00       	call   39c9 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 a4 19 00 00       	call   39c9 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 94 19 00 00       	call   39d1 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 7c 19 00 00       	call   39d1 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 64 19 00 00       	call   39d1 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 34 19 00 00       	call   39b9 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 1c 19 00 00       	call   39b9 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 24 19 00 00       	call   39d9 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 0c 19 00 00       	call   39d9 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 d4 18 00 00       	call   39b9 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 bc 18 00 00       	call   39b9 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 a4 18 00 00       	call   39b9 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 8c 18 00 00       	call   39b9 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 74 18 00 00       	call   39b9 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 ef 17 00 00       	call   3969 <exit>
    ...
    exit();
    2188:	e8 dc 17 00 00       	call   3969 <exit>
    ...
    exit();
    219b:	e8 c9 17 00 00       	call   3969 <exit>
    ...
    exit();
    21ae:	e8 b6 17 00 00       	call   3969 <exit>
    ...
    exit();
    21c1:	e8 a3 17 00 00       	call   3969 <exit>
    ...
    exit();
    21d4:	e8 90 17 00 00       	call   3969 <exit>
    ...
    exit();
    21e7:	e8 7d 17 00 00       	call   3969 <exit>
    ...
    exit();
    21fa:	e8 6a 17 00 00       	call   3969 <exit>
    ...
    exit();
    220d:	e8 57 17 00 00       	call   3969 <exit>
    ...
    exit();
    2220:	e8 44 17 00 00       	call   3969 <exit>
    ...
    exit();
    2233:	e8 31 17 00 00       	call   3969 <exit>
    ...
    exit();
    2246:	e8 1e 17 00 00       	call   3969 <exit>
    ...
    exit();
    2259:	e8 0b 17 00 00       	call   3969 <exit>
    ...
    exit();
    226c:	e8 f8 16 00 00       	call   3969 <exit>
    ...
    exit();
    227f:	e8 e5 16 00 00       	call   3969 <exit>
    ...
    exit();
    2292:	e8 d2 16 00 00       	call   3969 <exit>
    ...
    exit();
    22a5:	e8 bf 16 00 00       	call   3969 <exit>
    ...
    exit();
    22b8:	e8 ac 16 00 00       	call   3969 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 99 16 00 00       	call   3969 <exit>
    ...
    exit();
    22de:	e8 86 16 00 00       	call   3969 <exit>
    ...
    exit();
    22f1:	e8 73 16 00 00       	call   3969 <exit>
    ...
    exit();
    2304:	e8 60 16 00 00       	call   3969 <exit>
    ...
    exit();
    2317:	e8 4d 16 00 00       	call   3969 <exit>
    ...
    exit();
    232a:	e8 3a 16 00 00       	call   3969 <exit>
    ...
    exit();
    233d:	e8 27 16 00 00       	call   3969 <exit>
    ...
    exit();
    2350:	e8 14 16 00 00       	call   3969 <exit>
    ...
    exit();
    2363:	e8 01 16 00 00       	call   3969 <exit>
    ...
    exit();
    2376:	e8 ee 15 00 00       	call   3969 <exit>
    ...
    exit();
    2389:	e8 db 15 00 00       	call   3969 <exit>
    ...
    exit();
    239c:	e8 c8 15 00 00       	call   3969 <exit>
    ...
    exit();
    23af:	e8 b5 15 00 00       	call   3969 <exit>
    ...
    exit();
    23c2:	e8 a2 15 00 00       	call   3969 <exit>
    ...
    exit();
    23d5:	e8 8f 15 00 00       	call   3969 <exit>
    ...
    exit();
    23e8:	e8 7c 15 00 00       	call   3969 <exit>
    ...
    exit();
    23fb:	e8 69 15 00 00       	call   3969 <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 94 15 00 00       	call   39b9 <unlink>
    ...
    243d:	e8 67 15 00 00       	call   39a9 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 2f 15 00 00       	call   3989 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 19 15 00 00       	call   3989 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 0b 15 00 00       	call   3991 <close>
    unlink("bigwrite");
    2486:	c7 04 24 64 48 00 00 	movl   $0x4864,(%esp)
    248d:	e8 27 15 00 00       	call   39b9 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 0c 16 00 00       	call   3ad0 <printf>
        exit();
    24c4:	e8 a0 14 00 00       	call   3969 <exit>
    ...
    24d3:	e8 f8 15 00 00       	call   3ad0 <printf>
      exit();
    24d8:	e8 8c 14 00 00       	call   3969 <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 b8 14 00 00       	call   39b9 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 c0 48 00 00       	push   $0x48c0
    250d:	e8 97 14 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 3b 14 00 00       	call   3989 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 24 14 00 00       	call   3991 <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 c0 48 00 00       	push   $0x48c0
    2576:	e8 2e 14 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 b0 13 00 00       	call   3981 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 ae 13 00 00       	call   3991 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 ba 13 00 00       	call   39b9 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 a9 14 00 00       	call   3ad0 <printf>
      exit();
    2627:	e8 3d 13 00 00       	call   3969 <exit>
    ...
    2636:	e8 95 14 00 00       	call   3ad0 <printf>
      exit();
    263b:	e8 29 13 00 00       	call   3969 <exit>
    ...
    264a:	e8 81 14 00 00       	call   3ad0 <printf>
      exit();
    264f:	e8 15 13 00 00       	call   3969 <exit>
    ...
    265e:	e8 6d 14 00 00       	call   3ad0 <printf>
      exit();
    2663:	e8 01 13 00 00       	call   3969 <exit>
    ...
    exit();
    2676:	e8 ee 12 00 00       	call   3969 <exit>
    ...
    exit();
    2689:	e8 db 12 00 00       	call   3969 <exit>
    ...
    exit();
    269c:	e8 c8 12 00 00       	call   3969 <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 03 13 00 00       	call   39d1 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 eb 12 00 00       	call   39d1 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 a6 12 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 7a 12 00 00       	call   3991 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 18 52 00 00       	push   $0x5218
    2720:	e8 84 12 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 5c 12 00 00       	call   3991 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 8c 49 00 00 	movl   $0x498c,(%esp)
    273c:	e8 90 12 00 00       	call   39d1 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 7c 12 00 00       	call   39d1 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 e6 11 00 00       	call   3969 <exit>
    ...
    exit();
    2791:	e8 d3 11 00 00       	call   3969 <exit>
    ...
    exit();
    27a4:	e8 c0 11 00 00       	call   3969 <exit>
    ...
    exit();
    27b7:	e8 ad 11 00 00       	call   3969 <exit>
    ...
    exit();
    27ca:	e8 9a 11 00 00       	call   3969 <exit>
    ...
    exit();
    27dd:	e8 87 11 00 00       	call   3969 <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 c3 11 00 00       	call   39d1 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 b3 11 00 00       	call   39d9 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 7b 11 00 00       	call   39b9 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 63 11 00 00       	call   39b9 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 6b 11 00 00       	call   39d9 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 33 11 00 00       	call   39b9 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 1f 11 00 00       	call   39b9 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 0b 11 00 00       	call   39b9 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 8d 10 00 00       	call   3969 <exit>
    ...
    exit();
    28ea:	e8 7a 10 00 00       	call   3969 <exit>
    ...
    exit();
    28fd:	e8 67 10 00 00       	call   3969 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 54 10 00 00       	call   3969 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 41 10 00 00       	call   3969 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 2e 10 00 00       	call   3969 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 1b 10 00 00       	call   3969 <exit>
    ...
    exit();
    295c:	e8 08 10 00 00       	call   3969 <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 15 10 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 e9 0f 00 00       	call   3991 <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 75 4a 00 00 	movl   $0x4a75,(%esp)
    29af:	e8 25 10 00 00       	call   39d9 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 db 0f 00 00       	call   39a9 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 be 0f 00 00       	call   39a9 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 ce 0f 00 00       	call   39d1 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 9e 0f 00 00       	call   39b9 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 91 0f 00 00       	call   39c9 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 69 0f 00 00       	call   39b9 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 3f 0f 00 00       	call   39a9 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 25 0f 00 00       	call   39a9 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 f3 0e 00 00       	call   3989 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 eb 0e 00 00       	call   3991 <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 9a 0e 00 00       	call   3969 <exit>
    ...
    exit();
    2add:	e8 87 0e 00 00       	call   3969 <exit>
    ...
    exit();
    2af0:	e8 74 0e 00 00       	call   3969 <exit>
    ...
    exit();
    2b03:	e8 61 0e 00 00       	call   3969 <exit>
    ...
    exit();
    2b16:	e8 4e 0e 00 00       	call   3969 <exit>
    ...
    exit();
    2b29:	e8 3b 0e 00 00       	call   3969 <exit>
    ...
    exit();
    2b3c:	e8 28 0e 00 00       	call   3969 <exit>
    ...
    exit();
    2b4f:	e8 15 0e 00 00       	call   3969 <exit>
    ...
    exit();
    2b62:	e8 02 0e 00 00       	call   3969 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 34 0e 00 00       	call   39d1 <mkdir>
    ...
    2bb0:	e8 24 0e 00 00       	call   39d9 <chdir>
    2bb5:	83 c4 10             	add    $0x10,%esp
    2bb8:	85 c0                	test   %eax,%eax
    2bba:	0f 85 b7 00 00 00    	jne    2c77 <iref+0x107>
    mkdir("");
    2bc0:	83 ec 0c             	sub    $0xc,%esp
    2bc3:	68 a1 55 00 00       	push   $0x55a1
    2bc8:	e8 04 0e 00 00       	call   39d1 <mkdir>
    link("README", "");
    2bcd:	59                   	pop    %ecx
    2bce:	58                   	pop    %eax
    2bcf:	68 a1 55 00 00       	push   $0x55a1
    2bd4:	68 12 4b 00 00       	push   $0x4b12
    2bd9:	e8 eb 0d 00 00       	call   39c9 <link>
    fd = open("", O_CREATE);
    2bde:	58                   	pop    %eax
    2bdf:	5a                   	pop    %edx
    2be0:	68 00 02 00 00       	push   $0x200
    2be5:	68 a1 55 00 00       	push   $0x55a1
    2bea:	e8 ba 0d 00 00       	call   39a9 <open>
    if(fd >= 0)
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 6d 0d 00 00       	call   3991 <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 50 47 00 00       	push   $0x4750
    2c2f:	e8 85 0d 00 00       	call   39b9 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 8c 0d 00 00       	call   39d9 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 5e 0e 00 00       	call   3ad0 <printf>
      exit();
    2c72:	e8 f2 0c 00 00       	call   3969 <exit>
    ...
    2c81:	e8 4a 0e 00 00       	call   3ad0 <printf>
      exit();
    2c86:	e8 de 0c 00 00       	call   3969 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 9f 0c 00 00       	call   3961 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 9c 0c 00 00       	call   3971 <wait>
  ...
  if(wait() != -1){
    2cde:	e8 8e 0c 00 00       	call   3971 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 68 0c 00 00       	call   3969 <exit>
    ...
    2d0b:	e8 c0 0d 00 00       	call   3ad0 <printf>
      exit();
    2d10:	e8 54 0c 00 00       	call   3969 <exit>
    ...
    exit();
    2d23:	e8 41 0c 00 00       	call   3969 <exit>
    ...
    exit();
    2d36:	e8 2e 0c 00 00       	call   3969 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 65 0c 00 00       	call   39f1 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 b4 0b 00 00       	call   3961 <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 2d 0c 00 00       	call   39f1 <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 21 0c 00 00       	call   39f1 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 89 0b 00 00       	call   3971 <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 ff 0b 00 00       	call   39f1 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 ee 0b 00 00       	call   39f1 <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 d9 0b 00 00       	call   39f1 <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 cb 0b 00 00       	call   39f1 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 b5 0b 00 00       	call   39f1 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 9a 0b 00 00       	call   39f1 <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 8c 0b 00 00       	call   39f1 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 75 0b 00 00       	call   39f1 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 0c 0b 00 00       	call   39e9 <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 7d 0a 00 00       	call   3961 <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 7a 0a 00 00       	call   3971 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 68 0a 00 00       	call   3979 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 34 0a 00 00       	call   3961 <fork>
    ...
    2f48:	e8 34 0a 00 00       	call   3981 <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 8d 0a 00 00       	call   39f1 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 19 0a 00 00       	call   3999 <kill>
    wait();
    2f80:	e8 ec 09 00 00       	call   3971 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 4f 0a 00 00       	call   39f1 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fb2:	ff 35 84 5f 00 00    	push   0x5f84
    ...
    exit();
    310c:	e8 58 08 00 00       	call   3969 <exit>
    exit();
    3111:	e8 53 08 00 00       	call   3969 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 25 4c 00 00       	push   $0x4c25
    311d:	ff 35 84 5f 00 00    	push   0x5f84
    3123:	e8 a8 09 00 00       	call   3ad0 <printf>
    exit();
    3128:	e8 3c 08 00 00       	call   3969 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 e4 53 00 00       	push   $0x53e4
    3134:	ff 35 84 5f 00 00    	push   0x5f84
    313a:	e8 91 09 00 00       	call   3ad0 <printf>
    exit();
    313f:	e8 25 08 00 00       	call   3969 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 ac 53 00 00       	push   $0x53ac
    314b:	ff 35 84 5f 00 00    	push   0x5f84
    3151:	e8 7a 09 00 00       	call   3ad0 <printf>
    exit();
    3156:	e8 0e 08 00 00       	call   3969 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 41 4c 00 00       	push   $0x4c41
    3162:	ff 35 84 5f 00 00    	push   0x5f84
    3168:	e8 63 09 00 00       	call   3ad0 <printf>
    exit();
    316d:	e8 f7 07 00 00       	call   3969 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 34 08 00 00       	call   39f9 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 28 08 00 00       	call   39f9 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 c0 07 00 00       	call   3999 <kill>
    wait();
    31d9:	e8 93 07 00 00       	call   3971 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 ad 4c 00 00       	push   $0x4cad
    31e6:	e8 de 07 00 00       	call   39c9 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 84 5f 00 00    	push   0x5f84
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 46 07 00 00       	call   3969 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 b8 4c 00 00       	push   $0x4cb8
    322b:	ff 35 84 5f 00 00    	push   0x5f84
    3231:	e8 9a 08 00 00       	call   3ad0 <printf>
      exit();
    3236:	e8 2e 07 00 00       	call   3969 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 84 5f 00 00    	push   0x5f84
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 84 5f 00 00    	push   0x5f84
    ...
    3293:	ff 35 84 5f 00 00    	push   0x5f84
    3299:	e8 32 08 00 00       	call   3ad0 <printf>
      exit();
    329e:	e8 c6 06 00 00       	call   3969 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 f9 06 00 00       	call   39b9 <unlink>
  pid = fork();
    32c0:	e8 9c 06 00 00       	call   3961 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 9a 06 00 00       	call   3971 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 06 4d 00 00       	push   $0x4d06
    32e1:	e8 c3 06 00 00       	call   39a9 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 97 06 00 00       	call   3991 <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 06 4d 00 00 	movl   $0x4d06,(%esp)
    3301:	e8 b3 06 00 00       	call   39b9 <unlink>
}
    ...
    332a:	ff 35 84 5f 00 00    	push   0x5f84
    args[MAXARG-1] = 0;
    ...
    334b:	e8 51 06 00 00       	call   39a1 <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 1d 4d 00 00       	push   $0x4d1d
    3357:	ff 35 84 5f 00 00    	push   0x5f84
    ...
    336e:	e8 36 06 00 00       	call   39a9 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 16 06 00 00       	call   3991 <close>
    exit();
    337b:	e8 e9 05 00 00       	call   3969 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 46 4d 00 00       	push   $0x4d46
    3387:	ff 35 84 5f 00 00    	push   0x5f84
    338d:	e8 3e 07 00 00       	call   3ad0 <printf>
    exit();
    3392:	e8 d2 05 00 00       	call   3969 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 2d 4d 00 00       	push   $0x4d2d
    339e:	ff 35 84 5f 00 00    	push   0x5f84
    33a4:	e8 27 07 00 00       	call   3ad0 <printf>
    exit();
    33a9:	e8 bb 05 00 00       	call   3969 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 4b 05 00 00       	call   39a9 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 04 05 00 00       	call   3989 <write>
      if(cc < 512)
    ...
    34a2:	e8 ea 04 00 00       	call   3991 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 68 04 00 00       	call   39b9 <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 ca 03 00 00       	call   3961 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 cc 03 00 00       	call   3971 <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 8c 03 00 00       	call   3969 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 79 03 00 00       	call   3969 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 a6 03 00 00       	call   39a9 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 db 03 00 00       	call   39f1 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 5c 03 00 00       	call   3981 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 64 03 00 00       	call   3991 <close>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 c4 01 00 00       	call   3981 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 87 01 00 00       	call   39a9 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 8a 01 00 00       	call   39c1 <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 50 01 00 00       	call   3991 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
  ...
  void* stack = malloc(4096);
    ...
    38dc:	e8 1f 04 00 00       	call   3d00 <malloc>
  // if((int) stack % 4096 != 0){
  //   stack = stack + (4096 - (int) stack % 4096);
  // }
  int rc = clone(start_routine, arg1, arg2, stack);
    38e1:	50                   	push   %eax
    38e2:	ff 75 10             	push   0x10(%ebp)
    38e5:	ff 75 0c             	push   0xc(%ebp)
    38e8:	ff 75 08             	push   0x8(%ebp)
    38eb:	e8 19 01 00 00       	call   3a09 <clone>
  printf(1, " thread create %d \n", rc);
    38f0:	83 c4 1c             	add    $0x1c,%esp
    38f3:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
    38f4:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
    38f6:	68 8e 55 00 00       	push   $0x558e
    38fb:	6a 01                	push   $0x1
    38fd:	e8 ce 01 00 00       	call   3ad0 <printf>
  return rc;
}
    3902:	89 d8                	mov    %ebx,%eax
    3904:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3907:	c9                   	leave  
    3908:	c3                   	ret    
...
thread_join(){
  ...
  void** stack = malloc(sizeof(void*));
    ...
    3918:	6a 04                	push   $0x4
    391a:	e8 e1 03 00 00       	call   3d00 <malloc>
  int rc = join(stack);
    391f:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
    3922:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
    3924:	e8 e8 00 00 00       	call   3a11 <join>
    3929:	89 c6                	mov    %eax,%esi
  free(*stack);
    392b:	58                   	pop    %eax
    392c:	ff 33                	push   (%ebx)
    392e:	e8 3d 03 00 00       	call   3c70 <free>
  return rc;
}
    3933:	8d 65 f8             	lea    -0x8(%ebp),%esp
    3936:	89 f0                	mov    %esi,%eax
    3938:	5b                   	pop    %ebx
    3939:	5e                   	pop    %esi
    393a:	5d                   	pop    %ebp
    393b:	c3                   	ret    
...
void lock_acquire(lock_t * lock){
    ...
    3948:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    394f:	90                   	nop
...
SYSCALL(fork)
    3961:	b8 01 00 00 00       	mov    $0x1,%eax
    3966:	cd 40                	int    $0x40
    3968:	c3                   	ret    

00003969 <exit>:
SYSCALL(exit)
    3969:	b8 02 00 00 00       	mov    $0x2,%eax
    396e:	cd 40                	int    $0x40
    3970:	c3                   	ret    

00003971 <wait>:
SYSCALL(wait)
    3971:	b8 03 00 00 00       	mov    $0x3,%eax
    3976:	cd 40                	int    $0x40
    3978:	c3                   	ret    

00003979 <pipe>:
SYSCALL(pipe)
    3979:	b8 04 00 00 00       	mov    $0x4,%eax
    397e:	cd 40                	int    $0x40
    3980:	c3                   	ret    

00003981 <read>:
SYSCALL(read)
    3981:	b8 05 00 00 00       	mov    $0x5,%eax
    3986:	cd 40                	int    $0x40
    3988:	c3                   	ret    

00003989 <write>:
SYSCALL(write)
    3989:	b8 10 00 00 00       	mov    $0x10,%eax
    398e:	cd 40                	int    $0x40
    3990:	c3                   	ret    

00003991 <close>:
SYSCALL(close)
    3991:	b8 15 00 00 00       	mov    $0x15,%eax
    3996:	cd 40                	int    $0x40
    3998:	c3                   	ret    

00003999 <kill>:
SYSCALL(kill)
    3999:	b8 06 00 00 00       	mov    $0x6,%eax
    399e:	cd 40                	int    $0x40
    39a0:	c3                   	ret    

000039a1 <exec>:
SYSCALL(exec)
    39a1:	b8 07 00 00 00       	mov    $0x7,%eax
    39a6:	cd 40                	int    $0x40
    39a8:	c3                   	ret    

000039a9 <open>:
SYSCALL(open)
    39a9:	b8 0f 00 00 00       	mov    $0xf,%eax
    39ae:	cd 40                	int    $0x40
    39b0:	c3                   	ret    

000039b1 <mknod>:
SYSCALL(mknod)
    39b1:	b8 11 00 00 00       	mov    $0x11,%eax
    39b6:	cd 40                	int    $0x40
    39b8:	c3                   	ret    

000039b9 <unlink>:
SYSCALL(unlink)
    39b9:	b8 12 00 00 00       	mov    $0x12,%eax
    39be:	cd 40                	int    $0x40
    39c0:	c3                   	ret    

000039c1 <fstat>:
SYSCALL(fstat)
    39c1:	b8 08 00 00 00       	mov    $0x8,%eax
    39c6:	cd 40                	int    $0x40
    39c8:	c3                   	ret    

000039c9 <link>:
SYSCALL(link)
    39c9:	b8 13 00 00 00       	mov    $0x13,%eax
    39ce:	cd 40                	int    $0x40
    39d0:	c3                   	ret    

000039d1 <mkdir>:
SYSCALL(mkdir)
    39d1:	b8 14 00 00 00       	mov    $0x14,%eax
    39d6:	cd 40                	int    $0x40
    39d8:	c3                   	ret    

000039d9 <chdir>:
SYSCALL(chdir)
    39d9:	b8 09 00 00 00       	mov    $0x9,%eax
    39de:	cd 40                	int    $0x40
    39e0:	c3                   	ret    

000039e1 <dup>:
SYSCALL(dup)
    39e1:	b8 0a 00 00 00       	mov    $0xa,%eax
    39e6:	cd 40                	int    $0x40
    39e8:	c3                   	ret    

000039e9 <getpid>:
SYSCALL(getpid)
    39e9:	b8 0b 00 00 00       	mov    $0xb,%eax
    39ee:	cd 40                	int    $0x40
    39f0:	c3                   	ret    

000039f1 <sbrk>:
SYSCALL(sbrk)
    39f1:	b8 0c 00 00 00       	mov    $0xc,%eax
    39f6:	cd 40                	int    $0x40
    39f8:	c3                   	ret    

000039f9 <sleep>:
SYSCALL(sleep)
    39f9:	b8 0d 00 00 00       	mov    $0xd,%eax
    39fe:	cd 40                	int    $0x40
    3a00:	c3                   	ret    

00003a01 <uptime>:
SYSCALL(uptime)
    3a01:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a06:	cd 40                	int    $0x40
    3a08:	c3                   	ret    

00003a09 <clone>:
SYSCALL(clone)
    3a09:	b8 16 00 00 00       	mov    $0x16,%eax
    3a0e:	cd 40                	int    $0x40
    3a10:	c3                   	ret    

00003a11 <join>:
SYSCALL(join)
    3a11:	b8 17 00 00 00       	mov    $0x17,%eax
    3a16:	cd 40                	int    $0x40
    3a18:	c3                   	ret    
    ...
    3a2c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    3a59:	0f b6 92 04 56 00 00 	movzbl 0x5604(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    3a9e:	56                   	push   %esi
    3a9f:	57                   	push   %edi
    3aa0:	e8 e4 fe ff ff       	call   3989 <write>
  while(--i >= 0)
    ...
    3ad9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b15:	57                   	push   %edi
    3b16:	56                   	push   %esi
    3b17:	e8 6d fe ff ff       	call   3989 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3b49:	ff 24 85 ac 55 00 00 	jmp    *0x55ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    3b6e:	e8 16 fe ff ff       	call   3989 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b7f:	57                   	push   %edi
    3b80:	56                   	push   %esi
    3b81:	e8 03 fe ff ff       	call   3989 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3beb:	57                   	push   %edi
    3bec:	56                   	push   %esi
    3bed:	e8 97 fd ff ff       	call   3989 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c2f:	e8 55 fd ff ff       	call   3989 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3c57:	90                   	nop
          s = "(null)";
    3c58:	ba a2 55 00 00       	mov    $0x55a2,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d63:	e8 89 fc ff ff       	call   39f1 <sbrk>
  if(p == (char*)-1)
