...
int main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  11:	e8 b3 06 00 00       	call   6c9 <getpid>
  ...
  27:	c7 45 f4 16 00 00 00 	movl   $0x16,-0xc(%ebp)
   size = (unsigned int)sbrk(0);
  2e:	e8 9e 06 00 00       	call   6d1 <sbrk>
  ...
  66:	e8 45 07 00 00       	call   7b0 <printf>
   exit();
  6b:	e8 d9 05 00 00       	call   649 <exit>
   assert(join_pid > 0);
  70:	6a 27                	push   $0x27
  ...
  ac:	e8 c8 05 00 00       	call   679 <kill>
  b1:	e8 93 05 00 00       	call   649 <exit>
   assert(thread_pid > 0);
  b6:	6a 24                	push   $0x24
...
void worker2(void *arg1, void *arg2)
{
  ...
  e3:	83 ec 14             	sub    $0x14,%esp
   lock_acquire(&lock);
  e6:	68 51 0f 00 00       	push   $0xf51
  eb:	e8 30 05 00 00       	call   620 <lock_acquire>
   assert((unsigned int)sbrk(0) == size);
  f0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  f7:	e8 d5 05 00 00       	call   6d1 <sbrk>
 ...
 143:	e8 31 05 00 00       	call   679 <kill>
 148:	e8 fc 04 00 00       	call   649 <exit>
   lock_release(&lock);
 14d:	83 ec 0c             	sub    $0xc,%esp
   global++;
 150:	83 05 58 0f 00 00 01 	addl   $0x1,0xf58
   lock_release(&lock);
 157:	68 51 0f 00 00       	push   $0xf51
 15c:	e8 cf 04 00 00       	call   630 <lock_release>
   lock_acquire(&lock2);
 161:	c7 04 24 50 0f 00 00 	movl   $0xf50,(%esp)
 168:	e8 b3 04 00 00       	call   620 <lock_acquire>
   assert((unsigned int)sbrk(0) == size);
 16d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 174:	e8 58 05 00 00       	call   6d1 <sbrk>
 ...
 18b:	83 05 58 0f 00 00 01 	addl   $0x1,0xf58
   lock_release(&lock2);
 192:	68 50 0f 00 00       	push   $0xf50
 197:	e8 94 04 00 00       	call   630 <lock_release>

   
   exit();
 19c:	e8 a8 04 00 00       	call   649 <exit>
...
void worker(void *arg1, void *arg2) {
 ...
 1b3:	83 ec 14             	sub    $0x14,%esp
   lock_init(&lock);
 1b6:	68 51 0f 00 00       	push   $0xf51
 1bb:	e8 80 04 00 00       	call   640 <lock_init>
   lock_init(&lock2);
 1c0:	c7 04 24 50 0f 00 00 	movl   $0xf50,(%esp)
 1c7:	e8 74 04 00 00       	call   640 <lock_init>
   lock_acquire(&lock);
 1cc:	c7 04 24 51 0f 00 00 	movl   $0xf51,(%esp)
 1d3:	e8 48 04 00 00       	call   620 <lock_acquire>
   lock_acquire(&lock2);
 1d8:	c7 04 24 50 0f 00 00 	movl   $0xf50,(%esp)
 1df:	e8 3c 04 00 00       	call   620 <lock_acquire>
 ...
 203:	6a 00                	push   $0x0
 205:	e8 c7 04 00 00       	call   6d1 <sbrk>
 ...
 20d:	a3 54 0f 00 00       	mov    %eax,0xf54
   while (global < num_threads) {
 212:	a1 4c 0f 00 00       	mov    0xf4c,%eax
 217:	39 05 58 0f 00 00    	cmp    %eax,0xf58
 21d:	7d 36                	jge    255 <worker+0xa5>
 21f:	90                   	nop
      lock_release(&lock);
 220:	83 ec 0c             	sub    $0xc,%esp
 223:	68 51 0f 00 00       	push   $0xf51
 228:	e8 03 04 00 00       	call   630 <lock_release>
      sleep(100);
 22d:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
 234:	e8 a0 04 00 00       	call   6d9 <sleep>
      lock_acquire(&lock);
 239:	c7 04 24 51 0f 00 00 	movl   $0xf51,(%esp)
 240:	e8 db 03 00 00       	call   620 <lock_acquire>
   while (global < num_threads) {
 245:	a1 4c 0f 00 00       	mov    0xf4c,%eax
 ...
 267:	e8 65 04 00 00       	call   6d1 <sbrk>
   size = (unsigned int)sbrk(0);
 26c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 273:	e8 59 04 00 00       	call   6d1 <sbrk>
   lock_release(&lock);
 278:	c7 04 24 51 0f 00 00 	movl   $0xf51,(%esp)
   size = (unsigned int)sbrk(0);
 ...
 284:	e8 a7 03 00 00       	call   630 <lock_release>
   ...
   while (global < num_threads) {
 289:	a1 4c 0f 00 00       	mov    0xf4c,%eax
 ...
 2a3:	68 50 0f 00 00       	push   $0xf50
 2a8:	e8 83 03 00 00       	call   630 <lock_release>
      sleep(100);
 2ad:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
 2b4:	e8 20 04 00 00       	call   6d9 <sleep>
      lock_acquire(&lock2);
 2b9:	c7 04 24 50 0f 00 00 	movl   $0xf50,(%esp)
 2c0:	e8 5b 03 00 00       	call   620 <lock_acquire>
   while (global < num_threads) {
 2c5:	a1 4c 0f 00 00       	mov    0xf4c,%eax
 ...
 2ec:	7e 05                	jle    2f3 <worker+0x143>
   ...
   exit();
 2ee:	e8 56 03 00 00       	call   649 <exit>
   assert(nested_join_pid > 0);
 2f3:	6a 5d                	push   $0x5d
 ...
 32f:	e8 45 03 00 00       	call   679 <kill>
 334:	e8 10 03 00 00       	call   649 <exit>
    assert(nested_thread_id > 0);
 339:	6a 47                	push   $0x47
 ...
 489:	31 db                	xor    %ebx,%ebx
{
 ...
 495:	57                   	push   %edi
 496:	6a 00                	push   $0x0
 498:	e8 c4 01 00 00       	call   661 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4fd:	e8 87 01 00 00       	call   689 <open>
  if(fd < 0)
 ...
 511:	50                   	push   %eax
 512:	e8 8a 01 00 00       	call   6a1 <fstat>
  close(fd);
 517:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 51a:	89 c6                	mov    %eax,%esi
  close(fd);
 51c:	e8 50 01 00 00       	call   671 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 5b7:	68 00 10 00 00       	push   $0x1000
 5bc:	e8 1f 04 00 00       	call   9e0 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 5cb:	e8 19 01 00 00       	call   6e9 <clone>
 ...
 5d4:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 5d6:	68 6e 0b 00 00       	push   $0xb6e
 5db:	6a 01                	push   $0x1
 5dd:	e8 ce 01 00 00       	call   7b0 <printf>
  return rc;
}
...
thread_join(){
 ...
 5f8:	6a 04                	push   $0x4
 5fa:	e8 e1 03 00 00       	call   9e0 <malloc>
  int rc = join(stack);
 5ff:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 602:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 604:	e8 e8 00 00 00       	call   6f1 <join>
 609:	89 c6                	mov    %eax,%esi
  free(*stack);
 60b:	58                   	pop    %eax
 60c:	ff 33                	push   (%ebx)
 60e:	e8 3d 03 00 00       	call   950 <free>
  return rc;
}
 613:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 70c:	89 d1                	mov    %edx,%ecx
{
 ...
 739:	0f b6 92 e4 0b 00 00 	movzbl 0xbe4(%edx),%edx
 ...
 7b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7f5:	57                   	push   %edi
 7f6:	56                   	push   %esi
 7f7:	e8 6d fe ff ff       	call   669 <write>
 ...
 829:	ff 24 85 8c 0b 00 00 	jmp    *0xb8c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 84e:	e8 16 fe ff ff       	call   669 <write>
        putc(fd, c);
 ...
 85f:	57                   	push   %edi
 860:	56                   	push   %esi
 861:	e8 03 fe ff ff       	call   669 <write>
        putc(fd, c);
 ...
 8cb:	57                   	push   %edi
 8cc:	56                   	push   %esi
 8cd:	e8 97 fd ff ff       	call   669 <write>
        while(*s != 0){
 ...
 90c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 90f:	e8 55 fd ff ff       	call   669 <write>
        ap++;
 ...
 937:	90                   	nop
          s = "(null)";
 938:	ba 82 0b 00 00       	mov    $0xb82,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 951:	a1 60 0f 00 00       	mov    0xf60,%eax
{
 ...
 991:	5b                   	pop    %ebx
  freep = p;
 992:	89 15 60 0f 00 00    	mov    %edx,0xf60
}
 998:	5e                   	pop    %esi
 999:	5f                   	pop    %edi
 99a:	5d                   	pop    %ebp
 ...
 9c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9cc:	89 15 60 0f 00 00    	mov    %edx,0xf60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9ec:	8b 3d 60 0f 00 00    	mov    0xf60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a2f:	73 4f                	jae    a80 <malloc+0xa0>
    ...
    if(p == freep)
 a31:	8b 3d 60 0f 00 00    	mov    0xf60,%edi
 ...
 a43:	e8 89 fc ff ff       	call   6d1 <sbrk>
  if(p == (char*)-1)
 ...
 a5a:	e8 f1 fe ff ff       	call   950 <free>
  return freep;
 a5f:	8b 15 60 0f 00 00    	mov    0xf60,%edx
 ...
 a8c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a8f:	89 15 60 0f 00 00    	mov    %edx,0xf60
}
 ...
 a9f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 aa0:	c7 05 60 0f 00 00 64 	movl   $0xf64,0xf60
 aa7:	0f 00 00 
    base.s.size = 0;
 aaa:	bf 64 0f 00 00       	mov    $0xf64,%edi
    base.s.ptr = freep = prevp = &base;
 aaf:	c7 05 64 0f 00 00 64 	movl   $0xf64,0xf64
 ab6:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ab9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 abb:	c7 05 68 0f 00 00 00 	movl   $0x0,0xf68
 ac2:	00 00 00 
    if(p->s.size >= nunits){
