...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 04 04 00 00       	call   43e <mkdir>
...
thread_join(){
 ...
 337:	68 af 08 00 00       	push   $0x8af
 33c:	6a 01                	push   $0x1
 33e:	e8 fd 01 00 00       	call   540 <printf>
  void** stack = malloc(sizeof(void**));
 343:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
 34a:	e8 21 04 00 00       	call   770 <malloc>
 34f:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 2 \n");
 351:	58                   	pop    %eax
 352:	5a                   	pop    %edx
 353:	68 bf 08 00 00       	push   $0x8bf
 358:	6a 01                	push   $0x1
 35a:	e8 e1 01 00 00       	call   540 <printf>
  int rc = join(stack);
 35f:	89 1c 24             	mov    %ebx,(%esp)
 362:	e8 17 01 00 00       	call   47e <join>
 ...
 368:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 36a:	58                   	pop    %eax
 36b:	68 cf 08 00 00       	push   $0x8cf
 370:	6a 01                	push   $0x1
 372:	e8 c9 01 00 00       	call   540 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 377:	58                   	pop    %eax
 378:	5a                   	pop    %edx
 379:	68 df 08 00 00       	push   $0x8df
 37e:	6a 01                	push   $0x1
 380:	e8 bb 01 00 00       	call   540 <printf>
  return rc;
}
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 50 09 00 00 	movzbl 0x950(%edx),%edx
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b9:	ff 24 85 f8 08 00 00 	jmp    *0x8f8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6c7:	90                   	nop
          s = "(null)";
 6c8:	ba ef 08 00 00       	mov    $0x8ef,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 b0 0c 00 00       	mov    0xcb0,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 b0 0c 00 00    	mov    %edx,0xcb0
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 b0 0c 00 00    	mov    %edx,0xcb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d b0 0c 00 00    	mov    0xcb0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d b0 0c 00 00    	mov    0xcb0,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 b0 0c 00 00    	mov    0xcb0,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 b0 0c 00 00    	mov    %edx,0xcb0
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 b0 0c 00 00 b4 	movl   $0xcb4,0xcb0
 837:	0c 00 00 
    base.s.size = 0;
 83a:	bf b4 0c 00 00       	mov    $0xcb4,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 b4 0c 00 00 b4 	movl   $0xcb4,0xcb4
 846:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 b8 0c 00 00 00 	movl   $0x0,0xcb8
 852:	00 00 00 
    if(p->s.size >= nunits){
