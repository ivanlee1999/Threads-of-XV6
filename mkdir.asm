...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 97 03 00 00       	call   3d1 <mkdir>
  ...
  exit();
  4b:	e8 19 03 00 00       	call   369 <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 5e 04 00 00       	call   4d0 <printf>
    exit();
  72:	e8 f2 02 00 00       	call   369 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 c4 01 00 00       	call   381 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 87 01 00 00       	call   3a9 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 8a 01 00 00       	call   3c1 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 50 01 00 00       	call   391 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2dc:	e8 1f 04 00 00       	call   700 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 2eb:	e8 19 01 00 00       	call   409 <clone>
 ...
 2f4:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 2f6:	68 2b 08 00 00       	push   $0x82b
 2fb:	6a 01                	push   $0x1
 2fd:	e8 ce 01 00 00       	call   4d0 <printf>
  return rc;
}
...
thread_join(){
 ...
 318:	6a 04                	push   $0x4
 31a:	e8 e1 03 00 00       	call   700 <malloc>
  int rc = join(stack);
 31f:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 322:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 324:	e8 e8 00 00 00       	call   411 <join>
 329:	89 c6                	mov    %eax,%esi
  free(*stack);
 32b:	58                   	pop    %eax
 32c:	ff 33                	push   (%ebx)
 32e:	e8 3d 03 00 00       	call   670 <free>
  return rc;
}
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 3f 08 00 00       	mov    $0x83f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 e0 0b 00 00       	mov    0xbe0,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 e0 0b 00 00    	mov    %edx,0xbe0
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 e0 0b 00 00    	mov    %edx,0xbe0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d e0 0b 00 00    	mov    0xbe0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d e0 0b 00 00    	mov    0xbe0,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 e0 0b 00 00    	mov    0xbe0,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 e0 0b 00 00    	mov    %edx,0xbe0
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 e0 0b 00 00 e4 	movl   $0xbe4,0xbe0
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf e4 0b 00 00       	mov    $0xbe4,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 e4 0b 00 00 e4 	movl   $0xbe4,0xbe4
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 e8 0b 00 00 00 	movl   $0x0,0xbe8
 7e2:	00 00 00 
    if(p->s.size >= nunits){
