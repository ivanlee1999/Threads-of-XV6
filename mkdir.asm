...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 77 03 00 00       	call   3b1 <mkdir>
  ...
  exit();
  4b:	e8 f9 02 00 00       	call   349 <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 3e 04 00 00       	call   4b0 <printf>
    exit();
  72:	e8 d2 02 00 00       	call   349 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 a4 01 00 00       	call   361 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 67 01 00 00       	call   389 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 6a 01 00 00       	call   3a1 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 30 01 00 00       	call   371 <close>
  return r;
