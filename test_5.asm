...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 90 05 00 00       	call   5a9 <getpid>

   void *stack, *p = malloc(PGSIZE * 2);
  19:	83 ec 0c             	sub    $0xc,%esp
  1c:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  21:	a3 38 0e 00 00       	mov    %eax,0xe38
   void *stack, *p = malloc(PGSIZE * 2);
  ...
  60:	c7 45 e0 18 00 00 00 	movl   $0x18,-0x20(%ebp)
   int clone_pid = clone(worker, &arg1, &arg2, stack);
  67:	e8 5d 05 00 00       	call   5c9 <clone>
   assert(clone_pid > 0);
  ...
  7b:	50                   	push   %eax
  7c:	e8 50 05 00 00       	call   5d1 <join>
  ...
  bd:	5b                   	pop    %ebx
  be:	ff 35 38 0e 00 00    	push   0xe38
  c4:	e8 90 04 00 00       	call   559 <kill>
  c9:	e8 5b 04 00 00       	call   529 <exit>
  ce:	6a 25                	push   $0x25
 ...
 10b:	eb 96                	jmp    a3 <main+0xa3>
   assert(global == 2);
 10d:	83 3d 34 0e 00 00 02 	cmpl   $0x2,0xe34
 ...
 167:	e8 c4 06 00 00       	call   830 <free>
   exit();
 16c:	e8 b8 03 00 00       	call   529 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 196:	75 2a                	jne    1c2 <worker+0x42>
   assert(global == 1);
 198:	83 3d 34 0e 00 00 01 	cmpl   $0x1,0xe34
 ...
 1f7:	59                   	pop    %ecx
 1f8:	ff 35 38 0e 00 00    	push   0xe38
 1fe:	e8 56 03 00 00       	call   559 <kill>
 203:	e8 21 03 00 00       	call   529 <exit>
   assert(tmp1 == 42);
 208:	6a 36                	push   $0x36
 ...
 223:	eb b8                	jmp    1dd <worker+0x5d>
   global++;
 225:	c7 05 34 0e 00 00 02 	movl   $0x2,0xe34
 22c:	00 00 00 
   exit();
 ...
 5ec:	89 d1                	mov    %edx,%ecx
{
 ...
 619:	0f b6 92 dc 0a 00 00 	movzbl 0xadc(%edx),%edx
 ...
 699:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 709:	ff 24 85 84 0a 00 00 	jmp    *0xa84(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 817:	90                   	nop
          s = "(null)";
 818:	ba 7b 0a 00 00       	mov    $0xa7b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 831:	a1 3c 0e 00 00       	mov    0xe3c,%eax
{
 ...
 871:	5b                   	pop    %ebx
  freep = p;
 872:	89 15 3c 0e 00 00    	mov    %edx,0xe3c
}
 878:	5e                   	pop    %esi
 879:	5f                   	pop    %edi
 87a:	5d                   	pop    %ebp
 ...
 8a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8ac:	89 15 3c 0e 00 00    	mov    %edx,0xe3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8cc:	8b 3d 3c 0e 00 00    	mov    0xe3c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 90f:	73 4f                	jae    960 <malloc+0xa0>
    ...
    if(p == freep)
 911:	8b 3d 3c 0e 00 00    	mov    0xe3c,%edi
 ...
 93a:	e8 f1 fe ff ff       	call   830 <free>
  return freep;
 93f:	8b 15 3c 0e 00 00    	mov    0xe3c,%edx
 ...
 96c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 96f:	89 15 3c 0e 00 00    	mov    %edx,0xe3c
}
 ...
 97f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 980:	c7 05 3c 0e 00 00 40 	movl   $0xe40,0xe3c
 987:	0e 00 00 
    base.s.size = 0;
 98a:	bf 40 0e 00 00       	mov    $0xe40,%edi
    base.s.ptr = freep = prevp = &base;
 98f:	c7 05 40 0e 00 00 40 	movl   $0xe40,0xe40
 996:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 999:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 99b:	c7 05 44 0e 00 00 00 	movl   $0x0,0xe44
 9a2:	00 00 00 
    if(p->s.size >= nunits){
