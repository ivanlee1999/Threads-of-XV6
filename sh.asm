...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      24:	6a 02                	push   $0x2
      26:	68 59 14 00 00       	push   $0x1459
      2b:	e8 36 0f 00 00       	call   f66 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 c9 0e 00 00       	call   f1e <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 c7 0e 00 00       	call   f2e <wait>
  printf(2, "$ ");
      67:	83 ec 08             	sub    $0x8,%esp
      6a:	68 b8 13 00 00       	push   $0x13b8
      6f:	6a 02                	push   $0x2
      71:	e8 1a 10 00 00       	call   1090 <printf>
  memset(buf, 0, nbuf);
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 93 0e 00 00       	call   f4e <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 a1 0e 00 00       	call   f96 <chdir>
     ...
     106:	68 61 14 00 00       	push   $0x1461
     10b:	6a 02                	push   $0x2
     10d:	e8 7e 0f 00 00       	call   1090 <printf>
     112:	83 c4 10             	add    $0x10,%esp
     115:	e9 4d ff ff ff       	jmp    67 <main+0x67>
  exit();
     11a:	e8 07 0e 00 00       	call   f26 <exit>
    panic("fork");
     11f:	83 ec 0c             	sub    $0xc,%esp
     122:	68 bb 13 00 00       	push   $0x13bb
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 b8 13 00 00       	push   $0x13b8
     143:	6a 02                	push   $0x2
     145:	e8 46 0f 00 00       	call   1090 <printf>
  memset(buf, 0, nbuf);
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 55 14 00 00       	push   $0x1455
     17e:	6a 02                	push   $0x2
     180:	e8 0b 0f 00 00       	call   1090 <printf>
  exit();
     185:	e8 9c 0d 00 00       	call   f26 <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 83 0d 00 00       	call   f1e <fork>
  if(pid == -1)
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 bb 13 00 00       	push   $0x13bb
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 70 14 00 00 	jmp    *0x1470(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 7b 0d 00 00       	call   f5e <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     1e3:	83 c4 0c             	add    $0xc,%esp
     1e6:	ff 73 04             	push   0x4(%ebx)
     1e9:	68 c7 13 00 00       	push   $0x13c7
     1ee:	6a 02                	push   $0x2
     1f0:	e8 9b 0e 00 00       	call   1090 <printf>
    break;
     1f5:	83 c4 10             	add    $0x10,%esp
     1f8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     1ff:	90                   	nop
    exit();
     200:	e8 21 0d 00 00       	call   f26 <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 17 0d 00 00       	call   f36 <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 ff 0c 00 00       	call   f4e <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 f6 0c 00 00       	call   f4e <close>
    wait();
     258:	e8 d1 0c 00 00       	call   f2e <wait>
    wait();
     25d:	e8 cc 0c 00 00       	call   f2e <wait>
    break;
    ...
    wait();
     270:	e8 b9 0c 00 00       	call   f2e <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 c3 0c 00 00       	call   f4e <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 ce 0c 00 00       	call   f66 <open>
    ...
    panic("runcmd");
     ...
     2ad:	68 c0 13 00 00       	push   $0x13c0
     2b2:	e8 b9 fe ff ff       	call   170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2b7:	51                   	push   %ecx
     2b8:	ff 73 08             	push   0x8(%ebx)
     2bb:	68 d7 13 00 00       	push   $0x13d7
     2c0:	6a 02                	push   $0x2
     2c2:	e8 c9 0d 00 00       	call   1090 <printf>
      exit();
     2c7:	e8 5a 0c 00 00       	call   f26 <exit>
      panic("pipe");
     2cc:	83 ec 0c             	sub    $0xc,%esp
     2cf:	68 e7 13 00 00       	push   $0x13e7
     2d4:	e8 97 fe ff ff       	call   170 <panic>
      close(1);
     2d9:	83 ec 0c             	sub    $0xc,%esp
     2dc:	6a 01                	push   $0x1
     2de:	e8 6b 0c 00 00       	call   f4e <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 b2 0c 00 00       	call   f9e <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 59 0c 00 00       	call   f4e <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 50 0c 00 00       	call   f4e <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 3d 0c 00 00       	call   f4e <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 84 0c 00 00       	call   f9e <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 2b 0c 00 00       	call   f4e <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 22 0c 00 00       	call   f4e <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     347:	6a 54                	push   $0x54
     349:	e8 72 0f 00 00       	call   12c0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     377:	6a 18                	push   $0x18
     379:	e8 42 0f 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3c7:	6a 0c                	push   $0xc
     3c9:	e8 f2 0e 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     407:	6a 0c                	push   $0xc
     409:	e8 b2 0e 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     447:	6a 08                	push   $0x8
     449:	e8 72 0e 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 d8 1b 00 00       	push   $0x1bd8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 d8 1b 00 00       	push   $0x1bd8
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 d0 1b 00 00       	push   $0x1bd0
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 d8 1b 00 00       	push   $0x1bd8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 d8 1b 00 00       	push   $0x1bd8
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 09 14 00 00       	push   $0x1409
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     6c2:	e8 f9 0b 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     721:	e8 9a 0b 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     77e:	68 ec 13 00 00       	push   $0x13ec
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 0c 14 00 00       	push   $0x140c
     7a4:	57                   	push   %edi
     7a5:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     7bb:	6a 54                	push   $0x54
     7bd:	e8 fe 0a 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 23 14 00 00       	push   $0x1423
     80b:	57                   	push   %edi
     80c:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 15 14 00 00       	push   $0x1415
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 0e 14 00 00       	push   $0x140e
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 28 14 00 00       	push   $0x1428
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     90d:	e8 ae 09 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000940 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     972:	e8 49 09 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 2a 14 00 00       	push   $0x142a
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 26 14 00 00       	push   $0x1426
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     9ed:	e8 ce 08 00 00       	call   12c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 0c 14 00 00       	push   $0x140c
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 48 14 00 00       	push   $0x1448
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac9:	ff 24 85 88 14 00 00 	jmp    *0x1488(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 c4 14 00 00       	push   $0x14c4
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 4a 14 00 00       	push   $0x144a
     bb5:	6a 02                	push   $0x2
     bb7:	e8 d4 04 00 00       	call   1090 <printf>
    panic("syntax");
     bbc:	c7 04 24 0e 14 00 00 	movl   $0x140e,(%esp)
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 31 02 00 00       	call   f3e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 f4 01 00 00       	call   f66 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 f7 01 00 00       	call   f7e <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 bd 01 00 00       	call   f4e <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
  ...
  void* stack = malloc(2* 4096);
     ...
     e2c:	e8 8f 04 00 00       	call   12c0 <malloc>
  if((int) stack % 4096 != 0){
     e31:	83 c4 10             	add    $0x10,%esp
     e34:	a9 ff 0f 00 00       	test   $0xfff,%eax
     e39:	74 16                	je     e51 <thread_create+0x31>
    stack = stack + (4096 - (int) stack % 4096);
     e3b:	99                   	cltd   
     e3c:	c1 ea 14             	shr    $0x14,%edx
     e3f:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
     e42:	81 e1 ff 0f 00 00    	and    $0xfff,%ecx
     e48:	29 ca                	sub    %ecx,%edx
     e4a:	8d 84 10 00 10 00 00 	lea    0x1000(%eax,%edx,1),%eax
  }
  int rc = clone(start_routine, arg1, arg2, stack);
     e51:	50                   	push   %eax
     e52:	ff 75 10             	push   0x10(%ebp)
     e55:	ff 75 0c             	push   0xc(%ebp)
     e58:	ff 75 08             	push   0x8(%ebp)
     e5b:	e8 66 01 00 00       	call   fc6 <clone>
  ...
  printf(1, " thread create  %d \n", rc);
     e66:	68 a0 14 00 00       	push   $0x14a0
     e6b:	6a 01                	push   $0x1
     e6d:	e8 1e 02 00 00       	call   1090 <printf>
  return rc;
}
     e72:	89 d8                	mov    %ebx,%eax
     e74:	8b 5d fc             	mov    -0x4(%ebp),%ebx
     e77:	c9                   	leave  
     e78:	c3                   	ret    
...
thread_join(){
  ...
  printf(1, "thread join 1 \n");
     e87:	68 b5 14 00 00       	push   $0x14b5
     e8c:	6a 01                	push   $0x1
     e8e:	e8 fd 01 00 00       	call   1090 <printf>
  void** stack = malloc(sizeof(void**));
     e93:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
     e9a:	e8 21 04 00 00       	call   12c0 <malloc>
     e9f:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 2 \n");
     ea1:	58                   	pop    %eax
     ea2:	5a                   	pop    %edx
     ea3:	68 c5 14 00 00       	push   $0x14c5
     ea8:	6a 01                	push   $0x1
     eaa:	e8 e1 01 00 00       	call   1090 <printf>
  int rc = join(stack);
     eaf:	89 1c 24             	mov    %ebx,(%esp)
     eb2:	e8 17 01 00 00       	call   fce <join>
  ...
  printf(1, "thread join 3 \n");
     eba:	58                   	pop    %eax
     ebb:	68 d5 14 00 00       	push   $0x14d5
     ec0:	6a 01                	push   $0x1
     ec2:	e8 c9 01 00 00       	call   1090 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
     ec7:	58                   	pop    %eax
     ec8:	5a                   	pop    %edx
     ec9:	68 e5 14 00 00       	push   $0x14e5
     ece:	6a 01                	push   $0x1
     ed0:	e8 bb 01 00 00       	call   1090 <printf>
  return rc;
}
     ed5:	89 d8                	mov    %ebx,%eax
     ed7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
     eda:	c9                   	leave  
     edb:	c3                   	ret    
...
00000f00 <lock_release>:

void lock_release(lock_t * lock){
     f00:	55                   	push   %ebp
     f01:	31 c0                	xor    %eax,%eax
     f03:	89 e5                	mov    %esp,%ebp
     f05:	8b 55 08             	mov    0x8(%ebp),%edx
     f08:	f0 87 02             	lock xchg %eax,(%edx)
...
lock->flag=0;
     ...
     f16:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
     ...
     fec:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1019:	0f b6 92 54 15 00 00 	movzbl 0x1554(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    105e:	56                   	push   %esi
    105f:	57                   	push   %edi
    1060:	e8 e1 fe ff ff       	call   f46 <write>
  while(--i >= 0)
    ...
    1099:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    109f:	0f b6 13             	movzbl (%ebx),%edx
    10a2:	84 d2                	test   %dl,%dl
    10a4:	74 6a                	je     1110 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    10a6:	8d 45 10             	lea    0x10(%ebp),%eax
    10a9:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    10ac:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    10af:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    10b1:	89 45 d0             	mov    %eax,-0x30(%ebp)
    10b4:	eb 36                	jmp    10ec <printf+0x5c>
    10b6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    10bd:	8d 76 00             	lea    0x0(%esi),%esi
    10c0:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    10c3:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    10c8:	83 f8 25             	cmp    $0x25,%eax
    10cb:	74 15                	je     10e2 <printf+0x52>
  write(fd, &c, 1);
    ...
    10d5:	57                   	push   %edi
    10d6:	56                   	push   %esi
    10d7:	e8 6a fe ff ff       	call   f46 <write>
    10dc:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    10df:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    10e2:	0f b6 13             	movzbl (%ebx),%edx
    10e5:	83 c3 01             	add    $0x1,%ebx
    10e8:	84 d2                	test   %dl,%dl
    10ea:	74 24                	je     1110 <printf+0x80>
    c = fmt[i] & 0xff;
    10ec:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    10ef:	85 c9                	test   %ecx,%ecx
    10f1:	74 cd                	je     10c0 <printf+0x30>
      }
    } else if(state == '%'){
    10f3:	83 f9 25             	cmp    $0x25,%ecx
    10f6:	75 ea                	jne    10e2 <printf+0x52>
      if(c == 'd'){
    10f8:	83 f8 25             	cmp    $0x25,%eax
    10fb:	0f 84 07 01 00 00    	je     1208 <printf+0x178>
    1101:	83 e8 63             	sub    $0x63,%eax
    1104:	83 f8 15             	cmp    $0x15,%eax
    1107:	77 17                	ja     1120 <printf+0x90>
    1109:	ff 24 85 fc 14 00 00 	jmp    *0x14fc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1123:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    1126:	6a 01                	push   $0x1
    1128:	57                   	push   %edi
    1129:	56                   	push   %esi
    112a:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    112e:	e8 13 fe ff ff       	call   f46 <write>
        putc(fd, c);
    1133:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    1137:	83 c4 0c             	add    $0xc,%esp
    113a:	88 55 e7             	mov    %dl,-0x19(%ebp)
    113d:	6a 01                	push   $0x1
    113f:	57                   	push   %edi
    1140:	56                   	push   %esi
    1141:	e8 00 fe ff ff       	call   f46 <write>
        putc(fd, c);
    1146:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1149:	31 c9                	xor    %ecx,%ecx
    114b:	eb 95                	jmp    10e2 <printf+0x52>
    114d:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    1150:	83 ec 0c             	sub    $0xc,%esp
    1153:	b9 10 00 00 00       	mov    $0x10,%ecx
    1158:	6a 00                	push   $0x0
    115a:	8b 45 d0             	mov    -0x30(%ebp),%eax
    115d:	8b 10                	mov    (%eax),%edx
    115f:	89 f0                	mov    %esi,%eax
    1161:	e8 7a fe ff ff       	call   fe0 <printint>
        ap++;
    1166:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    116a:	83 c4 10             	add    $0x10,%esp
      state = 0;
    116d:	31 c9                	xor    %ecx,%ecx
    116f:	e9 6e ff ff ff       	jmp    10e2 <printf+0x52>
    1174:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    1178:	8b 45 d0             	mov    -0x30(%ebp),%eax
    117b:	8b 10                	mov    (%eax),%edx
        ap++;
    117d:	83 c0 04             	add    $0x4,%eax
    1180:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    1183:	85 d2                	test   %edx,%edx
    1185:	0f 84 8d 00 00 00    	je     1218 <printf+0x188>
        while(*s != 0){
    ...
    1192:	0f 84 4a ff ff ff    	je     10e2 <printf+0x52>
    1198:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    119b:	89 d3                	mov    %edx,%ebx
  ...
  write(fd, &c, 1);
    ...
    11ab:	57                   	push   %edi
    11ac:	56                   	push   %esi
    11ad:	e8 94 fd ff ff       	call   f46 <write>
        while(*s != 0){
    11b2:	0f b6 03             	movzbl (%ebx),%eax
    11b5:	83 c4 10             	add    $0x10,%esp
    11b8:	84 c0                	test   %al,%al
    11ba:	75 e4                	jne    11a0 <printf+0x110>
      state = 0;
    11bc:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    11bf:	31 c9                	xor    %ecx,%ecx
    11c1:	e9 1c ff ff ff       	jmp    10e2 <printf+0x52>
    ...
    11d8:	6a 01                	push   $0x1
    11da:	e9 7b ff ff ff       	jmp    115a <printf+0xca>
    11df:	90                   	nop
        putc(fd, *ap);
  ...
  write(fd, &c, 1);
    ...
    11eb:	56                   	push   %esi
        putc(fd, *ap);
    11ec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    11ef:	e8 52 fd ff ff       	call   f46 <write>
        ap++;
    11f4:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    11f8:	83 c4 10             	add    $0x10,%esp
      state = 0;
    11fb:	31 c9                	xor    %ecx,%ecx
    11fd:	e9 e0 fe ff ff       	jmp    10e2 <printf+0x52>
    1202:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, c);
    1208:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    120b:	83 ec 04             	sub    $0x4,%esp
    120e:	e9 2a ff ff ff       	jmp    113d <printf+0xad>
    1213:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    1217:	90                   	nop
          s = "(null)";
    1218:	ba f5 14 00 00       	mov    $0x14f5,%edx
        while(*s != 0){
    121d:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    1220:	b8 28 00 00 00       	mov    $0x28,%eax
    1225:	89 d3                	mov    %edx,%ebx
    1227:	e9 74 ff ff ff       	jmp    11a0 <printf+0x110>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1231:	a1 44 1c 00 00       	mov    0x1c44,%eax
{
  ...
  bp = (Header*)ap - 1;
    123e:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1241:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1248:	89 c2                	mov    %eax,%edx
    124a:	8b 00                	mov    (%eax),%eax
    124c:	39 ca                	cmp    %ecx,%edx
    124e:	73 30                	jae    1280 <free+0x50>
    1250:	39 c1                	cmp    %eax,%ecx
    1252:	72 04                	jb     1258 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1254:	39 c2                	cmp    %eax,%edx
    1256:	72 f0                	jb     1248 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    1258:	8b 73 fc             	mov    -0x4(%ebx),%esi
    125b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    125e:	39 f8                	cmp    %edi,%eax
    1260:	74 30                	je     1292 <free+0x62>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    1262:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    1265:	8b 42 04             	mov    0x4(%edx),%eax
    1268:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    126b:	39 f1                	cmp    %esi,%ecx
    126d:	74 3a                	je     12a9 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    126f:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    1271:	5b                   	pop    %ebx
  freep = p;
    1272:	89 15 44 1c 00 00    	mov    %edx,0x1c44
}
    1278:	5e                   	pop    %esi
    1279:	5f                   	pop    %edi
    127a:	5d                   	pop    %ebp
    ...
    1282:	72 c4                	jb     1248 <free+0x18>
    1284:	39 c1                	cmp    %eax,%ecx
    1286:	73 c0                	jae    1248 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    1288:	8b 73 fc             	mov    -0x4(%ebx),%esi
    128b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    128e:	39 f8                	cmp    %edi,%eax
    1290:	75 d0                	jne    1262 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    1292:	03 70 04             	add    0x4(%eax),%esi
    1295:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    1298:	8b 02                	mov    (%edx),%eax
    129a:	8b 00                	mov    (%eax),%eax
    129c:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    129f:	8b 42 04             	mov    0x4(%edx),%eax
    12a2:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    12a5:	39 f1                	cmp    %esi,%ecx
    12a7:	75 c6                	jne    126f <free+0x3f>
    p->s.size += bp->s.size;
    12a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    12ac:	89 15 44 1c 00 00    	mov    %edx,0x1c44
    p->s.size += bp->s.size;
    12b2:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    12b5:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    12b8:	89 0a                	mov    %ecx,(%edx)
}
    12ba:	5b                   	pop    %ebx
    12bb:	5e                   	pop    %esi
    12bc:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    12cc:	8b 3d 44 1c 00 00    	mov    0x1c44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    12d2:	8d 70 07             	lea    0x7(%eax),%esi
    12d5:	c1 ee 03             	shr    $0x3,%esi
    12d8:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    12db:	85 ff                	test   %edi,%edi
    12dd:	0f 84 9d 00 00 00    	je     1380 <malloc+0xc0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12e3:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    12e5:	8b 4a 04             	mov    0x4(%edx),%ecx
    12e8:	39 f1                	cmp    %esi,%ecx
    12ea:	73 6a                	jae    1356 <malloc+0x96>
    12ec:	bb 00 10 00 00       	mov    $0x1000,%ebx
    12f1:	39 de                	cmp    %ebx,%esi
    12f3:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    12f6:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    12fd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1300:	eb 17                	jmp    1319 <malloc+0x59>
    1302:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1308:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    130a:	8b 48 04             	mov    0x4(%eax),%ecx
    130d:	39 f1                	cmp    %esi,%ecx
    130f:	73 4f                	jae    1360 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1311:	8b 3d 44 1c 00 00    	mov    0x1c44,%edi
    1317:	89 c2                	mov    %eax,%edx
    1319:	39 d7                	cmp    %edx,%edi
    131b:	75 eb                	jne    1308 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    131d:	83 ec 0c             	sub    $0xc,%esp
    1320:	ff 75 e4             	push   -0x1c(%ebp)
    1323:	e8 86 fc ff ff       	call   fae <sbrk>
  if(p == (char*)-1)
    1328:	83 c4 10             	add    $0x10,%esp
    132b:	83 f8 ff             	cmp    $0xffffffff,%eax
    132e:	74 1c                	je     134c <malloc+0x8c>
  hp->s.size = nu;
    1330:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1333:	83 ec 0c             	sub    $0xc,%esp
    1336:	83 c0 08             	add    $0x8,%eax
    1339:	50                   	push   %eax
    133a:	e8 f1 fe ff ff       	call   1230 <free>
  return freep;
    133f:	8b 15 44 1c 00 00    	mov    0x1c44,%edx
      if((p = morecore(nunits)) == 0)
    1345:	83 c4 10             	add    $0x10,%esp
    1348:	85 d2                	test   %edx,%edx
    134a:	75 bc                	jne    1308 <malloc+0x48>
        return 0;
  }
}
    ...
    1358:	89 fa                	mov    %edi,%edx
    135a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    1360:	39 ce                	cmp    %ecx,%esi
    1362:	74 4c                	je     13b0 <malloc+0xf0>
        p->s.size -= nunits;
    1364:	29 f1                	sub    %esi,%ecx
    1366:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    1369:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    136c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    136f:	89 15 44 1c 00 00    	mov    %edx,0x1c44
}
    1375:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    1378:	83 c0 08             	add    $0x8,%eax
}
    137b:	5b                   	pop    %ebx
    137c:	5e                   	pop    %esi
    137d:	5f                   	pop    %edi
    ...
    137f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1380:	c7 05 44 1c 00 00 48 	movl   $0x1c48,0x1c44
    1387:	1c 00 00 
    base.s.size = 0;
    138a:	bf 48 1c 00 00       	mov    $0x1c48,%edi
    base.s.ptr = freep = prevp = &base;
    138f:	c7 05 48 1c 00 00 48 	movl   $0x1c48,0x1c48
    1396:	1c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1399:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    139b:	c7 05 4c 1c 00 00 00 	movl   $0x0,0x1c4c
    13a2:	00 00 00 
    if(p->s.size >= nunits){
    13a5:	e9 42 ff ff ff       	jmp    12ec <malloc+0x2c>
    13aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    13b0:	8b 08                	mov    (%eax),%ecx
    13b2:	89 0a                	mov    %ecx,(%edx)
    13b4:	eb b9                	jmp    136f <malloc+0xaf>
