     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 c3 14 00 00       	push   $0x14c3
  cmd = parseline(&s, es);
...
thread_join(){
  ...
  printf(1, "thread join 1 \n");
     e87:	68 b4 14 00 00       	push   $0x14b4
     e8c:	6a 01                	push   $0x1
  ...
  printf(1, "thread join 2 \n");
     ea1:	58                   	pop    %eax
     ea2:	5a                   	pop    %edx
     ea3:	68 c4 14 00 00       	push   $0x14c4
     ea8:	6a 01                	push   $0x1
  ...
  printf(1, "thread join 3 \n");
     eba:	58                   	pop    %eax
     ebb:	68 d4 14 00 00       	push   $0x14d4
     ec0:	6a 01                	push   $0x1
  ...
  printf(1, "thread join 4 \n");
     ec7:	58                   	pop    %eax
     ec8:	5a                   	pop    %edx
     ec9:	68 e4 14 00 00       	push   $0x14e4
     ece:	6a 01                	push   $0x1
    ...
    1099:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1217:	90                   	nop
          s = "(null)";
    1218:	ba f4 14 00 00       	mov    $0x14f4,%edx
        while(*s != 0){
