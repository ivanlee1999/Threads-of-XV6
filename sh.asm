...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 a9 0e 00 00       	call   ed9 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 3c 0e 00 00       	call   e91 <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 3a 0e 00 00       	call   ea1 <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 06 0e 00 00       	call   ec1 <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 14 0e 00 00       	call   f09 <chdir>
  ...
  exit();
     11a:	e8 7a 0d 00 00       	call   e99 <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 0f 0d 00 00       	call   e99 <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 f6 0c 00 00       	call   e91 <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 ee 0c 00 00       	call   ed1 <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 94 0c 00 00       	call   e99 <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 8a 0c 00 00       	call   ea9 <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 72 0c 00 00       	call   ec1 <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 69 0c 00 00       	call   ec1 <close>
    wait();
     258:	e8 44 0c 00 00       	call   ea1 <wait>
    wait();
     25d:	e8 3f 0c 00 00       	call   ea1 <wait>
    break;
    ...
    wait();
     270:	e8 2c 0c 00 00       	call   ea1 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 36 0c 00 00       	call   ec1 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 41 0c 00 00       	call   ed9 <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 39 0d 00 00       	call   1000 <printf>
      exit();
     2c7:	e8 cd 0b 00 00       	call   e99 <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 de 0b 00 00       	call   ec1 <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 25 0c 00 00       	call   f11 <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 cc 0b 00 00       	call   ec1 <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 c3 0b 00 00       	call   ec1 <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 b0 0b 00 00       	call   ec1 <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 f7 0b 00 00       	call   f11 <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 9e 0b 00 00       	call   ec1 <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 95 0b 00 00       	call   ec1 <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 a4 01 00 00       	call   eb1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 67 01 00 00       	call   ed9 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 6a 01 00 00       	call   ef1 <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 30 01 00 00       	call   ec1 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
  ...
  void* stack = malloc(sizeof(void*));
     e26:	6a 04                	push   $0x4
     e28:	e8 03 04 00 00       	call   1230 <malloc>
  return clone(start_routine, arg1, arg2, stack);
     e2d:	50                   	push   %eax
     e2e:	ff 75 10             	push   0x10(%ebp)
     e31:	ff 75 0c             	push   0xc(%ebp)
     e34:	ff 75 08             	push   0x8(%ebp)
     e37:	e8 fd 00 00 00       	call   f39 <clone>
}
     e3c:	c9                   	leave  
     e3d:	c3                   	ret    
...
thread_join(){
  ...
  void** stack = malloc(sizeof(void*));
     ...
     e48:	6a 04                	push   $0x4
     e4a:	e8 e1 03 00 00       	call   1230 <malloc>
  int rc = join(stack);
     e4f:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
     e52:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
     e54:	e8 e8 00 00 00       	call   f41 <join>
     e59:	89 c6                	mov    %eax,%esi
  free(*stack);
     e5b:	58                   	pop    %eax
     e5c:	ff 33                	push   (%ebx)
     e5e:	e8 3d 03 00 00       	call   11a0 <free>
  return rc;
}
     e63:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
00000e99 <exit>:
SYSCALL(exit)
     e99:	b8 02 00 00 00       	mov    $0x2,%eax
     e9e:	cd 40                	int    $0x40
     ea0:	c3                   	ret    

00000ea1 <wait>:
SYSCALL(wait)
     ea1:	b8 03 00 00 00       	mov    $0x3,%eax
     ea6:	cd 40                	int    $0x40
     ea8:	c3                   	ret    

00000ea9 <pipe>:
SYSCALL(pipe)
     ea9:	b8 04 00 00 00       	mov    $0x4,%eax
     eae:	cd 40                	int    $0x40
     eb0:	c3                   	ret    

00000eb1 <read>:
SYSCALL(read)
     eb1:	b8 05 00 00 00       	mov    $0x5,%eax
     eb6:	cd 40                	int    $0x40
     eb8:	c3                   	ret    

00000eb9 <write>:
SYSCALL(write)
     eb9:	b8 10 00 00 00       	mov    $0x10,%eax
     ebe:	cd 40                	int    $0x40
     ec0:	c3                   	ret    

00000ec1 <close>:
SYSCALL(close)
     ec1:	b8 15 00 00 00       	mov    $0x15,%eax
     ec6:	cd 40                	int    $0x40
     ec8:	c3                   	ret    

00000ec9 <kill>:
SYSCALL(kill)
     ec9:	b8 06 00 00 00       	mov    $0x6,%eax
     ece:	cd 40                	int    $0x40
     ed0:	c3                   	ret    

00000ed1 <exec>:
SYSCALL(exec)
     ed1:	b8 07 00 00 00       	mov    $0x7,%eax
     ed6:	cd 40                	int    $0x40
     ed8:	c3                   	ret    

00000ed9 <open>:
SYSCALL(open)
     ed9:	b8 0f 00 00 00       	mov    $0xf,%eax
     ede:	cd 40                	int    $0x40
     ee0:	c3                   	ret    

00000ee1 <mknod>:
SYSCALL(mknod)
     ee1:	b8 11 00 00 00       	mov    $0x11,%eax
     ee6:	cd 40                	int    $0x40
     ee8:	c3                   	ret    

00000ee9 <unlink>:
SYSCALL(unlink)
     ee9:	b8 12 00 00 00       	mov    $0x12,%eax
     eee:	cd 40                	int    $0x40
     ef0:	c3                   	ret    

00000ef1 <fstat>:
SYSCALL(fstat)
     ef1:	b8 08 00 00 00       	mov    $0x8,%eax
     ef6:	cd 40                	int    $0x40
     ef8:	c3                   	ret    

00000ef9 <link>:
SYSCALL(link)
     ef9:	b8 13 00 00 00       	mov    $0x13,%eax
     efe:	cd 40                	int    $0x40
     f00:	c3                   	ret    

00000f01 <mkdir>:
SYSCALL(mkdir)
     f01:	b8 14 00 00 00       	mov    $0x14,%eax
     f06:	cd 40                	int    $0x40
     f08:	c3                   	ret    

00000f09 <chdir>:
SYSCALL(chdir)
     f09:	b8 09 00 00 00       	mov    $0x9,%eax
     f0e:	cd 40                	int    $0x40
     f10:	c3                   	ret    

00000f11 <dup>:
SYSCALL(dup)
     f11:	b8 0a 00 00 00       	mov    $0xa,%eax
     f16:	cd 40                	int    $0x40
     f18:	c3                   	ret    

00000f19 <getpid>:
SYSCALL(getpid)
     f19:	b8 0b 00 00 00       	mov    $0xb,%eax
     f1e:	cd 40                	int    $0x40
     f20:	c3                   	ret    

00000f21 <sbrk>:
SYSCALL(sbrk)
     f21:	b8 0c 00 00 00       	mov    $0xc,%eax
     f26:	cd 40                	int    $0x40
     f28:	c3                   	ret    

00000f29 <sleep>:
SYSCALL(sleep)
     f29:	b8 0d 00 00 00       	mov    $0xd,%eax
     f2e:	cd 40                	int    $0x40
     f30:	c3                   	ret    

00000f31 <uptime>:
SYSCALL(uptime)
     f31:	b8 0e 00 00 00       	mov    $0xe,%eax
     f36:	cd 40                	int    $0x40
     f38:	c3                   	ret    

00000f39 <clone>:
SYSCALL(clone)
     f39:	b8 16 00 00 00       	mov    $0x16,%eax
     f3e:	cd 40                	int    $0x40
     f40:	c3                   	ret    

00000f41 <join>:
SYSCALL(join)
     f41:	b8 17 00 00 00       	mov    $0x17,%eax
     f46:	cd 40                	int    $0x40
     f48:	c3                   	ret    
     ...
     f5c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     fce:	56                   	push   %esi
     fcf:	57                   	push   %edi
     fd0:	e8 e4 fe ff ff       	call   eb9 <write>
  while(--i >= 0)
    ...
    1009:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1045:	57                   	push   %edi
    1046:	56                   	push   %esi
    1047:	e8 6d fe ff ff       	call   eb9 <write>
  ...
  write(fd, &c, 1);
    ...
    109e:	e8 16 fe ff ff       	call   eb9 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10af:	57                   	push   %edi
    10b0:	56                   	push   %esi
    10b1:	e8 03 fe ff ff       	call   eb9 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    111b:	57                   	push   %edi
    111c:	56                   	push   %esi
    111d:	e8 97 fd ff ff       	call   eb9 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    115f:	e8 55 fd ff ff       	call   eb9 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1293:	e8 89 fc ff ff       	call   f21 <sbrk>
  if(p == (char*)-1)
