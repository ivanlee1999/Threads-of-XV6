...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 dd 03 00 00       	call   419 <open>
  ...
  57:	e8 a5 03 00 00       	call   401 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 70 03 00 00       	call   3d9 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 c8 04 00 00       	call   540 <printf>
      exit();
  78:	e8 5c 03 00 00       	call   3d9 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 4d 03 00 00       	call   3d9 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 49 03 00 00       	call   3f9 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 27 03 00 00       	call   3f1 <read>
  ...
  e6:	e8 55 04 00 00       	call   540 <printf>
      exit();
  eb:	e8 e9 02 00 00       	call   3d9 <exit>
  ...
  f9:	e8 42 04 00 00       	call   540 <printf>
    exit();
  fe:	e8 d6 02 00 00       	call   3d9 <exit>
 ...
 239:	31 db                	xor    %ebx,%ebx
{
 ...
 245:	57                   	push   %edi
 246:	6a 00                	push   $0x0
 248:	e8 a4 01 00 00       	call   3f1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 67 01 00 00       	call   419 <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 6a 01 00 00       	call   431 <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 30 01 00 00       	call   401 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 366:	6a 04                	push   $0x4
 368:	e8 03 04 00 00       	call   770 <malloc>
  return clone(start_routine, arg1, arg2, stack);
 36d:	50                   	push   %eax
 36e:	ff 75 10             	push   0x10(%ebp)
 371:	ff 75 0c             	push   0xc(%ebp)
 374:	ff 75 08             	push   0x8(%ebp)
 377:	e8 fd 00 00 00       	call   479 <clone>
}
 37c:	c9                   	leave  
 37d:	c3                   	ret    
