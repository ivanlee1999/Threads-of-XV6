...
main(int argc, char *argv[])
{
  ...
  57:	e8 c5 03 00 00       	call   421 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 90 03 00 00       	call   3f9 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 e8 04 00 00       	call   560 <printf>
      exit();
  78:	e8 7c 03 00 00       	call   3f9 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 6d 03 00 00       	call   3f9 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 69 03 00 00       	call   419 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 47 03 00 00       	call   411 <read>
  ...
  e6:	e8 75 04 00 00       	call   560 <printf>
      exit();
  eb:	e8 09 03 00 00       	call   3f9 <exit>
  ...
  f9:	e8 62 04 00 00       	call   560 <printf>
    exit();
  fe:	e8 f6 02 00 00       	call   3f9 <exit>
 ...
 239:	31 db                	xor    %ebx,%ebx
{
 ...
 245:	57                   	push   %edi
 246:	6a 00                	push   $0x0
 248:	e8 c4 01 00 00       	call   411 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 87 01 00 00       	call   439 <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 8a 01 00 00       	call   451 <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 50 01 00 00       	call   421 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 36c:	e8 1f 04 00 00       	call   790 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 37b:	e8 19 01 00 00       	call   499 <clone>
 ...
 384:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 386:	68 c0 08 00 00       	push   $0x8c0
 38b:	6a 01                	push   $0x1
 38d:	e8 ce 01 00 00       	call   560 <printf>
  return rc;
}
...
thread_join(){
 ...
 3a8:	6a 04                	push   $0x4
 3aa:	e8 e1 03 00 00       	call   790 <malloc>
  int rc = join(stack);
 3af:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 3b2:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 3b4:	e8 e8 00 00 00       	call   4a1 <join>
 3b9:	89 c6                	mov    %eax,%esi
  free(*stack);
 3bb:	58                   	pop    %eax
 3bc:	ff 33                	push   (%ebx)
 3be:	e8 3d 03 00 00       	call   700 <free>
  return rc;
}
 3c3:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 4e9:	0f b6 92 34 09 00 00 	movzbl 0x934(%edx),%edx
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d9:	ff 24 85 dc 08 00 00 	jmp    *0x8dc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6e7:	90                   	nop
          s = "(null)";
 6e8:	ba d4 08 00 00       	mov    $0x8d4,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 701:	a1 a0 0e 00 00       	mov    0xea0,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 a0 0e 00 00    	mov    %edx,0xea0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d a0 0e 00 00    	mov    0xea0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d a0 0e 00 00    	mov    0xea0,%edi
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
 ...
 83c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 83f:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 ...
 84f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 a0 0e 00 00 a4 	movl   $0xea4,0xea0
 857:	0e 00 00 
    base.s.size = 0;
 85a:	bf a4 0e 00 00       	mov    $0xea4,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 a4 0e 00 00 a4 	movl   $0xea4,0xea4
 866:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 a8 0e 00 00 00 	movl   $0x0,0xea8
 872:	00 00 00 
    if(p->s.size >= nunits){
