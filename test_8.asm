...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 4c7:	68 00 20 00 00       	push   $0x2000
 ...
 739:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 8b7:	90                   	nop
          s = "(null)";
 8b8:	ba 69 0b 00 00       	mov    $0xb69,%edx
        while(*s != 0){
