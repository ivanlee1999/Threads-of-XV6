...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 a0 05 00 00       	call   5b9 <getpid>
  ...
  60:	c7 45 e0 18 00 00 00 	movl   $0x18,-0x20(%ebp)
   int clone_pid = clone(worker, &arg1, &arg2, stack);
  67:	e8 6d 05 00 00       	call   5d9 <clone>
   assert(clone_pid > 0);
  ...
  7d:	e8 47 05 00 00       	call   5c9 <sleep>
   assert(wait() == -1);
  82:	e8 ba 04 00 00       	call   541 <wait>
  ...
  cf:	e8 95 04 00 00       	call   569 <kill>
  d4:	e8 60 04 00 00       	call   539 <exit>
  d9:	6a 25                	push   $0x25
 ...
 119:	50                   	push   %eax
 11a:	e8 c2 04 00 00       	call   5e1 <join>
 ...
 1a5:	e8 96 06 00 00       	call   840 <free>
   exit();
 1aa:	e8 8a 03 00 00       	call   539 <exit>
 1af:	90                   	nop
...
worker(void *arg1, void *arg2) {
 ...
 22e:	e8 36 03 00 00       	call   569 <kill>
 233:	e8 01 03 00 00       	call   539 <exit>
   assert(tmp1 == 42);
 238:	6a 39                	push   $0x39
 ...
 25c:	00 00 00 
   exit();
 25f:	e8 d5 02 00 00       	call   539 <exit>
 ...
 399:	31 db                	xor    %ebx,%ebx
{
 ...
 3a5:	57                   	push   %edi
 3a6:	6a 00                	push   $0x0
 3a8:	e8 a4 01 00 00       	call   551 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 40d:	e8 67 01 00 00       	call   579 <open>
  if(fd < 0)
 ...
 421:	50                   	push   %eax
 422:	e8 6a 01 00 00       	call   591 <fstat>
  close(fd);
 427:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 42a:	89 c6                	mov    %eax,%esi
  close(fd);
 42c:	e8 30 01 00 00       	call   561 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 4c6:	6a 04                	push   $0x4
 4c8:	e8 03 04 00 00       	call   8d0 <malloc>
  return clone(start_routine, arg1, arg2, stack);
 4cd:	50                   	push   %eax
 4ce:	ff 75 10             	push   0x10(%ebp)
 4d1:	ff 75 0c             	push   0xc(%ebp)
 4d4:	ff 75 08             	push   0x8(%ebp)
 4d7:	e8 fd 00 00 00       	call   5d9 <clone>
}
 4dc:	c9                   	leave  
 4dd:	c3                   	ret    
...
thread_join(){
 ...
 4e8:	6a 04                	push   $0x4
 4ea:	e8 e1 03 00 00       	call   8d0 <malloc>
  int rc = join(stack);
 4ef:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 4f2:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 4f4:	e8 e8 00 00 00       	call   5e1 <join>
 4f9:	89 c6                	mov    %eax,%esi
  free(*stack);
 4fb:	58                   	pop    %eax
 4fc:	ff 33                	push   (%ebx)
 4fe:	e8 3d 03 00 00       	call   840 <free>
  return rc;
}
 503:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
00000539 <exit>:
SYSCALL(exit)
 539:	b8 02 00 00 00       	mov    $0x2,%eax
 53e:	cd 40                	int    $0x40
 540:	c3                   	ret    

00000541 <wait>:
SYSCALL(wait)
 541:	b8 03 00 00 00       	mov    $0x3,%eax
 546:	cd 40                	int    $0x40
 548:	c3                   	ret    

00000549 <pipe>:
SYSCALL(pipe)
 549:	b8 04 00 00 00       	mov    $0x4,%eax
 54e:	cd 40                	int    $0x40
 550:	c3                   	ret    

00000551 <read>:
SYSCALL(read)
 551:	b8 05 00 00 00       	mov    $0x5,%eax
 556:	cd 40                	int    $0x40
 558:	c3                   	ret    

00000559 <write>:
SYSCALL(write)
 559:	b8 10 00 00 00       	mov    $0x10,%eax
 55e:	cd 40                	int    $0x40
 560:	c3                   	ret    

00000561 <close>:
SYSCALL(close)
 561:	b8 15 00 00 00       	mov    $0x15,%eax
 566:	cd 40                	int    $0x40
 568:	c3                   	ret    

00000569 <kill>:
SYSCALL(kill)
 569:	b8 06 00 00 00       	mov    $0x6,%eax
 56e:	cd 40                	int    $0x40
 570:	c3                   	ret    

00000571 <exec>:
SYSCALL(exec)
 571:	b8 07 00 00 00       	mov    $0x7,%eax
 576:	cd 40                	int    $0x40
 578:	c3                   	ret    

00000579 <open>:
SYSCALL(open)
 579:	b8 0f 00 00 00       	mov    $0xf,%eax
 57e:	cd 40                	int    $0x40
 580:	c3                   	ret    

00000581 <mknod>:
SYSCALL(mknod)
 581:	b8 11 00 00 00       	mov    $0x11,%eax
 586:	cd 40                	int    $0x40
 588:	c3                   	ret    

00000589 <unlink>:
SYSCALL(unlink)
 589:	b8 12 00 00 00       	mov    $0x12,%eax
 58e:	cd 40                	int    $0x40
 590:	c3                   	ret    

00000591 <fstat>:
SYSCALL(fstat)
 591:	b8 08 00 00 00       	mov    $0x8,%eax
 596:	cd 40                	int    $0x40
 598:	c3                   	ret    

00000599 <link>:
SYSCALL(link)
 599:	b8 13 00 00 00       	mov    $0x13,%eax
 59e:	cd 40                	int    $0x40
 5a0:	c3                   	ret    

000005a1 <mkdir>:
SYSCALL(mkdir)
 5a1:	b8 14 00 00 00       	mov    $0x14,%eax
 5a6:	cd 40                	int    $0x40
 5a8:	c3                   	ret    

000005a9 <chdir>:
SYSCALL(chdir)
 5a9:	b8 09 00 00 00       	mov    $0x9,%eax
 5ae:	cd 40                	int    $0x40
 5b0:	c3                   	ret    

000005b1 <dup>:
SYSCALL(dup)
 5b1:	b8 0a 00 00 00       	mov    $0xa,%eax
 5b6:	cd 40                	int    $0x40
 5b8:	c3                   	ret    

000005b9 <getpid>:
SYSCALL(getpid)
 5b9:	b8 0b 00 00 00       	mov    $0xb,%eax
 5be:	cd 40                	int    $0x40
 5c0:	c3                   	ret    

000005c1 <sbrk>:
SYSCALL(sbrk)
 5c1:	b8 0c 00 00 00       	mov    $0xc,%eax
 5c6:	cd 40                	int    $0x40
 5c8:	c3                   	ret    

000005c9 <sleep>:
SYSCALL(sleep)
 5c9:	b8 0d 00 00 00       	mov    $0xd,%eax
 5ce:	cd 40                	int    $0x40
 5d0:	c3                   	ret    

000005d1 <uptime>:
SYSCALL(uptime)
 5d1:	b8 0e 00 00 00       	mov    $0xe,%eax
 5d6:	cd 40                	int    $0x40
 5d8:	c3                   	ret    

000005d9 <clone>:
SYSCALL(clone)
 5d9:	b8 16 00 00 00       	mov    $0x16,%eax
 5de:	cd 40                	int    $0x40
 5e0:	c3                   	ret    

000005e1 <join>:
SYSCALL(join)
 5e1:	b8 17 00 00 00       	mov    $0x17,%eax
 5e6:	cd 40                	int    $0x40
 5e8:	c3                   	ret    
 ...
 5fc:	89 d1                	mov    %edx,%ecx
{
 ...
 66e:	56                   	push   %esi
 66f:	57                   	push   %edi
 670:	e8 e4 fe ff ff       	call   559 <write>
  while(--i >= 0)
 ...
 6a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6e5:	57                   	push   %edi
 6e6:	56                   	push   %esi
 6e7:	e8 6d fe ff ff       	call   559 <write>
 ...
 73e:	e8 16 fe ff ff       	call   559 <write>
        putc(fd, c);
 ...
 74f:	57                   	push   %edi
 750:	56                   	push   %esi
 751:	e8 03 fe ff ff       	call   559 <write>
        putc(fd, c);
 ...
 7bb:	57                   	push   %edi
 7bc:	56                   	push   %esi
 7bd:	e8 97 fd ff ff       	call   559 <write>
        while(*s != 0){
 ...
 7fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 7ff:	e8 55 fd ff ff       	call   559 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 933:	e8 89 fc ff ff       	call   5c1 <sbrk>
  if(p == (char*)-1)
