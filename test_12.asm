...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 637:	68 00 20 00 00       	push   $0x2000
...
thread_join(){
 ...
 697:	68 75 0c 00 00       	push   $0xc75
 69c:	6a 01                	push   $0x1
 69e:	e8 fd 01 00 00       	call   8a0 <printf>
  void** stack = malloc(sizeof(void**));
 6a3:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
 6aa:	e8 21 04 00 00       	call   ad0 <malloc>
 6af:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 2 \n");
 6b1:	58                   	pop    %eax
 6b2:	5a                   	pop    %edx
 6b3:	68 85 0c 00 00       	push   $0xc85
 6b8:	6a 01                	push   $0x1
 6ba:	e8 e1 01 00 00       	call   8a0 <printf>
  int rc = join(stack);
 6bf:	89 1c 24             	mov    %ebx,(%esp)
 6c2:	e8 17 01 00 00       	call   7de <join>
 ...
 6c8:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 6ca:	58                   	pop    %eax
 6cb:	68 95 0c 00 00       	push   $0xc95
 6d0:	6a 01                	push   $0x1
 6d2:	e8 c9 01 00 00       	call   8a0 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 6d7:	58                   	pop    %eax
 6d8:	5a                   	pop    %edx
 6d9:	68 a5 0c 00 00       	push   $0xca5
 6de:	6a 01                	push   $0x1
 6e0:	e8 bb 01 00 00       	call   8a0 <printf>
  return rc;
}
 ...
 8a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 a27:	90                   	nop
          s = "(null)";
 a28:	ba b5 0c 00 00       	mov    $0xcb5,%edx
        while(*s != 0){
