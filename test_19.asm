...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 52 06 00 00       	call   669 <getpid>
  ...
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 3);
  51:	83 3d 5c 0f 00 00 03 	cmpl   $0x3,0xf5c
  ...
  b0:	5b                   	pop    %ebx
  b1:	ff 35 60 0f 00 00    	push   0xf60
  b7:	e8 5d 05 00 00       	call   619 <kill>
  bc:	e8 28 05 00 00       	call   5e9 <exit>
   assert(thread_pid > 0);
  c1:	6a 1e                	push   $0x1e
  ...
  e7:	e8 64 06 00 00       	call   750 <printf>
   exit();
  ec:	e8 f8 04 00 00       	call   5e9 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
void nested_worker(void *arg1, void *arg2){
 ...
 116:	75 78                	jne    190 <nested_worker+0x90>
   assert(global == 2);
 118:	83 3d 5c 0f 00 00 02 	cmpl   $0x2,0xf5c
 11f:	75 52                	jne    173 <nested_worker+0x73>
   global++;
 121:	c7 05 5c 0f 00 00 03 	movl   $0x3,0xf5c
 128:	00 00 00 
   // no exit() in thread
}
 12b:	c9                   	leave  
 ...
 162:	59                   	pop    %ecx
 163:	ff 35 60 0f 00 00    	push   0xf60
 169:	e8 ab 04 00 00       	call   619 <kill>
 16e:	e8 76 04 00 00       	call   5e9 <exit>
   assert(global == 2);
 173:	6a 2d                	push   $0x2d
...
worker(void *arg1, void *arg2) {
 ...
 1cf:	75 2a                	jne    1fb <worker+0x4b>
   assert(global == 1);
 1d1:	83 3d 5c 0f 00 00 01 	cmpl   $0x1,0xf5c
 ...
 230:	5b                   	pop    %ebx
 231:	ff 35 60 0f 00 00    	push   0xf60
 237:	e8 dd 03 00 00       	call   619 <kill>
 23c:	e8 a8 03 00 00       	call   5e9 <exit>
   assert(tmp1 == 42);
 241:	6a 36                	push   $0x36
 ...
 267:	68 00 01 00 00       	push   $0x100
   global++;
 26c:	c7 05 5c 0f 00 00 02 	movl   $0x2,0xf5c
 273:	00 00 00 
   int nested_thread_pid = thread_create(nested_worker, &tmp1, &tmp2);
 ...
 2ec:	e9 25 ff ff ff       	jmp    216 <worker+0x66>
   exit();
 2f1:	e8 f3 02 00 00       	call   5e9 <exit>
 ...
 429:	31 db                	xor    %ebx,%ebx
{
 ...
 435:	57                   	push   %edi
 436:	6a 00                	push   $0x0
 438:	e8 c4 01 00 00       	call   601 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 49d:	e8 87 01 00 00       	call   629 <open>
  if(fd < 0)
 ...
 4b1:	50                   	push   %eax
 4b2:	e8 8a 01 00 00       	call   641 <fstat>
  close(fd);
 4b7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4ba:	89 c6                	mov    %eax,%esi
  close(fd);
 4bc:	e8 50 01 00 00       	call   611 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 55c:	e8 1f 04 00 00       	call   980 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 56b:	e8 19 01 00 00       	call   689 <clone>
  printf(1, " thread create %d \n", rc);
 570:	83 c4 1c             	add    $0x1c,%esp
 573:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 574:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 576:	68 75 0b 00 00       	push   $0xb75
 57b:	6a 01                	push   $0x1
 57d:	e8 ce 01 00 00       	call   750 <printf>
  return rc;
}
...
thread_join(){
 ...
 598:	6a 04                	push   $0x4
 59a:	e8 e1 03 00 00       	call   980 <malloc>
  int rc = join(stack);
 59f:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 5a2:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 5a4:	e8 e8 00 00 00       	call   691 <join>
 5a9:	89 c6                	mov    %eax,%esi
  free(*stack);
 5ab:	58                   	pop    %eax
 5ac:	ff 33                	push   (%ebx)
 5ae:	e8 3d 03 00 00       	call   8f0 <free>
  return rc;
}
 5b3:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 6ac:	89 d1                	mov    %edx,%ecx
{
 ...
 6d9:	0f b6 92 e8 0b 00 00 	movzbl 0xbe8(%edx),%edx
 ...
 759:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7c9:	ff 24 85 90 0b 00 00 	jmp    *0xb90(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8d7:	90                   	nop
          s = "(null)";
 8d8:	ba 89 0b 00 00       	mov    $0xb89,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8f1:	a1 64 0f 00 00       	mov    0xf64,%eax
{
 ...
 931:	5b                   	pop    %ebx
  freep = p;
 932:	89 15 64 0f 00 00    	mov    %edx,0xf64
}
 938:	5e                   	pop    %esi
 939:	5f                   	pop    %edi
 93a:	5d                   	pop    %ebp
 ...
 969:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 96c:	89 15 64 0f 00 00    	mov    %edx,0xf64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 989:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 98c:	8b 3d 64 0f 00 00    	mov    0xf64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9cf:	73 4f                	jae    a20 <malloc+0xa0>
    ...
    if(p == freep)
 9d1:	8b 3d 64 0f 00 00    	mov    0xf64,%edi
 ...
 9fa:	e8 f1 fe ff ff       	call   8f0 <free>
  return freep;
 9ff:	8b 15 64 0f 00 00    	mov    0xf64,%edx
 ...
 a2c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a2f:	89 15 64 0f 00 00    	mov    %edx,0xf64
}
 ...
 a3f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a40:	c7 05 64 0f 00 00 68 	movl   $0xf68,0xf64
 a47:	0f 00 00 
    base.s.size = 0;
 a4a:	bf 68 0f 00 00       	mov    $0xf68,%edi
    base.s.ptr = freep = prevp = &base;
 a4f:	c7 05 68 0f 00 00 68 	movl   $0xf68,0xf68
 a56:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a59:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a5b:	c7 05 6c 0f 00 00 00 	movl   $0x0,0xf6c
 a62:	00 00 00 
    if(p->s.size >= nunits){
