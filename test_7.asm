...
thread_join(){
 ...
 397:	68 43 09 00 00       	push   $0x943
 39c:	6a 01                	push   $0x1
 39e:	e8 fd 01 00 00       	call   5a0 <printf>
  void** stack = malloc(sizeof(void**));
 3a3:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
 3aa:	e8 21 04 00 00       	call   7d0 <malloc>
 3af:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 2 \n");
 3b1:	58                   	pop    %eax
 3b2:	5a                   	pop    %edx
 3b3:	68 53 09 00 00       	push   $0x953
 3b8:	6a 01                	push   $0x1
 3ba:	e8 e1 01 00 00       	call   5a0 <printf>
  int rc = join(stack);
 3bf:	89 1c 24             	mov    %ebx,(%esp)
 3c2:	e8 17 01 00 00       	call   4de <join>
 ...
 3c8:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 3ca:	58                   	pop    %eax
 3cb:	68 63 09 00 00       	push   $0x963
 3d0:	6a 01                	push   $0x1
 3d2:	e8 c9 01 00 00       	call   5a0 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 3d7:	58                   	pop    %eax
 3d8:	5a                   	pop    %edx
 3d9:	68 73 09 00 00       	push   $0x973
 3de:	6a 01                	push   $0x1
 3e0:	e8 bb 01 00 00       	call   5a0 <printf>
  return rc;
}
 ...
 5a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 727:	90                   	nop
          s = "(null)";
 728:	ba 83 09 00 00       	mov    $0x983,%edx
        while(*s != 0){
