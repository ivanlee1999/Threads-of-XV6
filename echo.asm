...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 cf 02 00 00       	call   339 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 a4 01 00 00       	call   351 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 67 01 00 00       	call   379 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 6a 01 00 00       	call   391 <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 30 01 00 00       	call   361 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2c6:	6a 04                	push   $0x4
 2c8:	e8 03 04 00 00       	call   6d0 <malloc>
  return clone(start_routine, arg1, arg2, stack);
 2cd:	50                   	push   %eax
 2ce:	ff 75 10             	push   0x10(%ebp)
 2d1:	ff 75 0c             	push   0xc(%ebp)
 2d4:	ff 75 08             	push   0x8(%ebp)
 2d7:	e8 fd 00 00 00       	call   3d9 <clone>
}
 2dc:	c9                   	leave  
 2dd:	c3                   	ret    
...
thread_join(){
 ...
 2e8:	6a 04                	push   $0x4
 2ea:	e8 e1 03 00 00       	call   6d0 <malloc>
  int rc = join(stack);
 2ef:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 2f2:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 2f4:	e8 e8 00 00 00       	call   3e1 <join>
 2f9:	89 c6                	mov    %eax,%esi
  free(*stack);
 2fb:	58                   	pop    %eax
 2fc:	ff 33                	push   (%ebx)
 2fe:	e8 3d 03 00 00       	call   640 <free>
  return rc;
}
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e5:	57                   	push   %edi
 4e6:	56                   	push   %esi
 4e7:	e8 6d fe ff ff       	call   359 <write>
 ...
 53e:	e8 16 fe ff ff       	call   359 <write>
        putc(fd, c);
 ...
 54f:	57                   	push   %edi
 550:	56                   	push   %esi
 551:	e8 03 fe ff ff       	call   359 <write>
        putc(fd, c);
 ...
 5bb:	57                   	push   %edi
 5bc:	56                   	push   %esi
 5bd:	e8 97 fd ff ff       	call   359 <write>
        while(*s != 0){
 ...
 5fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5ff:	e8 55 fd ff ff       	call   359 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 733:	e8 89 fc ff ff       	call   3c1 <sbrk>
  if(p == (char*)-1)
