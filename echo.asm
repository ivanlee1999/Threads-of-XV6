...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 ef 02 00 00       	call   359 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 c4 01 00 00       	call   371 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 87 01 00 00       	call   399 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 8a 01 00 00       	call   3b1 <fstat>
  close(fd);
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2cc:	e8 1f 04 00 00       	call   6f0 <malloc>
  // if((int) stack % 4096 != 0){
  //   stack = stack + (4096 - (int) stack % 4096);
  // }
  int rc = clone(start_routine, arg1, arg2, stack);
 2d1:	50                   	push   %eax
 2d2:	ff 75 10             	push   0x10(%ebp)
 2d5:	ff 75 0c             	push   0xc(%ebp)
 2d8:	ff 75 08             	push   0x8(%ebp)
 2db:	e8 19 01 00 00       	call   3f9 <clone>
  printf(1, " thread create %d \n", rc);
 2e0:	83 c4 1c             	add    $0x1c,%esp
 2e3:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 2e4:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 2e6:	68 ef 07 00 00       	push   $0x7ef
 2eb:	6a 01                	push   $0x1
 2ed:	e8 ce 01 00 00       	call   4c0 <printf>
  return rc;
}
...
thread_join(){
 ...
 308:	6a 04                	push   $0x4
 30a:	e8 e1 03 00 00       	call   6f0 <malloc>
  int rc = join(stack);
 30f:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 312:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 314:	e8 e8 00 00 00       	call   401 <join>
 319:	89 c6                	mov    %eax,%esi
  free(*stack);
 31b:	58                   	pop    %eax
 31c:	ff 33                	push   (%ebx)
 31e:	e8 3d 03 00 00       	call   660 <free>
  return rc;
}
 323:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 e4 fe ff ff       	call   379 <write>
  while(--i >= 0)
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 6d fe ff ff       	call   379 <write>
 ...
 539:	ff 24 85 0c 08 00 00 	jmp    *0x80c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 55e:	e8 16 fe ff ff       	call   379 <write>
        putc(fd, c);
 ...
 56f:	57                   	push   %edi
 570:	56                   	push   %esi
 571:	e8 03 fe ff ff       	call   379 <write>
        putc(fd, c);
 ...
 5db:	57                   	push   %edi
 5dc:	56                   	push   %esi
 5dd:	e8 97 fd ff ff       	call   379 <write>
        while(*s != 0){
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 61f:	e8 55 fd ff ff       	call   379 <write>
        ap++;
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 03 08 00 00       	mov    $0x803,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 a0 0b 00 00    	mov    %edx,0xba0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
 ...
 753:	e8 89 fc ff ff       	call   3e1 <sbrk>
  if(p == (char*)-1)
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 a0 0b 00 00 a4 	movl   $0xba4,0xba0
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf a4 0b 00 00       	mov    $0xba4,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 7d2:	00 00 00 
    if(p->s.size >= nunits){
