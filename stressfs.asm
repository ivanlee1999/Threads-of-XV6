  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 2b 04 00 00       	call   48e <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 2e 04 00 00       	call   4d6 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 f7 03 00 00       	call   4b6 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 ee 03 00 00       	call   4be <close>

  printf(1, "read\n");
  d0:	58                   	pop    %eax
  d1:	5a                   	pop    %edx
  d2:	68 45 09 00 00       	push   $0x945
  d7:	6a 01                	push   $0x1
  ...
  ed:	50                   	push   %eax
  ee:	e8 e3 03 00 00       	call   4d6 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 9f 03 00 00       	call   4ae <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 9e 03 00 00       	call   4be <close>

  wait();
 120:	e8 79 03 00 00       	call   49e <wait>

  exit();
 125:	e8 6c 03 00 00       	call   496 <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 31 02 00 00       	call   4ae <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 f4 01 00 00       	call   4d6 <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 f7 01 00 00       	call   4ee <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 bd 01 00 00       	call   4be <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 39c:	e8 8f 04 00 00       	call   830 <malloc>
  if((int) stack % 4096 != 0){
 3a1:	83 c4 10             	add    $0x10,%esp
 3a4:	a9 ff 0f 00 00       	test   $0xfff,%eax
 3a9:	74 16                	je     3c1 <thread_create+0x31>
    stack = stack + (4096 - (int) stack % 4096);
 3ab:	99                   	cltd   
 3ac:	c1 ea 14             	shr    $0x14,%edx
 3af:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
 3b2:	81 e1 ff 0f 00 00    	and    $0xfff,%ecx
 3b8:	29 ca                	sub    %ecx,%edx
 3ba:	8d 84 10 00 10 00 00 	lea    0x1000(%eax,%edx,1),%eax
  }
 ...
 3cb:	e8 66 01 00 00       	call   536 <clone>
 ...
 3d4:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create  %d \n", rc);
 3d6:	68 4b 09 00 00       	push   $0x94b
 3db:	6a 01                	push   $0x1
 3dd:	e8 1e 02 00 00       	call   600 <printf>
  return rc;
}
 ...
 609:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 787:	90                   	nop
          s = "(null)";
 788:	ba a0 09 00 00       	mov    $0x9a0,%edx
        while(*s != 0){
 ...
 7a1:	a1 60 0d 00 00       	mov    0xd60,%eax
{
 ...
 7e1:	5b                   	pop    %ebx
  freep = p;
 7e2:	89 15 60 0d 00 00    	mov    %edx,0xd60
}
 7e8:	5e                   	pop    %esi
 7e9:	5f                   	pop    %edi
 7ea:	5d                   	pop    %ebp
 ...
 819:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 81c:	89 15 60 0d 00 00    	mov    %edx,0xd60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 839:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 83c:	8b 3d 60 0d 00 00    	mov    0xd60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 87f:	73 4f                	jae    8d0 <malloc+0xa0>
    ...
    if(p == freep)
 881:	8b 3d 60 0d 00 00    	mov    0xd60,%edi
 ...
 8aa:	e8 f1 fe ff ff       	call   7a0 <free>
  return freep;
 8af:	8b 15 60 0d 00 00    	mov    0xd60,%edx
 ...
 8ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8f0:	c7 05 60 0d 00 00 64 	movl   $0xd64,0xd60
 8f7:	0d 00 00 
    base.s.size = 0;
 8fa:	bf 64 0d 00 00       	mov    $0xd64,%edi
    base.s.ptr = freep = prevp = &base;
 8ff:	c7 05 64 0d 00 00 64 	movl   $0xd64,0xd64
 906:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 909:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 90b:	c7 05 68 0d 00 00 00 	movl   $0x0,0xd68
 912:	00 00 00 
    if(p->s.size >= nunits){
