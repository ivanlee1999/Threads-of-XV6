  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 be 03 00 00       	call   421 <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 c1 03 00 00       	call   469 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 8a 03 00 00       	call   449 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 81 03 00 00       	call   451 <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 76 03 00 00       	call   469 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 32 03 00 00       	call   441 <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 31 03 00 00       	call   451 <close>

  wait();
 120:	e8 0c 03 00 00       	call   431 <wait>

  exit();
 125:	e8 ff 02 00 00       	call   429 <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 c4 01 00 00       	call   441 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 87 01 00 00       	call   469 <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 8a 01 00 00       	call   481 <fstat>
  close(fd);
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 39c:	e8 1f 04 00 00       	call   7c0 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 3ab:	e8 19 01 00 00       	call   4c9 <clone>
  printf(1, " thread create %d \n", rc);
 3b0:	83 c4 1c             	add    $0x1c,%esp
 3b3:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 3b4:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 3b6:	68 db 08 00 00       	push   $0x8db
 3bb:	6a 01                	push   $0x1
 3bd:	e8 ce 01 00 00       	call   590 <printf>
  return rc;
}
...
thread_join(){
 ...
 3d8:	6a 04                	push   $0x4
 3da:	e8 e1 03 00 00       	call   7c0 <malloc>
  int rc = join(stack);
 3df:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 3e2:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 3e4:	e8 e8 00 00 00       	call   4d1 <join>
 3e9:	89 c6                	mov    %eax,%esi
  free(*stack);
 3eb:	58                   	pop    %eax
 3ec:	ff 33                	push   (%ebx)
 3ee:	e8 3d 03 00 00       	call   730 <free>
  return rc;
}
 ...
 4ec:	89 d1                	mov    %edx,%ecx
{
 ...
 55e:	56                   	push   %esi
 55f:	57                   	push   %edi
 560:	e8 e4 fe ff ff       	call   449 <write>
  while(--i >= 0)
 ...
 599:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d5:	57                   	push   %edi
 5d6:	56                   	push   %esi
 5d7:	e8 6d fe ff ff       	call   449 <write>
 ...
 62e:	e8 16 fe ff ff       	call   449 <write>
        putc(fd, c);
 ...
 63f:	57                   	push   %edi
 640:	56                   	push   %esi
 641:	e8 03 fe ff ff       	call   449 <write>
        putc(fd, c);
 ...
 6ab:	57                   	push   %edi
 6ac:	56                   	push   %esi
 6ad:	e8 97 fd ff ff       	call   449 <write>
        while(*s != 0){
 ...
 6ec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6ef:	e8 55 fd ff ff       	call   449 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 823:	e8 89 fc ff ff       	call   4b1 <sbrk>
  if(p == (char*)-1)
