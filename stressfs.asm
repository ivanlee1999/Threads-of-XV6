  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 9e 03 00 00       	call   401 <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 a1 03 00 00       	call   449 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 6a 03 00 00       	call   429 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 61 03 00 00       	call   431 <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 56 03 00 00       	call   449 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 12 03 00 00       	call   421 <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 11 03 00 00       	call   431 <close>

  wait();
 120:	e8 ec 02 00 00       	call   411 <wait>

  exit();
 125:	e8 df 02 00 00       	call   409 <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 a4 01 00 00       	call   421 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 67 01 00 00       	call   449 <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 6a 01 00 00       	call   461 <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 30 01 00 00       	call   431 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 396:	6a 04                	push   $0x4
 398:	e8 03 04 00 00       	call   7a0 <malloc>
  return clone(start_routine, arg1, arg2, stack);
 39d:	50                   	push   %eax
 39e:	ff 75 10             	push   0x10(%ebp)
 3a1:	ff 75 0c             	push   0xc(%ebp)
 3a4:	ff 75 08             	push   0x8(%ebp)
 3a7:	e8 fd 00 00 00       	call   4a9 <clone>
}
 3ac:	c9                   	leave  
 3ad:	c3                   	ret    
...
thread_join(){
 ...
 3b8:	6a 04                	push   $0x4
 3ba:	e8 e1 03 00 00       	call   7a0 <malloc>
  int rc = join(stack);
 ...
 3cb:	58                   	pop    %eax
 3cc:	ff 33                	push   (%ebx)
 3ce:	e8 3d 03 00 00       	call   710 <free>
  return rc;
}
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 53e:	56                   	push   %esi
 53f:	57                   	push   %edi
 540:	e8 e4 fe ff ff       	call   429 <write>
  while(--i >= 0)
 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b5:	57                   	push   %edi
 5b6:	56                   	push   %esi
 5b7:	e8 6d fe ff ff       	call   429 <write>
 ...
 60e:	e8 16 fe ff ff       	call   429 <write>
        putc(fd, c);
 ...
 61f:	57                   	push   %edi
 620:	56                   	push   %esi
 621:	e8 03 fe ff ff       	call   429 <write>
        putc(fd, c);
 ...
 68b:	57                   	push   %edi
 68c:	56                   	push   %esi
 68d:	e8 97 fd ff ff       	call   429 <write>
        while(*s != 0){
 ...
 6cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6cf:	e8 55 fd ff ff       	call   429 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 803:	e8 89 fc ff ff       	call   491 <sbrk>
  if(p == (char*)-1)
