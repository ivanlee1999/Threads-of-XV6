...
thread_join(){
 ...
 793:	58                   	pop    %eax
 794:	5a                   	pop    %edx
 795:	68 a0 0d 00 00       	push   $0xda0
 79a:	6a 01                	push   $0x1
 79c:	e8 ef 01 00 00       	call   990 <printf>
  int rc = join(stack);
 7a1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 7a8:	e8 21 01 00 00       	call   8ce <join>
 ...
 7ae:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 7b0:	58                   	pop    %eax
 7b1:	68 b0 0d 00 00       	push   $0xdb0
 7b6:	6a 01                	push   $0x1
 7b8:	e8 d3 01 00 00       	call   990 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 7bd:	58                   	pop    %eax
 7be:	5a                   	pop    %edx
 7bf:	68 c0 0d 00 00       	push   $0xdc0
 7c4:	6a 01                	push   $0x1
 7c6:	e8 c5 01 00 00       	call   990 <printf>
  return rc;
}
 7cb:	89 d8                	mov    %ebx,%eax
 ...
 999:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 b17:	90                   	nop
          s = "(null)";
 b18:	ba d0 0d 00 00       	mov    $0xdd0,%edx
        while(*s != 0){
