...
int main(int argc, char *argv[])
{
  ...
  21:	6a 2c                	push   $0x2c
   ppid = getpid();
  23:	a3 d8 0e 00 00       	mov    %eax,0xed8
    global = (int*)malloc(size * sizeof(int));
  ...
  30:	83 c4 10             	add    $0x10,%esp
    global = (int*)malloc(size * sizeof(int));
  33:	a3 d4 0e 00 00       	mov    %eax,0xed4
    for(int i = 0; i < size; i++){
  ...
  40:	a1 d4 0e 00 00       	mov    0xed4,%eax
        global[i] = size - i - 1;
  ...
  5d:	50                   	push   %eax
  5e:	ff 35 d4 0e 00 00    	push   0xed4
  ...
  82:	75 35                	jne    b9 <main+0xb9>
   assert(global[0] == 0);
  84:	a1 d4 0e 00 00       	mov    0xed4,%eax
  ...
  ee:	5b                   	pop    %ebx
  ef:	ff 35 d8 0e 00 00    	push   0xed8
  f5:	e8 ff 04 00 00       	call   5f9 <kill>
  fa:	e8 ca 04 00 00       	call   5c9 <exit>
   assert(thread_pid > 0);
  ff:	6a 30                	push   $0x30
 ...
 125:	e8 06 06 00 00       	call   730 <printf>
   exit();
 12a:	e8 9a 04 00 00       	call   5c9 <exit>
   assert(global[0] == 0);
 12f:	6a 34                	push   $0x34
...
//    assert(nested_thread_pid_r == nested_join_pid_1 || nested_thread_pid_r == nested_join_pid_2);
   exit();
 2cf:	e8 f5 02 00 00       	call   5c9 <exit>
       exit();
 2d4:	e8 f0 02 00 00       	call   5c9 <exit>
 ...
 409:	31 db                	xor    %ebx,%ebx
{
 ...
 415:	57                   	push   %edi
 416:	6a 00                	push   $0x0
 418:	e8 c4 01 00 00       	call   5e1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 47d:	e8 87 01 00 00       	call   609 <open>
  if(fd < 0)
 ...
 491:	50                   	push   %eax
 492:	e8 8a 01 00 00       	call   621 <fstat>
  close(fd);
 497:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 49a:	89 c6                	mov    %eax,%esi
  close(fd);
 49c:	e8 50 01 00 00       	call   5f1 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 53c:	e8 1f 04 00 00       	call   960 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 54b:	e8 19 01 00 00       	call   669 <clone>
  printf(1, " thread create %d \n", rc);
 550:	83 c4 1c             	add    $0x1c,%esp
 553:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 554:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 556:	68 de 0a 00 00       	push   $0xade
 55b:	6a 01                	push   $0x1
 55d:	e8 ce 01 00 00       	call   730 <printf>
  return rc;
}
 ...
 68c:	89 d1                	mov    %edx,%ecx
{
 ...
 6b9:	0f b6 92 54 0b 00 00 	movzbl 0xb54(%edx),%edx
 ...
 739:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7a9:	ff 24 85 fc 0a 00 00 	jmp    *0xafc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8b7:	90                   	nop
          s = "(null)";
 8b8:	ba f2 0a 00 00       	mov    $0xaf2,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8d1:	a1 dc 0e 00 00       	mov    0xedc,%eax
{
 ...
 911:	5b                   	pop    %ebx
  freep = p;
 912:	89 15 dc 0e 00 00    	mov    %edx,0xedc
}
 918:	5e                   	pop    %esi
 919:	5f                   	pop    %edi
 91a:	5d                   	pop    %ebp
 ...
 949:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 94c:	89 15 dc 0e 00 00    	mov    %edx,0xedc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 96c:	8b 3d dc 0e 00 00    	mov    0xedc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9af:	73 4f                	jae    a00 <malloc+0xa0>
    ...
    if(p == freep)
 9b1:	8b 3d dc 0e 00 00    	mov    0xedc,%edi
 ...
 9da:	e8 f1 fe ff ff       	call   8d0 <free>
  return freep;
 9df:	8b 15 dc 0e 00 00    	mov    0xedc,%edx
 ...
 a0c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a0f:	89 15 dc 0e 00 00    	mov    %edx,0xedc
}
 ...
 a1f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a20:	c7 05 dc 0e 00 00 e0 	movl   $0xee0,0xedc
 a27:	0e 00 00 
    base.s.size = 0;
 a2a:	bf e0 0e 00 00       	mov    $0xee0,%edi
    base.s.ptr = freep = prevp = &base;
 a2f:	c7 05 e0 0e 00 00 e0 	movl   $0xee0,0xee0
 a36:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a39:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a3b:	c7 05 e4 0e 00 00 00 	movl   $0x0,0xee4
 a42:	00 00 00 
    if(p->s.size >= nunits){
