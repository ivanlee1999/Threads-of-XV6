...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 537:	68 00 20 00 00       	push   $0x2000
...
thread_join(){
 ...
 597:	68 63 0b 00 00       	push   $0xb63
 59c:	6a 01                	push   $0x1
 59e:	e8 fd 01 00 00       	call   7a0 <printf>
  void** stack = malloc(sizeof(void**));
 5a3:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
 5aa:	e8 21 04 00 00       	call   9d0 <malloc>
 5af:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 2 \n");
 5b1:	58                   	pop    %eax
 5b2:	5a                   	pop    %edx
 5b3:	68 73 0b 00 00       	push   $0xb73
 5b8:	6a 01                	push   $0x1
 5ba:	e8 e1 01 00 00       	call   7a0 <printf>
  int rc = join(stack);
 5bf:	89 1c 24             	mov    %ebx,(%esp)
 5c2:	e8 17 01 00 00       	call   6de <join>
 ...
 5c8:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 5ca:	58                   	pop    %eax
 5cb:	68 83 0b 00 00       	push   $0xb83
 5d0:	6a 01                	push   $0x1
 5d2:	e8 c9 01 00 00       	call   7a0 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 5d7:	58                   	pop    %eax
 5d8:	5a                   	pop    %edx
 5d9:	68 93 0b 00 00       	push   $0xb93
 5de:	6a 01                	push   $0x1
 5e0:	e8 bb 01 00 00       	call   7a0 <printf>
  return rc;
}
 ...
 7a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 927:	90                   	nop
          s = "(null)";
 928:	ba a3 0b 00 00       	mov    $0xba3,%edx
        while(*s != 0){
