...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 447:	68 00 20 00 00       	push   $0x2000
 ...
 6b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 837:	90                   	nop
          s = "(null)";
 838:	ba 23 0b 00 00       	mov    $0xb23,%edx
        while(*s != 0){
