...
main(int argc, char *argv[])
{
  ...
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 2c 0e 00 00       	mov    %eax,0xe2c
   void *stack, *p = malloc(PGSIZE * 2);
  ...
  4e:	e8 26 05 00 00       	call   579 <clone>
   assert(clone_pid > 0);
  ...
  5a:	0f 8e 8b 00 00 00    	jle    eb <main+0xeb>
   while(global != 5);
  60:	8b 15 28 0e 00 00    	mov    0xe28,%edx
  ...
  7f:	e8 fd 04 00 00       	call   581 <join>
  ...
  c0:	5b                   	pop    %ebx
  c1:	ff 35 2c 0e 00 00    	push   0xe2c
  c7:	e8 3d 04 00 00       	call   509 <kill>
  cc:	e8 08 04 00 00       	call   4d9 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  e1:	e8 fa 06 00 00       	call   7e0 <free>
   exit();
  e6:	e8 ee 03 00 00       	call   4d9 <exit>
   assert(clone_pid > 0);
  eb:	6a 23                	push   $0x23
...
worker(void *arg1, void *arg2) {
 ...
 1b2:	59                   	pop    %ecx
 1b3:	ff 35 2c 0e 00 00    	push   0xe2c
 1b9:	e8 4b 03 00 00       	call   509 <kill>
 1be:	e8 16 03 00 00       	call   4d9 <exit>
   assert((uint)&arg2 == ((uint)arg1 + PGSIZE - 4));
 1c3:	6a 30                	push   $0x30
 ...
 1de:	eb b8                	jmp    198 <worker+0x68>
   global = 5;
 1e0:	c7 05 28 0e 00 00 05 	movl   $0x5,0xe28
 1e7:	00 00 00 
   exit();
 1ea:	e8 ea 02 00 00       	call   4d9 <exit>
 1ef:	90                   	nop
 ...
 319:	31 db                	xor    %ebx,%ebx
{
 ...
 325:	57                   	push   %edi
 326:	6a 00                	push   $0x0
 328:	e8 c4 01 00 00       	call   4f1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 38d:	e8 87 01 00 00       	call   519 <open>
  if(fd < 0)
 ...
 3a1:	50                   	push   %eax
 3a2:	e8 8a 01 00 00       	call   531 <fstat>
  close(fd);
 3a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 3aa:	89 c6                	mov    %eax,%esi
  close(fd);
 3ac:	e8 50 01 00 00       	call   501 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 44c:	e8 1f 04 00 00       	call   870 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 45b:	e8 19 01 00 00       	call   579 <clone>
  printf(1, " thread create %d \n", rc);
 460:	83 c4 1c             	add    $0x1c,%esp
 463:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 464:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 466:	68 5e 0a 00 00       	push   $0xa5e
 46b:	6a 01                	push   $0x1
 46d:	e8 ce 01 00 00       	call   640 <printf>
  return rc;
}
 ...
 59c:	89 d1                	mov    %edx,%ecx
{
 ...
 5c9:	0f b6 92 d4 0a 00 00 	movzbl 0xad4(%edx),%edx
 ...
 649:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6b9:	ff 24 85 7c 0a 00 00 	jmp    *0xa7c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7c7:	90                   	nop
          s = "(null)";
 7c8:	ba 72 0a 00 00       	mov    $0xa72,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7e1:	a1 30 0e 00 00       	mov    0xe30,%eax
{
 ...
 821:	5b                   	pop    %ebx
  freep = p;
 822:	89 15 30 0e 00 00    	mov    %edx,0xe30
}
 828:	5e                   	pop    %esi
 829:	5f                   	pop    %edi
 82a:	5d                   	pop    %ebp
 ...
 859:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 85c:	89 15 30 0e 00 00    	mov    %edx,0xe30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 879:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 87c:	8b 3d 30 0e 00 00    	mov    0xe30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8bf:	73 4f                	jae    910 <malloc+0xa0>
    ...
    if(p == freep)
 8c1:	8b 3d 30 0e 00 00    	mov    0xe30,%edi
 ...
 8ea:	e8 f1 fe ff ff       	call   7e0 <free>
  return freep;
 8ef:	8b 15 30 0e 00 00    	mov    0xe30,%edx
 ...
 91c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 91f:	89 15 30 0e 00 00    	mov    %edx,0xe30
}
 ...
 92f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 930:	c7 05 30 0e 00 00 34 	movl   $0xe34,0xe30
 937:	0e 00 00 
    base.s.size = 0;
 93a:	bf 34 0e 00 00       	mov    $0xe34,%edi
    base.s.ptr = freep = prevp = &base;
 93f:	c7 05 34 0e 00 00 34 	movl   $0xe34,0xe34
 946:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 949:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 94b:	c7 05 38 0e 00 00 00 	movl   $0x0,0xe38
 952:	00 00 00 
    if(p->s.size >= nunits){
