...
main(int argc, char *argv[])
{
  ...
  4e:	e8 06 05 00 00       	call   559 <clone>
   assert(clone_pid > 0);
  ...
  7f:	e8 dd 04 00 00       	call   561 <join>
  ...
  c7:	e8 1d 04 00 00       	call   4e9 <kill>
  cc:	e8 e8 03 00 00       	call   4b9 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  e1:	e8 da 06 00 00       	call   7c0 <free>
   exit();
  e6:	e8 ce 03 00 00       	call   4b9 <exit>
   assert(clone_pid > 0);
  eb:	6a 23                	push   $0x23
...
worker(void *arg1, void *arg2) {
 ...
 1b9:	e8 2b 03 00 00       	call   4e9 <kill>
 1be:	e8 f6 02 00 00       	call   4b9 <exit>
   assert((uint)&arg2 == ((uint)arg1 + PGSIZE - 4));
 1c3:	6a 30                	push   $0x30
 ...
 1e7:	00 00 00 
   exit();
 1ea:	e8 ca 02 00 00       	call   4b9 <exit>
 1ef:	90                   	nop
 ...
 319:	31 db                	xor    %ebx,%ebx
{
 ...
 325:	57                   	push   %edi
 326:	6a 00                	push   $0x0
 328:	e8 a4 01 00 00       	call   4d1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 38d:	e8 67 01 00 00       	call   4f9 <open>
  if(fd < 0)
 ...
 3a1:	50                   	push   %eax
 3a2:	e8 6a 01 00 00       	call   511 <fstat>
  close(fd);
 3a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 3aa:	89 c6                	mov    %eax,%esi
  close(fd);
 3ac:	e8 30 01 00 00       	call   4e1 <close>
  return r;
