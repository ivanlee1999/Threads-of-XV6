...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 da 04 00 00       	call   516 <open>
  ...
  59:	e8 a0 04 00 00       	call   4fe <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 6b 04 00 00       	call   4d6 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 c6 05 00 00       	call   640 <printf>
      exit();
  7a:	e8 57 04 00 00       	call   4d6 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 44 04 00 00       	call   4d6 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 19 04 00 00       	call   4ee <read>
 ...
 166:	50                   	push   %eax
 167:	50                   	push   %eax
 168:	68 6e 09 00 00       	push   $0x96e
 16d:	6a 01                	push   $0x1
 16f:	e8 cc 04 00 00       	call   640 <printf>
    exit();
 174:	e8 5d 03 00 00       	call   4d6 <exit>
...
thread_join(){
 ...
 443:	58                   	pop    %eax
 444:	5a                   	pop    %edx
 445:	68 c3 09 00 00       	push   $0x9c3
 44a:	6a 01                	push   $0x1
 44c:	e8 ef 01 00 00       	call   640 <printf>
  int rc = join(stack);
 451:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 458:	e8 21 01 00 00       	call   57e <join>
 ...
 45e:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 460:	58                   	pop    %eax
 461:	68 d3 09 00 00       	push   $0x9d3
 466:	6a 01                	push   $0x1
 468:	e8 d3 01 00 00       	call   640 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 46d:	58                   	pop    %eax
 46e:	5a                   	pop    %edx
 46f:	68 e3 09 00 00       	push   $0x9e3
 474:	6a 01                	push   $0x1
 476:	e8 c5 01 00 00       	call   640 <printf>
  return rc;
}
 ...
 59c:	89 d1                	mov    %edx,%ecx
{
 ...
 5c9:	0f b6 92 54 0a 00 00 	movzbl 0xa54(%edx),%edx
 ...
 649:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6b9:	ff 24 85 fc 09 00 00 	jmp    *0x9fc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 7e1:	a1 00 10 00 00       	mov    0x1000,%eax
{
 ...
 821:	5b                   	pop    %ebx
  freep = p;
 822:	89 15 00 10 00 00    	mov    %edx,0x1000
}
 828:	5e                   	pop    %esi
 829:	5f                   	pop    %edi
 82a:	5d                   	pop    %ebp
 ...
 859:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 85c:	89 15 00 10 00 00    	mov    %edx,0x1000
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 879:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 87c:	8b 3d 00 10 00 00    	mov    0x1000,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8bf:	73 4f                	jae    910 <malloc+0xa0>
    ...
    if(p == freep)
 8c1:	8b 3d 00 10 00 00    	mov    0x1000,%edi
 ...
 8ea:	e8 f1 fe ff ff       	call   7e0 <free>
  return freep;
 8ef:	8b 15 00 10 00 00    	mov    0x1000,%edx
 ...
 91c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 91f:	89 15 00 10 00 00    	mov    %edx,0x1000
}
 ...
 92f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 930:	c7 05 00 10 00 00 04 	movl   $0x1004,0x1000
 937:	10 00 00 
    base.s.size = 0;
 93a:	bf 04 10 00 00       	mov    $0x1004,%edi
    base.s.ptr = freep = prevp = &base;
 93f:	c7 05 04 10 00 00 04 	movl   $0x1004,0x1004
 946:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 949:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 94b:	c7 05 08 10 00 00 00 	movl   $0x0,0x1008
 952:	00 00 00 
    if(p->s.size >= nunits){
