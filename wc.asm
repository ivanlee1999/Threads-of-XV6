...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 6d 04 00 00       	call   4a9 <open>
  ...
  59:	e8 33 04 00 00       	call   491 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 fe 03 00 00       	call   469 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 56 05 00 00       	call   5d0 <printf>
      exit();
  7a:	e8 ea 03 00 00       	call   469 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  81:	68 42 09 00 00       	push   $0x942
  86:	6a 00                	push   $0x0
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 d7 03 00 00       	call   469 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 ac 03 00 00       	call   481 <read>
 ...
 16f:	e8 5c 04 00 00       	call   5d0 <printf>
    exit();
 174:	e8 f0 02 00 00       	call   469 <exit>
 ...
 52c:	89 d1                	mov    %edx,%ecx
{
 ...
 559:	0f b6 92 a4 09 00 00 	movzbl 0x9a4(%edx),%edx
 ...
 5d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 649:	ff 24 85 4c 09 00 00 	jmp    *0x94c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 757:	90                   	nop
          s = "(null)";
 758:	ba 43 09 00 00       	mov    $0x943,%edx
        while(*s != 0){
