...
main(int argc, char *argv[])
{
  ...
  55:	e8 27 06 00 00       	call   681 <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 2b 06 00 00       	call   699 <open>
  ...
  81:	e8 3a 07 00 00       	call   7c0 <printf>
      exit();
  86:	e8 ce 05 00 00       	call   659 <exit>
  }
  exit();
  8b:	e8 c9 05 00 00       	call   659 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 22 07 00 00       	call   7c0 <printf>
    exit();
  9e:	e8 b6 05 00 00       	call   659 <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 a7 05 00 00       	call   659 <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 64 04 00 00       	call   671 <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 e8 03 00 00       	call   679 <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 c4 01 00 00       	call   671 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 87 01 00 00       	call   699 <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 8a 01 00 00       	call   6b1 <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 50 01 00 00       	call   681 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 5cc:	e8 1f 04 00 00       	call   9f0 <malloc>
  // if((int) stack % 4096 != 0){
  //   stack = stack + (4096 - (int) stack % 4096);
  // }
  int rc = clone(start_routine, arg1, arg2, stack);
 5d1:	50                   	push   %eax
 5d2:	ff 75 10             	push   0x10(%ebp)
 5d5:	ff 75 0c             	push   0xc(%ebp)
 5d8:	ff 75 08             	push   0x8(%ebp)
 5db:	e8 19 01 00 00       	call   6f9 <clone>
  printf(1, " thread create %d \n", rc);
 5e0:	83 c4 1c             	add    $0x1c,%esp
 5e3:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 5e4:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 5e6:	68 1e 0b 00 00       	push   $0xb1e
 5eb:	6a 01                	push   $0x1
 5ed:	e8 ce 01 00 00       	call   7c0 <printf>
  return rc;
}
...
thread_join(){
 ...
 608:	6a 04                	push   $0x4
 60a:	e8 e1 03 00 00       	call   9f0 <malloc>
  int rc = join(stack);
 60f:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 612:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 614:	e8 e8 00 00 00       	call   701 <join>
 619:	89 c6                	mov    %eax,%esi
  free(*stack);
 61b:	58                   	pop    %eax
 61c:	ff 33                	push   (%ebx)
 61e:	e8 3d 03 00 00       	call   960 <free>
  return rc;
}
 623:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 71c:	89 d1                	mov    %edx,%ecx
{
 ...
 78e:	56                   	push   %esi
 78f:	57                   	push   %edi
 790:	e8 e4 fe ff ff       	call   679 <write>
  while(--i >= 0)
 ...
 7c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 805:	57                   	push   %edi
 806:	56                   	push   %esi
 807:	e8 6d fe ff ff       	call   679 <write>
 ...
 85e:	e8 16 fe ff ff       	call   679 <write>
        putc(fd, c);
 ...
 86f:	57                   	push   %edi
 870:	56                   	push   %esi
 871:	e8 03 fe ff ff       	call   679 <write>
        putc(fd, c);
 ...
 8db:	57                   	push   %edi
 8dc:	56                   	push   %esi
 8dd:	e8 97 fd ff ff       	call   679 <write>
        while(*s != 0){
 ...
 91c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 91f:	e8 55 fd ff ff       	call   679 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 a53:	e8 89 fc ff ff       	call   6e1 <sbrk>
  if(p == (char*)-1)
