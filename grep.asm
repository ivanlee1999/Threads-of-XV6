...
main(int argc, char *argv[])
{
  ...
  55:	e8 07 06 00 00       	call   661 <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 0b 06 00 00       	call   679 <open>
  ...
  81:	e8 1a 07 00 00       	call   7a0 <printf>
      exit();
  86:	e8 ae 05 00 00       	call   639 <exit>
  }
  exit();
  8b:	e8 a9 05 00 00       	call   639 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 02 07 00 00       	call   7a0 <printf>
    exit();
  9e:	e8 96 05 00 00       	call   639 <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 87 05 00 00       	call   639 <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 44 04 00 00       	call   651 <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 c8 03 00 00       	call   659 <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 a4 01 00 00       	call   651 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 67 01 00 00       	call   679 <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 6a 01 00 00       	call   691 <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 30 01 00 00       	call   661 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 5c6:	6a 04                	push   $0x4
 5c8:	e8 03 04 00 00       	call   9d0 <malloc>
  return clone(start_routine, arg1, arg2, stack);
 5cd:	50                   	push   %eax
 5ce:	ff 75 10             	push   0x10(%ebp)
 5d1:	ff 75 0c             	push   0xc(%ebp)
 5d4:	ff 75 08             	push   0x8(%ebp)
 5d7:	e8 fd 00 00 00       	call   6d9 <clone>
}
 5dc:	c9                   	leave  
 5dd:	c3                   	ret    
...
thread_join(){
 ...
 5e8:	6a 04                	push   $0x4
 5ea:	e8 e1 03 00 00       	call   9d0 <malloc>
  int rc = join(stack);
 5ef:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 5f2:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 5f4:	e8 e8 00 00 00       	call   6e1 <join>
 5f9:	89 c6                	mov    %eax,%esi
  free(*stack);
 5fb:	58                   	pop    %eax
 5fc:	ff 33                	push   (%ebx)
 5fe:	e8 3d 03 00 00       	call   940 <free>
  return rc;
}
 603:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 6fc:	89 d1                	mov    %edx,%ecx
{
 ...
 76e:	56                   	push   %esi
 76f:	57                   	push   %edi
 770:	e8 e4 fe ff ff       	call   659 <write>
  while(--i >= 0)
 ...
 7a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7e5:	57                   	push   %edi
 7e6:	56                   	push   %esi
 7e7:	e8 6d fe ff ff       	call   659 <write>
 ...
 83e:	e8 16 fe ff ff       	call   659 <write>
        putc(fd, c);
 ...
 84f:	57                   	push   %edi
 850:	56                   	push   %esi
 851:	e8 03 fe ff ff       	call   659 <write>
        putc(fd, c);
 ...
 8bb:	57                   	push   %edi
 8bc:	56                   	push   %esi
 8bd:	e8 97 fd ff ff       	call   659 <write>
        while(*s != 0){
 ...
 8fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8ff:	e8 55 fd ff ff       	call   659 <write>
        ap++;
...
free(void *ap)
{
 ...
 941:	a1 a0 13 00 00       	mov    0x13a0,%eax
{
 ...
 981:	5b                   	pop    %ebx
  freep = p;
 982:	89 15 a0 13 00 00    	mov    %edx,0x13a0
}
 988:	5e                   	pop    %esi
 989:	5f                   	pop    %edi
 98a:	5d                   	pop    %ebp
 ...
 9b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9bc:	89 15 a0 13 00 00    	mov    %edx,0x13a0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9dc:	8b 3d a0 13 00 00    	mov    0x13a0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a1f:	73 4f                	jae    a70 <malloc+0xa0>
    ...
    if(p == freep)
 a21:	8b 3d a0 13 00 00    	mov    0x13a0,%edi
 ...
 a33:	e8 89 fc ff ff       	call   6c1 <sbrk>
  if(p == (char*)-1)
 ...
 a4a:	e8 f1 fe ff ff       	call   940 <free>
  return freep;
 a4f:	8b 15 a0 13 00 00    	mov    0x13a0,%edx
 ...
 a7c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a7f:	89 15 a0 13 00 00    	mov    %edx,0x13a0
}
 ...
 a8f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a90:	c7 05 a0 13 00 00 a4 	movl   $0x13a4,0x13a0
 a97:	13 00 00 
    base.s.size = 0;
 a9a:	bf a4 13 00 00       	mov    $0x13a4,%edi
    base.s.ptr = freep = prevp = &base;
 a9f:	c7 05 a4 13 00 00 a4 	movl   $0x13a4,0x13a4
 aa6:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 aa9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 aab:	c7 05 a8 13 00 00 00 	movl   $0x0,0x13a8
 ab2:	00 00 00 
    if(p->s.size >= nunits){
