   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 dc 04 00 00       	call   4f9 <getpid>
  1d:	a3 78 0d 00 00       	mov    %eax,0xd78

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 74 0d 00 00 01 	movl   $0x1,0xd74
  2f:	00 00 00 
  ...
  4c:	e8 cf 03 00 00       	call   420 <thread_join>
      assert(join_pid == thread_pid);
  51:	39 c3                	cmp    %eax,%ebx
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 74 0d 00 00       	mov    0xd74,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 90 04 00 00       	call   501 <sbrk>
  ...
  84:	50                   	push   %eax
  85:	50                   	push   %eax
  86:	68 79 09 00 00       	push   $0x979
  8b:	6a 01                	push   $0x1
  8d:	e8 4e 05 00 00       	call   5e0 <printf>
   exit();
  92:	e8 e2 03 00 00       	call   479 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  99:	68 08 09 00 00       	push   $0x908
  9e:	68 12 09 00 00       	push   $0x912
  a3:	6a 01                	push   $0x1
  a5:	e8 36 05 00 00       	call   5e0 <printf>
  aa:	83 c4 0c             	add    $0xc,%esp
  ad:	68 47 09 00 00       	push   $0x947
      assert(join_pid == thread_pid);
  b2:	68 26 09 00 00       	push   $0x926
  b7:	6a 01                	push   $0x1
  b9:	e8 22 05 00 00       	call   5e0 <printf>
  be:	5a                   	pop    %edx
  bf:	59                   	pop    %ecx
  c0:	68 3a 09 00 00       	push   $0x93a
  c5:	6a 01                	push   $0x1
  c7:	e8 14 05 00 00       	call   5e0 <printf>
  cc:	5b                   	pop    %ebx
  cd:	ff 35 78 0d 00 00    	push   0xd78
  d3:	e8 d1 03 00 00       	call   4a9 <kill>
  d8:	e8 9c 03 00 00       	call   479 <exit>
  dd:	6a 22                	push   $0x22
  df:	68 08 09 00 00       	push   $0x908
  e4:	68 12 09 00 00       	push   $0x912
  e9:	6a 01                	push   $0x1
  eb:	e8 f0 04 00 00       	call   5e0 <printf>
  f0:	83 c4 0c             	add    $0xc,%esp
  f3:	68 56 09 00 00       	push   $0x956
  f8:	eb b8                	jmp    b2 <main+0xb2>
      assert(global == 5);
  fa:	6a 23                	push   $0x23
  fc:	68 08 09 00 00       	push   $0x908
 101:	68 12 09 00 00       	push   $0x912
 106:	6a 01                	push   $0x1
 108:	e8 d3 04 00 00       	call   5e0 <printf>
 10d:	83 c4 0c             	add    $0xc,%esp
 110:	68 6d 09 00 00       	push   $0x96d
 115:	eb 9b                	jmp    b2 <main+0xb2>
      assert((uint)sbrk(0) < (150 * 4096) && "shouldn't even come close");
 117:	6a 25                	push   $0x25
 119:	68 08 09 00 00       	push   $0x908
 11e:	68 12 09 00 00       	push   $0x912
 123:	6a 01                	push   $0x1
 125:	e8 b6 04 00 00       	call   5e0 <printf>
 12a:	83 c4 0c             	add    $0xc,%esp
 12d:	68 88 09 00 00       	push   $0x988
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 74 0d 00 00       	mov    0xd74,%eax
 14b:	83 f8 01             	cmp    $0x1,%eax
 14e:	74 46                	je     196 <worker+0x56>
 150:	6a 2e                	push   $0x2e
 152:	68 08 09 00 00       	push   $0x908
 157:	68 12 09 00 00       	push   $0x912
 15c:	6a 01                	push   $0x1
 15e:	e8 7d 04 00 00       	call   5e0 <printf>
 163:	83 c4 0c             	add    $0xc,%esp
 166:	68 1a 09 00 00       	push   $0x91a
 16b:	68 26 09 00 00       	push   $0x926
 170:	6a 01                	push   $0x1
 172:	e8 69 04 00 00       	call   5e0 <printf>
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	68 3a 09 00 00       	push   $0x93a
 17e:	6a 01                	push   $0x1
 180:	e8 5b 04 00 00       	call   5e0 <printf>
 185:	59                   	pop    %ecx
 186:	ff 35 78 0d 00 00    	push   0xd78
 18c:	e8 18 03 00 00       	call   4a9 <kill>
 191:	e8 e3 02 00 00       	call   479 <exit>
   global += 4;
 196:	a1 74 0d 00 00       	mov    0xd74,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 74 0d 00 00       	mov    %eax,0xd74
   exit();
 1a3:	e8 d1 02 00 00       	call   479 <exit>
 ...
 53c:	89 d1                	mov    %edx,%ecx
{
 ...
 569:	0f b6 92 24 0a 00 00 	movzbl 0xa24(%edx),%edx
 ...
 5e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 659:	ff 24 85 cc 09 00 00 	jmp    *0x9cc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 767:	90                   	nop
          s = "(null)";
 768:	ba c4 09 00 00       	mov    $0x9c4,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 781:	a1 7c 0d 00 00       	mov    0xd7c,%eax
{
 ...
 7c1:	5b                   	pop    %ebx
  freep = p;
 7c2:	89 15 7c 0d 00 00    	mov    %edx,0xd7c
}
 7c8:	5e                   	pop    %esi
 7c9:	5f                   	pop    %edi
 7ca:	5d                   	pop    %ebp
 ...
 7f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7fc:	89 15 7c 0d 00 00    	mov    %edx,0xd7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 819:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 81c:	8b 3d 7c 0d 00 00    	mov    0xd7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 85f:	73 4f                	jae    8b0 <malloc+0xa0>
    ...
    if(p == freep)
 861:	8b 3d 7c 0d 00 00    	mov    0xd7c,%edi
 ...
 88a:	e8 f1 fe ff ff       	call   780 <free>
  return freep;
 88f:	8b 15 7c 0d 00 00    	mov    0xd7c,%edx
 ...
 8bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8bf:	89 15 7c 0d 00 00    	mov    %edx,0xd7c
}
 ...
 8cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8d0:	c7 05 7c 0d 00 00 80 	movl   $0xd80,0xd7c
 8d7:	0d 00 00 
    base.s.size = 0;
 8da:	bf 80 0d 00 00       	mov    $0xd80,%edi
    base.s.ptr = freep = prevp = &base;
 8df:	c7 05 80 0d 00 00 80 	movl   $0xd80,0xd80
 8e6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8eb:	c7 05 84 0d 00 00 00 	movl   $0x0,0xd84
 8f2:	00 00 00 
    if(p->s.size >= nunits){
