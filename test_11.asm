   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 fc 04 00 00       	call   519 <getpid>
  1d:	a3 b0 0d 00 00       	mov    %eax,0xdb0

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 ac 0d 00 00 01 	movl   $0x1,0xdac
  2f:	00 00 00 
  ...
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 ac 0d 00 00       	mov    0xdac,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 b0 04 00 00       	call   521 <sbrk>
  ...
  8d:	e8 6e 05 00 00       	call   600 <printf>
   exit();
  92:	e8 02 04 00 00       	call   499 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  ...
  cc:	5b                   	pop    %ebx
  cd:	ff 35 b0 0d 00 00    	push   0xdb0
  d3:	e8 f1 03 00 00       	call   4c9 <kill>
  d8:	e8 bc 03 00 00       	call   499 <exit>
  dd:	6a 22                	push   $0x22
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 ac 0d 00 00       	mov    0xdac,%eax
 ...
 185:	59                   	pop    %ecx
 186:	ff 35 b0 0d 00 00    	push   0xdb0
 18c:	e8 38 03 00 00       	call   4c9 <kill>
 191:	e8 03 03 00 00       	call   499 <exit>
   global += 4;
 196:	a1 ac 0d 00 00       	mov    0xdac,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 ac 0d 00 00       	mov    %eax,0xdac
   exit();
 1a3:	e8 f1 02 00 00       	call   499 <exit>
 ...
 2d9:	31 db                	xor    %ebx,%ebx
{
 ...
 2e5:	57                   	push   %edi
 2e6:	6a 00                	push   $0x0
 2e8:	e8 c4 01 00 00       	call   4b1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 34d:	e8 87 01 00 00       	call   4d9 <open>
  if(fd < 0)
 ...
 361:	50                   	push   %eax
 362:	e8 8a 01 00 00       	call   4f1 <fstat>
  close(fd);
 367:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 36a:	89 c6                	mov    %eax,%esi
  close(fd);
 36c:	e8 50 01 00 00       	call   4c1 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 40c:	e8 1f 04 00 00       	call   830 <malloc>
  // if((int) stack % 4096 != 0){
  //   stack = stack + (4096 - (int) stack % 4096);
  // }
  int rc = clone(start_routine, arg1, arg2, stack);
 411:	50                   	push   %eax
 412:	ff 75 10             	push   0x10(%ebp)
 415:	ff 75 0c             	push   0xc(%ebp)
 418:	ff 75 08             	push   0x8(%ebp)
 41b:	e8 19 01 00 00       	call   539 <clone>
 ...
 424:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 426:	68 e4 09 00 00       	push   $0x9e4
 42b:	6a 01                	push   $0x1
 42d:	e8 ce 01 00 00       	call   600 <printf>
  return rc;
}
 ...
 55c:	89 d1                	mov    %edx,%ecx
{
 ...
 589:	0f b6 92 58 0a 00 00 	movzbl 0xa58(%edx),%edx
 ...
 609:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 679:	ff 24 85 00 0a 00 00 	jmp    *0xa00(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 787:	90                   	nop
          s = "(null)";
 788:	ba f8 09 00 00       	mov    $0x9f8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a1:	a1 b4 0d 00 00       	mov    0xdb4,%eax
{
 ...
 7e1:	5b                   	pop    %ebx
  freep = p;
 7e2:	89 15 b4 0d 00 00    	mov    %edx,0xdb4
}
 7e8:	5e                   	pop    %esi
 7e9:	5f                   	pop    %edi
 7ea:	5d                   	pop    %ebp
 ...
 819:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 81c:	89 15 b4 0d 00 00    	mov    %edx,0xdb4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 839:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 83c:	8b 3d b4 0d 00 00    	mov    0xdb4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 87f:	73 4f                	jae    8d0 <malloc+0xa0>
    ...
    if(p == freep)
 881:	8b 3d b4 0d 00 00    	mov    0xdb4,%edi
 ...
 8aa:	e8 f1 fe ff ff       	call   7a0 <free>
  return freep;
 8af:	8b 15 b4 0d 00 00    	mov    0xdb4,%edx
 ...
 8dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8df:	89 15 b4 0d 00 00    	mov    %edx,0xdb4
}
 ...
 8ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8f0:	c7 05 b4 0d 00 00 b8 	movl   $0xdb8,0xdb4
 8f7:	0d 00 00 
    base.s.size = 0;
 8fa:	bf b8 0d 00 00       	mov    $0xdb8,%edi
    base.s.ptr = freep = prevp = &base;
 8ff:	c7 05 b8 0d 00 00 b8 	movl   $0xdb8,0xdb8
 906:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 909:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 90b:	c7 05 bc 0d 00 00 00 	movl   $0x0,0xdbc
 912:	00 00 00 
    if(p->s.size >= nunits){
