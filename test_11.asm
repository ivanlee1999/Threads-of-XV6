...
thread_join(){
 ...
 473:	58                   	pop    %eax
 474:	5a                   	pop    %edx
 475:	68 78 0a 00 00       	push   $0xa78
 47a:	6a 01                	push   $0x1
 47c:	e8 ef 01 00 00       	call   670 <printf>
  int rc = join(stack);
 481:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 488:	e8 21 01 00 00       	call   5ae <join>
 ...
 48e:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 490:	58                   	pop    %eax
 491:	68 88 0a 00 00       	push   $0xa88
 496:	6a 01                	push   $0x1
 498:	e8 d3 01 00 00       	call   670 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 49d:	58                   	pop    %eax
 49e:	5a                   	pop    %edx
 49f:	68 98 0a 00 00       	push   $0xa98
 4a4:	6a 01                	push   $0x1
 4a6:	e8 c5 01 00 00       	call   670 <printf>
  return rc;
}
