...
main(int argc, char **argv)
{
  ...
  39:	e8 a8 03 00 00       	call   3e6 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 6c 03 00 00       	call   3b6 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 c8 04 00 00       	call   520 <printf>
    exit();
  58:	e8 59 03 00 00       	call   3b6 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
thread_join(){
 ...
 317:	68 71 08 00 00       	push   $0x871
 31c:	6a 01                	push   $0x1
 31e:	e8 fd 01 00 00       	call   520 <printf>
  void** stack = malloc(sizeof(void**));
 323:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
 32a:	e8 21 04 00 00       	call   750 <malloc>
 32f:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 2 \n");
 331:	58                   	pop    %eax
 332:	5a                   	pop    %edx
 333:	68 81 08 00 00       	push   $0x881
 338:	6a 01                	push   $0x1
 33a:	e8 e1 01 00 00       	call   520 <printf>
  int rc = join(stack);
 33f:	89 1c 24             	mov    %ebx,(%esp)
 342:	e8 17 01 00 00       	call   45e <join>
 ...
 348:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 34a:	58                   	pop    %eax
 34b:	68 91 08 00 00       	push   $0x891
 350:	6a 01                	push   $0x1
 352:	e8 c9 01 00 00       	call   520 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 357:	58                   	pop    %eax
 358:	5a                   	pop    %edx
 359:	68 a1 08 00 00       	push   $0x8a1
 35e:	6a 01                	push   $0x1
 360:	e8 bb 01 00 00       	call   520 <printf>
  return rc;
}
 365:	89 d8                	mov    %ebx,%eax
 367:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 36a:	c9                   	leave  
 36b:	c3                   	ret    
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6a7:	90                   	nop
          s = "(null)";
 6a8:	ba b1 08 00 00       	mov    $0x8b1,%edx
        while(*s != 0){
 ...
 6c1:	a1 70 0c 00 00       	mov    0xc70,%eax
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	89 15 70 0c 00 00    	mov    %edx,0xc70
}
 708:	5e                   	pop    %esi
 709:	5f                   	pop    %edi
 70a:	5d                   	pop    %ebp
 ...
 739:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 73c:	89 15 70 0c 00 00    	mov    %edx,0xc70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d 70 0c 00 00    	mov    0xc70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 4f                	jae    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	8b 3d 70 0c 00 00    	mov    0xc70,%edi
 ...
 7ca:	e8 f1 fe ff ff       	call   6c0 <free>
  return freep;
 7cf:	8b 15 70 0c 00 00    	mov    0xc70,%edx
 ...
 7fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ff:	89 15 70 0c 00 00    	mov    %edx,0xc70
}
 ...
 80f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 70 0c 00 00 74 	movl   $0xc74,0xc70
 817:	0c 00 00 
    base.s.size = 0;
 81a:	bf 74 0c 00 00       	mov    $0xc74,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 74 0c 00 00 74 	movl   $0xc74,0xc74
 826:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 829:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 82b:	c7 05 78 0c 00 00 00 	movl   $0x0,0xc78
 832:	00 00 00 
    if(p->s.size >= nunits){
