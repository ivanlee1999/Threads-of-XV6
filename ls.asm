...
thread_join(){
 ...
 5f7:	68 87 0b 00 00       	push   $0xb87
 5fc:	6a 01                	push   $0x1
 5fe:	e8 fd 01 00 00       	call   800 <printf>
  void** stack = malloc(sizeof(void**));
 603:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
 60a:	e8 21 04 00 00       	call   a30 <malloc>
 60f:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 2 \n");
 611:	58                   	pop    %eax
 612:	5a                   	pop    %edx
 613:	68 97 0b 00 00       	push   $0xb97
 618:	6a 01                	push   $0x1
 61a:	e8 e1 01 00 00       	call   800 <printf>
  int rc = join(stack);
 61f:	89 1c 24             	mov    %ebx,(%esp)
 622:	e8 17 01 00 00       	call   73e <join>
 ...
 628:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 62a:	58                   	pop    %eax
 62b:	68 a7 0b 00 00       	push   $0xba7
 630:	6a 01                	push   $0x1
 632:	e8 c9 01 00 00       	call   800 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 637:	58                   	pop    %eax
 638:	5a                   	pop    %edx
 639:	68 b7 0b 00 00       	push   $0xbb7
 63e:	6a 01                	push   $0x1
 640:	e8 bb 01 00 00       	call   800 <printf>
  return rc;
}
 ...
 809:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 987:	90                   	nop
          s = "(null)";
 988:	ba c7 0b 00 00       	mov    $0xbc7,%edx
        while(*s != 0){
