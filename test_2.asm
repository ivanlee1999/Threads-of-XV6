...
main(int argc, char *argv[])
{
  ...
  10:	83 ec 1c             	sub    $0x1c,%esp
   ppid = getpid();
  13:	e8 61 05 00 00       	call   579 <getpid>
  ...
  45:	50                   	push   %eax
  46:	68 e4 0d 00 00       	push   $0xde4
  4b:	68 e8 0d 00 00       	push   $0xde8
  50:	68 90 01 00 00       	push   $0x190
  55:	e8 3f 05 00 00       	call   599 <clone>
   assert(clone_pid > 0);
  ...
  c7:	5b                   	pop    %ebx
  c8:	ff 35 ec 0d 00 00    	push   0xdec
  ce:	e8 56 04 00 00       	call   529 <kill>
  d3:	e8 21 04 00 00       	call   4f9 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
 ...
 152:	e8 4a 04 00 00       	call   5a1 <join>
 ...
 182:	e8 79 06 00 00       	call   800 <free>
   exit();
 187:	e8 6d 03 00 00       	call   4f9 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1a7:	c7 00 37 00 00 00    	movl   $0x37,(%eax)
   assert(global == 1);
 1ad:	a1 e0 0d 00 00       	mov    0xde0,%eax
 ...
 1ec:	59                   	pop    %ecx
 1ed:	ff 35 ec 0d 00 00    	push   0xdec
 1f3:	e8 31 03 00 00       	call   529 <kill>
 1f8:	e8 fc 02 00 00       	call   4f9 <exit>
   global = tmp1 + tmp2;
 1fd:	01 d9                	add    %ebx,%ecx
 1ff:	89 0d e0 0d 00 00    	mov    %ecx,0xde0
   exit();
 205:	e8 ef 02 00 00       	call   4f9 <exit>
 ...
 339:	31 db                	xor    %ebx,%ebx
{
 ...
 345:	57                   	push   %edi
 346:	6a 00                	push   $0x0
 348:	e8 c4 01 00 00       	call   511 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3ad:	e8 87 01 00 00       	call   539 <open>
  if(fd < 0)
 ...
 3c1:	50                   	push   %eax
 3c2:	e8 8a 01 00 00       	call   551 <fstat>
  close(fd);
 3c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 3ca:	89 c6                	mov    %eax,%esi
  close(fd);
 3cc:	e8 50 01 00 00       	call   521 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 46c:	e8 1f 04 00 00       	call   890 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 47b:	e8 19 01 00 00       	call   599 <clone>
  printf(1, " thread create %d \n", rc);
 480:	83 c4 1c             	add    $0x1c,%esp
 483:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 484:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 486:	68 17 0a 00 00       	push   $0xa17
 48b:	6a 01                	push   $0x1
 48d:	e8 ce 01 00 00       	call   660 <printf>
  return rc;
}
...
thread_join(){
 ...
 4a8:	6a 04                	push   $0x4
 4aa:	e8 e1 03 00 00       	call   890 <malloc>
  int rc = join(stack);
 4af:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 4b2:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 4b4:	e8 e8 00 00 00       	call   5a1 <join>
 4b9:	89 c6                	mov    %eax,%esi
  free(*stack);
 4bb:	58                   	pop    %eax
 4bc:	ff 33                	push   (%ebx)
 4be:	e8 3d 03 00 00       	call   800 <free>
  return rc;
}
 ...
 5bc:	89 d1                	mov    %edx,%ecx
{
 ...
 5e9:	0f b6 92 8c 0a 00 00 	movzbl 0xa8c(%edx),%edx
 ...
 62e:	56                   	push   %esi
 62f:	57                   	push   %edi
 630:	e8 e4 fe ff ff       	call   519 <write>
  while(--i >= 0)
 ...
 669:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6a5:	57                   	push   %edi
 6a6:	56                   	push   %esi
 6a7:	e8 6d fe ff ff       	call   519 <write>
 ...
 6d9:	ff 24 85 34 0a 00 00 	jmp    *0xa34(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6fe:	e8 16 fe ff ff       	call   519 <write>
        putc(fd, c);
 ...
 70f:	57                   	push   %edi
 710:	56                   	push   %esi
 711:	e8 03 fe ff ff       	call   519 <write>
        putc(fd, c);
 ...
 77b:	57                   	push   %edi
 77c:	56                   	push   %esi
 77d:	e8 97 fd ff ff       	call   519 <write>
        while(*s != 0){
 ...
 7bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 7bf:	e8 55 fd ff ff       	call   519 <write>
        ap++;
 ...
 7e7:	90                   	nop
          s = "(null)";
 7e8:	ba 2b 0a 00 00       	mov    $0xa2b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 801:	a1 f0 0d 00 00       	mov    0xdf0,%eax
{
 ...
 841:	5b                   	pop    %ebx
  freep = p;
 842:	89 15 f0 0d 00 00    	mov    %edx,0xdf0
}
 848:	5e                   	pop    %esi
 849:	5f                   	pop    %edi
 84a:	5d                   	pop    %ebp
 ...
 879:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 87c:	89 15 f0 0d 00 00    	mov    %edx,0xdf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 899:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 89c:	8b 3d f0 0d 00 00    	mov    0xdf0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8df:	73 4f                	jae    930 <malloc+0xa0>
    ...
    if(p == freep)
 8e1:	8b 3d f0 0d 00 00    	mov    0xdf0,%edi
 ...
 8f3:	e8 89 fc ff ff       	call   581 <sbrk>
  if(p == (char*)-1)
 ...
 90a:	e8 f1 fe ff ff       	call   800 <free>
  return freep;
 90f:	8b 15 f0 0d 00 00    	mov    0xdf0,%edx
 ...
 93c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 93f:	89 15 f0 0d 00 00    	mov    %edx,0xdf0
}
 ...
 94f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 950:	c7 05 f0 0d 00 00 f4 	movl   $0xdf4,0xdf0
 957:	0d 00 00 
    base.s.size = 0;
 95a:	bf f4 0d 00 00       	mov    $0xdf4,%edi
    base.s.ptr = freep = prevp = &base;
 95f:	c7 05 f4 0d 00 00 f4 	movl   $0xdf4,0xdf4
 966:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 969:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 96b:	c7 05 f8 0d 00 00 00 	movl   $0x0,0xdf8
 972:	00 00 00 
    if(p->s.size >= nunits){
