...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 467:	68 00 20 00 00       	push   $0x2000
 ...
 6d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 857:	90                   	nop
          s = "(null)";
 858:	ba dc 0a 00 00       	mov    $0xadc,%edx
        while(*s != 0){
