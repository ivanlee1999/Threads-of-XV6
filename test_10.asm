...
thread_join(){
 ...
 483:	58                   	pop    %eax
 484:	5a                   	pop    %edx
 485:	68 68 0a 00 00       	push   $0xa68
 48a:	6a 01                	push   $0x1
 48c:	e8 ef 01 00 00       	call   680 <printf>
  int rc = join(stack);
 491:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 498:	e8 21 01 00 00       	call   5be <join>
  printf(1, "thread join 3 \n");
 49d:	59                   	pop    %ecx
  int rc = join(stack);
 49e:	89 c3                	mov    %eax,%ebx
  printf(1, "thread join 3 \n");
 4a0:	58                   	pop    %eax
 4a1:	68 78 0a 00 00       	push   $0xa78
 4a6:	6a 01                	push   $0x1
 4a8:	e8 d3 01 00 00       	call   680 <printf>
  // printf(1, "stack %d", stack);
  // free(*stack);
  printf(1, "thread join 4 \n");
 4ad:	58                   	pop    %eax
 4ae:	5a                   	pop    %edx
 4af:	68 88 0a 00 00       	push   $0xa88
 4b4:	6a 01                	push   $0x1
 4b6:	e8 c5 01 00 00       	call   680 <printf>
  return rc;
}
 ...
 689:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 807:	90                   	nop
          s = "(null)";
 808:	ba 98 0a 00 00       	mov    $0xa98,%edx
        while(*s != 0){
