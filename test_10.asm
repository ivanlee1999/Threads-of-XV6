...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 12 05 00 00       	call   529 <getpid>
  ...
  1a:	c7 45 f0 23 00 00 00 	movl   $0x23,-0x10(%ebp)
   ppid = getpid();
  21:	a3 9c 0d 00 00       	mov    %eax,0xd9c
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 2);
  51:	83 3d 98 0d 00 00 02 	cmpl   $0x2,0xd98
  ...
  b0:	5b                   	pop    %ebx
  b1:	ff 35 9c 0d 00 00    	push   0xd9c
  b7:	e8 1d 04 00 00       	call   4d9 <kill>
  bc:	e8 e8 03 00 00       	call   4a9 <exit>
   assert(thread_pid > 0);
  c1:	6a 1f                	push   $0x1f
  ...
  e7:	e8 24 05 00 00       	call   610 <printf>
   exit();
  ec:	e8 b8 03 00 00       	call   4a9 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 116:	75 2a                	jne    142 <worker+0x42>
   assert(global == 1);
 118:	83 3d 98 0d 00 00 01 	cmpl   $0x1,0xd98
 ...
 177:	59                   	pop    %ecx
 178:	ff 35 9c 0d 00 00    	push   0xd9c
 17e:	e8 56 03 00 00       	call   4d9 <kill>
 183:	e8 21 03 00 00       	call   4a9 <exit>
   assert(arg1_int == 35);
 188:	6a 2d                	push   $0x2d
 ...
 1a3:	eb b8                	jmp    15d <worker+0x5d>
   global++;
 1a5:	c7 05 98 0d 00 00 02 	movl   $0x2,0xd98
 1ac:	00 00 00 
   exit();
 1af:	e8 f5 02 00 00       	call   4a9 <exit>
 ...
 2e9:	31 db                	xor    %ebx,%ebx
{
 ...
 2f5:	57                   	push   %edi
 2f6:	6a 00                	push   $0x0
 2f8:	e8 c4 01 00 00       	call   4c1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 35d:	e8 87 01 00 00       	call   4e9 <open>
  if(fd < 0)
 ...
 371:	50                   	push   %eax
 372:	e8 8a 01 00 00       	call   501 <fstat>
  close(fd);
 377:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 37a:	89 c6                	mov    %eax,%esi
  close(fd);
 37c:	e8 50 01 00 00       	call   4d1 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 417:	68 00 10 00 00       	push   $0x1000
 41c:	e8 1f 04 00 00       	call   840 <malloc>
  // if((int) stack % 4096 != 0){
 ...
 42b:	e8 19 01 00 00       	call   549 <clone>
  printf(1, " thread create %d \n", rc);
 430:	83 c4 1c             	add    $0x1c,%esp
 433:	50                   	push   %eax
  int rc = clone(start_routine, arg1, arg2, stack);
 434:	89 c3                	mov    %eax,%ebx
  printf(1, " thread create %d \n", rc);
 436:	68 d4 09 00 00       	push   $0x9d4
 43b:	6a 01                	push   $0x1
 43d:	e8 ce 01 00 00       	call   610 <printf>
  return rc;
}
...
thread_join(){
 ...
 458:	6a 04                	push   $0x4
 45a:	e8 e1 03 00 00       	call   840 <malloc>
  int rc = join(stack);
 45f:	89 04 24             	mov    %eax,(%esp)
  void** stack = malloc(sizeof(void*));
 462:	89 c3                	mov    %eax,%ebx
  int rc = join(stack);
 464:	e8 e8 00 00 00       	call   551 <join>
 469:	89 c6                	mov    %eax,%esi
  free(*stack);
 46b:	58                   	pop    %eax
 46c:	ff 33                	push   (%ebx)
 46e:	e8 3d 03 00 00       	call   7b0 <free>
  return rc;
}
 ...
 56c:	89 d1                	mov    %edx,%ecx
{
 ...
 5de:	56                   	push   %esi
 5df:	57                   	push   %edi
 5e0:	e8 e4 fe ff ff       	call   4c9 <write>
  while(--i >= 0)
 ...
 619:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 655:	57                   	push   %edi
 656:	56                   	push   %esi
 657:	e8 6d fe ff ff       	call   4c9 <write>
 ...
 6ae:	e8 16 fe ff ff       	call   4c9 <write>
        putc(fd, c);
 ...
 6bf:	57                   	push   %edi
 6c0:	56                   	push   %esi
 6c1:	e8 03 fe ff ff       	call   4c9 <write>
        putc(fd, c);
 ...
 72b:	57                   	push   %edi
 72c:	56                   	push   %esi
 72d:	e8 97 fd ff ff       	call   4c9 <write>
        while(*s != 0){
 ...
 76c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 76f:	e8 55 fd ff ff       	call   4c9 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 8a3:	e8 89 fc ff ff       	call   531 <sbrk>
  if(p == (char*)-1)
