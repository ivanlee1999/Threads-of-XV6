...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 b5 04 00 00       	call   4c9 <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 08 0d 00 00       	push   $0xd08
   ppid = getpid();
  1c:	a3 10 0d 00 00       	mov    %eax,0xd10
   lock_init(&lock);
  21:	e8 1a 04 00 00       	call   440 <lock_init>

   int i;
   for (i = 0; i < num_threads; i++) {
  26:	a1 04 0d 00 00       	mov    0xd04,%eax
  ...
  40:	a1 04 0d 00 00       	mov    0xd04,%eax
  ...
  64:	6a 25                	push   $0x25
  66:	68 d8 08 00 00       	push   $0x8d8
  6b:	68 e2 08 00 00       	push   $0x8e2
  70:	6a 01                	push   $0x1
  72:	e8 39 05 00 00       	call   5b0 <printf>
  77:	83 c4 0c             	add    $0xc,%esp
  7a:	68 ea 08 00 00       	push   $0x8ea
   }

   for (i = 0; i < num_threads; i++) {
      int join_pid = thread_join();
      assert(join_pid > 0);
  7f:	68 f9 08 00 00       	push   $0x8f9
  84:	6a 01                	push   $0x1
  86:	e8 25 05 00 00       	call   5b0 <printf>
  8b:	5a                   	pop    %edx
  8c:	59                   	pop    %ecx
  8d:	68 0d 09 00 00       	push   $0x90d
  92:	6a 01                	push   $0x1
  94:	e8 17 05 00 00       	call   5b0 <printf>
  99:	5b                   	pop    %ebx
  9a:	ff 35 10 0d 00 00    	push   0xd10
  a0:	e8 d4 03 00 00       	call   479 <kill>
  a5:	e8 9f 03 00 00       	call   449 <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 04 0d 00 00       	mov    0xd04,%eax
  bd:	83 c3 01             	add    $0x1,%ebx
  c0:	39 d8                	cmp    %ebx,%eax
  c2:	7e 26                	jle    ea <main+0xea>
      int join_pid = thread_join();
  c4:	e8 27 03 00 00       	call   3f0 <thread_join>
      assert(join_pid > 0);
  c9:	85 c0                	test   %eax,%eax
  cb:	7f eb                	jg     b8 <main+0xb8>
  cd:	6a 2a                	push   $0x2a
  cf:	68 d8 08 00 00       	push   $0x8d8
  d4:	68 e2 08 00 00       	push   $0x8e2
  d9:	6a 01                	push   $0x1
  db:	e8 d0 04 00 00       	call   5b0 <printf>
  ...
  ea:	0f af 05 00 0d 00 00 	imul   0xd00,%eax
  f1:	3b 05 0c 0d 00 00    	cmp    0xd0c,%eax
  f7:	74 20                	je     119 <main+0x119>
  f9:	6a 2d                	push   $0x2d
  fb:	68 d8 08 00 00       	push   $0x8d8
 100:	68 e2 08 00 00       	push   $0x8e2
 105:	6a 01                	push   $0x1
 107:	e8 a4 04 00 00       	call   5b0 <printf>
 10c:	83 c4 0c             	add    $0xc,%esp
 10f:	68 27 09 00 00       	push   $0x927
 114:	e9 66 ff ff ff       	jmp    7f <main+0x7f>

   printf(1, "TEST PASSED\n");
 119:	50                   	push   %eax
 11a:	50                   	push   %eax
 11b:	68 45 09 00 00       	push   $0x945
 120:	6a 01                	push   $0x1
 122:	e8 89 04 00 00       	call   5b0 <printf>
   exit();
 127:	e8 1d 03 00 00       	call   449 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 134:	83 ec 04             	sub    $0x4,%esp
   int i, j, tmp;
   for (i = 0; i < loops; i++) {
 137:	a1 00 0d 00 00       	mov    0xd00,%eax
 ...
 14b:	83 c3 01             	add    $0x1,%ebx
      lock_acquire(&lock);
 14e:	68 08 0d 00 00       	push   $0xd08
 153:	e8 c8 02 00 00       	call   420 <lock_acquire>
      tmp = global;
      for(j = 0; j < 50; j++); // take some time
      global = tmp + 1;
      lock_release(&lock);
 158:	c7 04 24 08 0d 00 00 	movl   $0xd08,(%esp)
      global = tmp + 1;
 15f:	83 05 0c 0d 00 00 01 	addl   $0x1,0xd0c
      lock_release(&lock);
 166:	e8 c5 02 00 00       	call   430 <lock_release>
   for (i = 0; i < loops; i++) {
 16b:	83 c4 10             	add    $0x10,%esp
 16e:	39 1d 00 0d 00 00    	cmp    %ebx,0xd00
 174:	7f d2                	jg     148 <worker+0x18>
   }
   exit();
 176:	e8 ce 02 00 00       	call   449 <exit>
 ...
 50c:	89 d1                	mov    %edx,%ecx
{
 ...
 539:	0f b6 92 b4 09 00 00 	movzbl 0x9b4(%edx),%edx
 ...
 5b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 629:	ff 24 85 5c 09 00 00 	jmp    *0x95c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 737:	90                   	nop
          s = "(null)";
 738:	ba 52 09 00 00       	mov    $0x952,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 751:	a1 14 0d 00 00       	mov    0xd14,%eax
{
 ...
 791:	5b                   	pop    %ebx
  freep = p;
 792:	89 15 14 0d 00 00    	mov    %edx,0xd14
}
 798:	5e                   	pop    %esi
 799:	5f                   	pop    %edi
 79a:	5d                   	pop    %ebp
 ...
 7c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7cc:	89 15 14 0d 00 00    	mov    %edx,0xd14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 3d 14 0d 00 00    	mov    0xd14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 82f:	73 4f                	jae    880 <malloc+0xa0>
    ...
    if(p == freep)
 831:	8b 3d 14 0d 00 00    	mov    0xd14,%edi
 ...
 85a:	e8 f1 fe ff ff       	call   750 <free>
  return freep;
 85f:	8b 15 14 0d 00 00    	mov    0xd14,%edx
 ...
 88c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 88f:	89 15 14 0d 00 00    	mov    %edx,0xd14
}
 ...
 89f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8a0:	c7 05 14 0d 00 00 18 	movl   $0xd18,0xd14
 8a7:	0d 00 00 
    base.s.size = 0;
 8aa:	bf 18 0d 00 00       	mov    $0xd18,%edi
    base.s.ptr = freep = prevp = &base;
 8af:	c7 05 18 0d 00 00 18 	movl   $0xd18,0xd18
 8b6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8bb:	c7 05 1c 0d 00 00 00 	movl   $0x0,0xd1c
 8c2:	00 00 00 
    if(p->s.size >= nunits){
